import { D as string, S as object, d as array, f as boolean, k as union, m as discriminatedUnion, o as _enum, v as literal, x as number } from "./types-BaLzBUv4.js";
import { F as loadApiKey, O as injectJsonInstructionIntoMessages, U as postJsonToApi, V as parseProviderOptions, X as withUserAgentSuffix, Z as withoutTrailingSlash, a as combineHeaders, c as convertToBase64, ct as NoSuchModelError, dt as UnsupportedFunctionalityError, f as createEventSourceResponseHandler, h as createJsonResponseHandler, lt as TooManyEmbeddingValuesForCallError, m as createJsonErrorResponseHandler, w as generateId } from "./dist-CVWZ5WHT.js";
...
var mistralContentSchema = union([string(), array(discriminatedUnion("type", [
	...
	object({
		...
		reference_ids: array(union([string(), number()]))
	}),
	object({
