const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./dist-BN152ZzG.js","./dist-oTn6Mzbo.js","./lib-cWyaA6i9.js","./rolldown-runtime-D8OvLAZx.js","./zwitch-D4MLDKRr.js","./dist-ry9cWLbi.js","./preload-helper-Cs2ugBNd.js","./markdown-it-x9jUBCR2.js","./markdown-it-B4th7Ewj.js"])))=>i.map(i=>d[i]);
import { t as loggerService } from "./LoggerService-ChVOAPl8.js";
import { t as __vitePreload } from "./preload-helper-Cs2ugBNd.js";
import { h as getTokenStyleObject } from "./dist-oTn6Mzbo.js";
...
var shikiInitializer = new AsyncInitializer(async () => {
	return await __vitePreload(() => import("./dist-BN152ZzG.js"), __vite__mapDeps([0,1,2,3,4,5,6]), import.meta.url);
});
...
var mdInitializer = new AsyncInitializer(async () => {
	return (await __vitePreload(() => import("./markdown-it-x9jUBCR2.js"), __vite__mapDeps([7,8,3]), import.meta.url)).default;
});
async function getMarkdownIt(theme, markdown) {
	...
	const { fromHighlighter } = await __vitePreload(async () => {
		const { fromHighlighter: fromHighlighter$1 } = await import("./core-CvjalN9N.js");
