3-GQeahjcW.js","./journeyDiagram-XKPGCS4Q-B7ewjkv0.js","./timeline-definition-IT6M3QCI-DVjyQX5n.js","./mindmap-definition-VGOIOE7T-CzlGVuh3.js","./kanban-definition-3W4ZIXB7-m837uUKI.js","./sankeyDiagram-TZEHDZUN-C3NuBHzH.js","./diagram-S2PKOQOG-B80GROaZ.js","./diagram-QEK2KX5R-C9tDMi9Y.js","./blockDiagram-VD42YOAC-P8PM4iYD.js","./clone-BbZf87mt.js","./architectureDiagram-VXUJARFQ-Cg5HxIBd.js","./cytoscape.esm-DEaisxFg.js","./diagram-PSM6KHXK-CWnS38If.js"])))=>i.map(i=>d[i]);
...
import { n as registerLayoutLoaders } from "./chunk-N4CR4FBY-GnzB9XOH.js";
import { n as load, t as JSON_SCHEMA } from "./chunk-MI3HLSF2-Dd71s9R4.js";
...
var c4Detector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await __vitePreload(async () => {
			const { diagram: diagram2$1 } = await import("./c4Diagram-YG6GDRKO-BZm373tB.js");
...
var flowDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await __vitePreload(async () => {
			const { diagram: diagram2$1 } = await import("./flowDiagram-NV44I4VS-CYM3jPM8.js");
			return { diagram: diagram2$1 };
...
var erDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await __vitePreload(async () => {
			const { diagram: diagram2$1 } = await import("./erDiagram-Q2GNP2WA-VMMXNcrF.js");
			return { diagram: diagram2$1 };
...
var gitGraphDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await __vitePreload(async () => {
			const { diagram: diagram2$1 } = await import("./gitGraphDiagram-NY62KEGX-C3ZRMfau.js");
			return { diagram: diagram2$1 };
...
var ganttDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await __vitePreload(async () => {
			const { diagram: diagram2$1 } = await import("./ganttDiagram-JELNMOA3-BDIFW8JZ.js");
			return { diagram: diagram2$1 };
...
var info = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await __vitePreload(async () => {
			const { diagram: diagram2$1 } = await import("./infoDiagram-WHAUD3N6-C9UGS737.js");
			return { diagram: diagram2$1 };
...
var pie = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await __vitePreload(async () => {
			const { diagram: diagram2$1 } = await import("./pieDiagram-ADFJNKIX-Bd42Jmnn.js");
			return { diagram: diagram2$1 };
...
var quadrantDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await __vitePreload(async () => {
			const { diagram: diagram2$1 } = await import("./quadrantDiagram-AYHSOK5B-D-Mha6-k.js");
			return { diagram: diagram2$1 };
...
var xychartDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await __vitePreload(async () => {
			const { diagram: diagram2$1 } = await import("./xychartDiagram-PRI3JC2R-0nWv9So_.js");
			return { diagram: diagram2$1 };
...
var requirementDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await __vitePreload(async () => {
			const { diagram: diagram2$1 } = await import("./requirementDiagram-UZGBJVZJ-D7VYfysX.js");
			return { diagram: diagram2$1 };
...
var sequenceDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await __vitePreload(async () => {
			const { diagram: diagram2$1 } = await import("./sequenceDiagram-WL72ISMW-xKkkLqRb.js");
			return { diagram: diagram2$1 };
...
var classDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await __vitePreload(async () => {
			const { diagram: diagram2$1 } = await import("./classDiagram-2ON5EDUG-DHlSRxbv.js");
			return { diagram: diagram2$1 };
...
var classDetector_V2_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await __vitePreload(async () => {
			const { diagram: diagram2$1 } = await import("./classDiagram-v2-WZHVMYZB-DbqTLMc5.js");
			return { diagram: diagram2$1 };
...
var stateDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await __vitePreload(async () => {
			const { diagram: diagram2$1 } = await import("./stateDiagram-FKZM4ZOC-BAqGb7BV.js");
			return { diagram: diagram2$1 };
...
var stateDetector_V2_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await __vitePreload(async () => {
			const { diagram: diagram2$1 } = await import("./stateDiagram-v2-4FDKWEC3-GQeahjcW.js");
			return { diagram: diagram2$1 };
...
var journeyDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await __vitePreload(async () => {
			const { diagram: diagram2$1 } = await import("./journeyDiagram-XKPGCS4Q-B7ewjkv0.js");
			return { diagram: diagram2$1 };
...
var detector_default2 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await __vitePreload(async () => {
			const { diagram: diagram2$1 } = await import("./timeline-definition-IT6M3QCI-DVjyQX5n.js");
			return { diagram: diagram2$1 };
...
var detector_default3 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await __vitePreload(async () => {
			const { diagram: diagram2$1 } = await import("./mindmap-definition-VGOIOE7T-CzlGVuh3.js");
			return { diagram: diagram2$1 };
...
var detector_default4 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await __vitePreload(async () => {
			const { diagram: diagram2$1 } = await import("./kanban-definition-3W4ZIXB7-m837uUKI.js");
			return { diagram: diagram2$1 };
...
var sankeyDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await __vitePreload(async () => {
			const { diagram: diagram2$1 } = await import("./sankeyDiagram-TZEHDZUN-C3NuBHzH.js");
			return { diagram: diagram2$1 };
...
var packet = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await __vitePreload(async () => {
			const { diagram: diagram2$1 } = await import("./diagram-S2PKOQOG-B80GROaZ.js");
			return { diagram: diagram2$1 };
...
var radar = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await __vitePreload(async () => {
			const { diagram: diagram2$1 } = await import("./diagram-QEK2KX5R-C9tDMi9Y.js");
			return { diagram: diagram2$1 };
...
var blockDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await __vitePreload(async () => {
			const { diagram: diagram2$1 } = await import("./blockDiagram-VD42YOAC-P8PM4iYD.js");
			return { diagram: diagram2$1 };
...
var architectureDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await __vitePreload(async () => {
			const { diagram: diagram2$1 } = await import("./architectureDiagram-VXUJARFQ-Cg5HxIBd.js");
			return { diagram: diagram2$1 };
...
var treemap = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await __vitePreload(async () => {
			const { diagram: diagram2$1 } = await import("./diagram-PSM6KHXK-CWnS38If.js");
			return { diagram: diagram2$1 };
