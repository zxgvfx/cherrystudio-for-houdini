...
import { c as writeComposerRichClipboardContent } from "./composerClipboard-q_YG-zvr.js";
var import_dayjs_min = /* @__PURE__ */ __toESM(require_dayjs_min());
async function exportTableToExcel(data) {
	if (data.length === 0) return false;
	const XLSX = await __vitePreload(() => import("./xlsx-1v7_8y_t.js"), [], import.meta.url);
