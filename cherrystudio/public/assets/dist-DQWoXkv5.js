import { F as safeParseAsync } from "./schemas-DwHFUYcd.js";
import { b as ZodFirstPartyTypeKind, c as EventSourceParserStream, e as APICallError, f as EmptyResponseBodyError, g as InvalidArgumentError, j as JSONParseError, k as LoadAPIKeyError, l as LoadSettingError, o as TypeValidationError, t as toJSONSchema } from "./types-1baJBz3q.js";
...
function injectJsonInstructionIntoMessages({ messages, schema, schemaPrefix, schemaSuffix }) {
	var _a, _b;
	const systemMessage = ((_a = messages[0]) == null ? void 0 : _a.role) === "system" ? { ...messages[0] } : {
		role: "system",
		content: ""
	};
	...
	return [systemMessage, ...((_b = messages[0]) == null ? void 0 : _b.role) === "system" ? messages.slice(1) : messages];
}
...
var createJsonStreamResponseHandler = (chunkSchema) => async ({ response }) => {
	...
	return {
		responseHeaders,
		value: response.body.pipeThrough(new TextDecoderStream()).pipeThrough(new TransformStream({ async transform(chunkText, controller) {
...
export { lazyValidator as A, loadApiKey as B, loadOptionalSetting as C, loadSetting as D, normalizeHeaders as E, parseProviderOptions as F, postJsonToApi as G, resolve as H, safeParseJSON as I, safeValidateTypes as J, tool as K, validateTypes as L, withUserAgentSuffix as M, withoutTrailingSlash as N, zodSchema as O, asSchema as b, combineHeaders as c, convertBase64ToUint8Array as d, convertToBase64 as e, convertUint8ArrayToBase64 as f, createEventSourceResponseHandler as g, createIdGenerator as h, createJsonErrorResponseHandler as i, createJsonResponseHandler as j, createJsonStreamResponseHandler as k, createProviderDefinedToolFactory as l, createProviderDefinedToolFactoryWithOutputSchema as m, delay as n, executeTool as o, extractResponseHeaders as p, generateId as q, getErrorMessage as r, getFromApi as s, getRuntimeEnvironmentUserAgent as t, injectJsonInstructionIntoMessages as u, isAbortError as v, isParsableJson as w, isUrlSupported as x, jsonSchema as y, lazySchema as z };
