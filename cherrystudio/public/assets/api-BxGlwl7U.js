import { c as withoutTrailingSlash, l as trim, t as formatApiHost } from "./format-BU2M4Rvo.js";
...
function formatVertexApiHost(input) {
	...
	if (!trimmedHost || trimmedHost.endsWith("aiplatform.googleapis.com")) return `${formatApiHost(location === "global" ? "https://aiplatform.googleapis.com" : `https://${location}-aiplatform.googleapis.com`)}/projects/${project}/locations/${location}`;
