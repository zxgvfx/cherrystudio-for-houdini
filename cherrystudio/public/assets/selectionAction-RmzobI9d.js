...
import { n as AntdProvider_default, r as require_lib, t as LanguageSelect_default } from "./LanguageSelect-MfQIX2CV.js";
import { Kr as LoadingOutlined_default, Qo as IpcChannel, Uo as defaultLanguage, Zo as loggerService, _o as i18n_default, n as init_es, yo as useTranslation } from "./es-BDLhINRJ.js";
import { $c as getAssistantById, Ci as getToastUtilities, Di as useHotkeys, Dr as detectLanguage, Hr as MessageContent_default, Ja as useTopicMessages, Jf as isWin, Jp as LanguagesEnum, Ks as isAbortError, Qa as cancelThrottledBlockUpdate, To as newMessagesActions, Ua as useTimer, Vs as formatErrorMessage, Wo as abortCompletion, Xf as Provider_default, Xs as ERROR_I18N_KEY_STREAM_PAUSED, Yf as StoreSyncService_default, Yp as UNKNOWN, Ys as ERROR_I18N_KEY_REQUEST_TIMEOUT, Zs as ChunkType, an as getUserMessage, ba as ThemeProvider, cc as upsertOneBlock, cp as createErrorBlock, dp as createThinkingBlock, el as getDefaultAssistant, fs as pauseTrace, hp as MessageBlockStatus, io as throttledBlockUpdate, lp as createMainTextBlock, mp as AssistantMessageStatus, n as store_default, nl as getDefaultTopic, nn as getAssistantMessage, oc as updateOneBlock, op as databases_default, pa as CodeStyleProvider, pc as useSettings, pp as require_lodash, pt as ConversationService, qf as isMac, qs as isTimeoutError, rl as getDefaultTranslateAssistant, sc as upsertManyBlocks, st as fetchChatCompletion, t as persistor, tl as getDefaultModel, wr as useTranslate } from "./store-D3I1EUFZ.js";
import "./dayjs.min-A7WN91xd.js";
import { t as require_react } from "./react-1FqkuScD.js";
import "./stylis-BaN_JEhW.js";
import { Wt as button_default, ht as dropdown_default, k as RefreshIcon_default, xt as tooltip_default } from "./ImageViewer-VzHMoqVA.js";
...
import { t as Droplet } from "./droplet-DQkj6qw0.js";
import { t as Minus } from "./minus-DbmXelDU.js";
import { t as Pause } from "./pause-C4rh-RPc.js";
import { t as Pin } from "./pin-CzkO0DZ_.js";
import { t as Settings2 } from "./settings-2-CsoVGNIO.js";
import { t as X } from "./x-Co43ms80.js";
import "./es-JfNV08uB.js";
import { n as slider_default, t as CopyButton_default } from "./CopyButton-BdTIKUW1.js";
import { n as dt, r as ft } from "./styled-components.browser.esm-CytjnjfA.js";
...
import "./en_US-C3M08vtz.js";
import { r as useSelectionAssistant, t as DynamicIcon } from "./DynamicIcon-yFQU1jFK.js";
