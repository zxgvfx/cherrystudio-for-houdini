import { c as __toESM, i as __reExport, n as __esmMin, o as __toCommonJS, r as __export, t as __commonJSMin } from "./rolldown-runtime-D8OvLAZx.js";
import { H as isObject_default, N as _baseAssignValue_default, S as isObjectLike_default, U as _baseGetTag_default, V as isFunction_default, _ as isArrayLikeObject_default, b as isArray_default, d as _copyObject_default, f as _assignValue_default, h as _baseUnary_default, m as _nodeUtil_default, n as _isIterateeCall_default, r as _baseRest_default, s as identity_default, t as _createAssigner_default, v as isArrayLike_default, w as _isPrototype_default } from "./_createAssigner-BE3XE1ym.js";
import { t as isEmpty_default } from "./isEmpty-DmX_zWoN.js";
import { D as keys_default, M as _arrayMap_default, O as _arrayIncludes_default, S as _baseFlatten_default, _ as _arraySome_default, a as filter_default, b as _getAllKeysIn_default, f as _baseIteratee_default, g as _cacheHas_default, i as values_default, j as noop_default, k as _baseIndexOf_default, l as _arrayIncludesWith_default, n as reduce_default, o as _baseFilter_default, r as isUndefined_default, s as forEach_default, t as _baseUniq_default, u as _baseEach_default, v as _SetCache_default, x as _arrayFilter_default } from "./_baseUniq-euB0txCp.js";
import { a as isString_default, d as defaults_default, f as flatten_default, l as find_default, n as min_default, o as has_default, p as toInteger_default, s as map_default, t as _basePickBy_default, u as last_default } from "./_basePickBy-GFVPRxH8.js";
import { t as clone_default } from "./clone-BD2esSDk.js";
...
var RegExpParser = class {
	...
	positiveInteger() {
		let number$2 = this.popChar();
		// istanbul ignore next - can't ever get here due to previous lookahead checks
		if (decimalPatternNoZero.test(number$2) === false) throw Error("Expecting a positive integer");
		while (decimalPattern.test(this.peekChar(0))) number$2 += this.popChar();
		return parseInt(number$2, 10);
	}
	integerIncludingZero() {
		let number$2 = this.popChar();
		if (decimalPattern.test(number$2) === false) throw Error("Expecting an integer");
		while (decimalPattern.test(this.peekChar(0))) number$2 += this.popChar();
		return parseInt(number$2, 10);
	}
	patternCharacter() {
...
function negateTokenToRegex(negate$1) {
	return withCardinality(`(?!${abstractElementToRegex(negate$1.terminal)})${WILDCARD}*?`, {
		...
		parenthesized: negate$1.parenthesized
	});
}
...
function baseSlice(array$2, start, end) {
	var index = -1, length = array$2.length;
	...
	while (++index < length) result[index] = array$2[index + start];
	return result;
}
var _baseSlice_default = baseSlice;
function compact(array$2) {
	var index = -1, length = array$2 == null ? 0 : array$2.length, resIndex = 0, result = [];
	while (++index < length) {
		var value = array$2[index];
		if (value) result[resIndex++] = value;
	}
	return result;
}
var compact_default = compact;
function arrayAggregator(array$2, setter, iteratee, accumulator) {
	var index = -1, length = array$2 == null ? 0 : array$2.length;
	while (++index < length) {
		var value = array$2[index];
		setter(accumulator, value, iteratee(value), array$2);
	}
	return accumulator;
}
...
function createAggregator(setter, initializer) {
	return function(collection, iteratee) {
		var func$2 = isArray_default(collection) ? _arrayAggregator_default : _baseAggregator_default, accumulator = initializer ? initializer() : {};
		return func$2(collection, setter, _baseIteratee_default(iteratee, 2), accumulator);
	};
}
var _createAggregator_default = createAggregator;
var LARGE_ARRAY_SIZE = 200;
function baseDifference(array$2, values, iteratee, comparator) {
	var index = -1, includes$1 = _arrayIncludes_default, isCommon = true, length = array$2.length, result = [], valuesLength = values.length;
	...
	outer: while (++index < length) {
		var value = array$2[index], computed = iteratee == null ? value : iteratee(value);
...
var difference_default = _baseRest_default(function(array$2, values) {
	return isArrayLikeObject_default(array$2) ? _baseDifference_default(array$2, _baseFlatten_default(values, 1, isArrayLikeObject_default, true)) : [];
});
function drop(array$2, n, guard) {
	var length = array$2 == null ? 0 : array$2.length;
	if (!length) return [];
	n = guard || n === void 0 ? 1 : toInteger_default(n);
	return _baseSlice_default(array$2, n < 0 ? 0 : n, length);
}
var drop_default = drop;
function dropRight(array$2, n, guard) {
	var length = array$2 == null ? 0 : array$2.length;
	if (!length) return [];
	n = guard || n === void 0 ? 1 : toInteger_default(n);
	n = length - n;
	return _baseSlice_default(array$2, 0, n < 0 ? 0 : n);
}
var dropRight_default = dropRight;
function arrayEvery(array$2, predicate) {
	var index = -1, length = array$2 == null ? 0 : array$2.length;
	while (++index < length) if (!predicate(array$2[index], index, array$2)) return false;
	return true;
}
...
function every(collection, predicate, guard) {
	var func$2 = isArray_default(collection) ? _arrayEvery_default : _baseEvery_default;
	if (guard && _isIterateeCall_default(collection, predicate, guard)) predicate = void 0;
	return func$2(collection, _baseIteratee_default(predicate, 3));
}
var every_default = every;
function head(array$2) {
	return array$2 && array$2.length ? array$2[0] : void 0;
}
...
function indexOf(array$2, value, fromIndex) {
	var length = array$2 == null ? 0 : array$2.length;
	if (!length) return -1;
	var index = fromIndex == null ? 0 : toInteger_default(fromIndex);
	if (index < 0) index = nativeMax(length + index, 0);
	return _baseIndexOf_default(array$2, value, index);
}
...
function reject(collection, predicate) {
	return (isArray_default(collection) ? _arrayFilter_default : _baseFilter_default)(collection, negate_default(_baseIteratee_default(predicate, 3)));
}
...
function some(collection, predicate, guard) {
	var func$2 = isArray_default(collection) ? _arraySome_default : _baseSome_default;
	if (guard && _isIterateeCall_default(collection, predicate, guard)) predicate = void 0;
	return func$2(collection, _baseIteratee_default(predicate, 3));
}
var some_default = some;
function uniq(array$2) {
	return array$2 && array$2.length ? _baseUniq_default(array$2) : [];
}
var uniq_default = uniq;
function uniqBy(array$2, iteratee) {
	return array$2 && array$2.length ? _baseUniq_default(array$2, _baseIteratee_default(iteratee, 2)) : [];
}
...
function firstForBranching(prod) {
	return uniq_default(flatten_default(map_default(prod.definition, (innerProd) => {
...
function analyzeTokenTypes(tokenTypes, options) {
	...
	tracer("misc mapping", () => {
		...
		patternIdxToLongerAltIdxArr = map_default(onlyRelevantTypes, (clazz) => {
			...
			if (longerAltType) return isArray_default(longerAltType) ? map_default(longerAltType, (type) => indexOf_default(onlyRelevantTypes, type)) : [indexOf_default(onlyRelevantTypes, longerAltType)];
		});
...
function findMissingPatterns(tokenTypes) {
	...
	return {
		errors: map_default(tokenTypesWithMissingPattern, (currType) => {
			return {
...
function findInvalidPatterns(tokenTypes) {
	...
	return {
		errors: map_default(tokenTypesWithInvalidPattern, (currType) => {
			return {
...
function findEndOfInputAnchor(tokenTypes) {
	...
	return map_default(filter_default(tokenTypes, (currType) => {
		const pattern = currType.PATTERN;
		try {
...
function findDuplicatePatterns(tokenTypes) {
	...
	return map_default(filter_default(identicalPatterns, (currIdenticalSet) => {
...
function findInvalidGroupType(tokenTypes) {
	return map_default(filter_default(tokenTypes, (clazz) => {
...
function performRuntimeChecks(lexerDefinition, trackLines, lineTerminatorCharacters) {
	...
	if (has_default(lexerDefinition, "modes")) forEach_default(lexerDefinition.modes, (currModeValue, currModeName) => {
		forEach_default(currModeValue, (currTokType, currIdx) => {
			...
			else if (has_default(currTokType, "LONGER_ALT")) forEach_default(isArray_default(currTokType.LONGER_ALT) ? currTokType.LONGER_ALT : [currTokType.LONGER_ALT], (currLongerAlt) => {
...
function performWarningRuntimeChecks(lexerDefinition, trackLines, lineTerminatorCharacters) {
	...
	const concreteTokenTypes = reject_default(compact_default(flatten_default(values_default(lexerDefinition.modes))), (currType) => currType[PATTERN] === Lexer.NA);
...
function cloneEmptyGroups(emptyGroups) {
	const clonedResult = {};
	forEach_default(keys_default(emptyGroups), (currKey) => {
...
function getCharCodes(charsOrCodes) {
	return map_default(charsOrCodes, (numOrString) => {
	...
	constructor(lexerDefinition, config = DEFAULT_LEXER_CONFIG) {
		...
		this.TRACE_INIT("Lexer Constructor", () => {
			...
			if (!isEmpty_default(this.lexerDefinitionErrors) && !this.config.deferDefinitionErrorsHandling) {
				const allErrMessagesString = map_default(this.lexerDefinitionErrors, (error$2) => {
...
const defaultParserErrorProvider = {
	...
	buildNoViableAltMessage({ expectedPathsPerAlt, actual, previous, customUserDescription, ruleName }) {
		...
		else return `Expecting: one of these possible Token sequences:\n${map_default(map_default(reduce_default(expectedPathsPerAlt, (result, currAltPaths) => result.concat(currAltPaths), []), (currPath) => `[${map_default(currPath, (currTokenType) => tokenLabel(currTokenType)).join(", ")}]`), (itemMsg, idx) => `  ${idx + 1}. ${itemMsg}`).join("\n")}` + errSuffix;
	},
	buildEarlyExitMessage({ expectedIterationPaths, actual, customUserDescription, ruleName }) {
		const errPrefix = "Expecting: ";
		const errSuffix = "\nbut found: '" + head_default(actual).image + "'";
		if (customUserDescription) return errPrefix + customUserDescription + errSuffix;
		else return `Expecting: expecting at least one iteration which starts with one of these possible Token sequences::\n  <${map_default(expectedIterationPaths, (currPath) => `[${map_default(currPath, (currTokenType) => tokenLabel(currTokenType)).join(",")}]`).join(" ,")}>` + errSuffix;
	}
};
...
const defaultGrammarValidatorErrorProvider = {
	...
	buildLeftRecursionError(options) {
		...
		return `Left Recursion found in grammar.\nrule: <${ruleName}> can be invoked from itself (directly or indirectly)\nwithout consuming any Tokens. The grammar path that causes this is: \n ${`${ruleName} --> ${map_default(options.leftRecursionPath, (currRule) => currRule.name).concat([ruleName]).join(" --> ")}`}\n To fix this refactor your grammar to remove the left recursion.\nsee: https://en.wikipedia.org/wiki/LL_parser#Left_factoring.`;
	},
...
function buildAlternativesLookAheadFunc(alts, hasPredicates, tokenMatcher$1, dynamicTokensEnabled) {
	...
	if (hasPredicates) return function(orAlts) {
		...
		const choiceToAlt = reduce_default(map_default(alts, (currAlt) => {
...
function lookAheadSequenceFromAlternatives(altsDefs, k) {
	...
	const altsHashes = map_default(partialAlts, (currAltPaths) => {
		...
		forEach_default(currAltPaths, (item) => {
			forEach_default(pathToHashKeys(item.partialPath), (currKey) => {
				dict[currKey] = true;
			});
		});
		return dict;
	...
	for (let pathLength = 1; pathLength <= k; pathLength++) {
		...
		for (let altIdx = 0; altIdx < currDataset.length; altIdx++) {
			...
			for (let currPathIdx = 0; currPathIdx < currAltPathsAndSuffixes.length; currPathIdx++) {
				...
				if (isUniquePrefixHash(altsHashes, prefixKeys, altIdx) || isEmpty_default(suffixDef) || currPathPrefix.length === k) {
					...
					forEach_default(newPartialPathsAndSuffixes, (item) => {
						forEach_default(pathToHashKeys(item.partialPath), (key) => {
...
function validateDuplicateProductions(topLevelRule, errMsgProvider) {
	...
	return map_default(values_default(pickBy_default(groupBy_default(allRuleProductions, identifyProductionForDuplicates), (currGroup) => {
...
function validateRuleDoesNotAlreadyExist(rule, allRules, className, errMsgProvider) {
	const errors = [];
	if (reduce_default(allRules, (result, curRule) => {
...
function validateNoLeftRecursion(topRule, currRule, errMsgProvider, path = []) {
	...
	if (isEmpty_default(nextNonTerminals)) return [];
		...
		const errorsFromNextSteps = flatMap_default(difference_default(nextNonTerminals, path.concat([topRule])), (currRefRule) => {
...
function validateEmptyOrAlternative(topLevelRule, errMsgProvider) {
	...
	return flatMap_default(ors, (currOr) => {
		return flatMap_default(dropRight_default(currOr.definition), (currAlternative, currAltIdx) => {
			if (isEmpty_default(nextPossibleTokensAfter([currAlternative], [], tokenStructuredMatcher, 1))) return [{
...
function checkAlternativesAmbiguities(alternatives, alternation$1, rule, errMsgProvider) {
	...
	return map_default(reduce_default(alternatives, (result, currAlt, currAltIdx) => {
...
function checkPrefixAlternativesAmbiguities(alternatives, alternation$1, rule, errMsgProvider) {
	...
	return compact_default(flatMap_default(pathsAndIndices, (currPathAndIdx) => {
		if (alternation$1.definition[currPathAndIdx.idx].ignoreAmbiguities === true) return [];
		const targetIdx = currPathAndIdx.idx;
		const targetPath = currPathAndIdx.path;
		return map_default(filter_default(pathsAndIndices, (searchPathAndIdx) => {
...
function isRecognitionException(error$2) {
	return includes_default(RECOGNITION_EXCEPTION_NAMES, error$2.name);
}
...
var Recoverable = class {
	...
	tryInRepetitionRecovery(grammarRule, grammarRuleArgs, lookAheadFunc, expectedTokType) {
		...
		const generateErrorMessage = () => {
			...
			const error$2 = new MismatchedTokenException(this.errorMessageProvider.buildMismatchTokenMessage({
				expected: expectedTokType,
				actual: nextTokenWithoutResync,
				previous: previousToken,
				ruleName: this.getCurrRuleFullName()
			}), nextTokenWithoutResync, this.LA(0));
			error$2.resyncedTokens = dropRight_default(resyncedTokens);
			this.SAVE_ERROR(error$2);
		};
	...
	flattenFollowSet() {
		return flatten_default(map_default(this.buildFullFollowKeyStack(), (currKey) => {
...
var LLkLookaheadStrategy = class {
	constructor(options) {
		var _a$1;
		this.maxLookahead = (_a$1 = options === null || options === void 0 ? void 0 : options.maxLookahead) !== null && _a$1 !== void 0 ? _a$1 : DEFAULT_PARSER_CONFIG.maxLookahead;
	}
	validate(options) {
...
function validateMissingCstMethods(visitorInstance, ruleNames) {
	return compact_default(map_default(filter_default(ruleNames, (currRuleName) => {
...
var RecognizerApi = class {
	...
	RULE(name, implementation, config = DEFAULT_RULE_CONFIG) {
		if (includes_default(this.definedRulesNames, name)) {
			...
			this.definitionErrors.push(error$2);
		}
...
var RecognizerEngine = class {
	initRecognizerEngine(tokenVocabulary, config) {
		...
		else if (has_default(tokenVocabulary, "modes") && every_default(flatten_default(values_default(tokenVocabulary.modes)), isTokenType)) this.tokensMap = reduce_default(uniq_default(flatten_default(values_default(tokenVocabulary.modes))), (acc, tokType) => {
			acc[tokType.name] = tokType;
			return acc;
		}, {});
		...
		this.tokenMatcher = every_default(has_default(tokenVocabulary, "modes") ? flatten_default(values_default(tokenVocabulary.modes)) : values_default(tokenVocabulary), (tokenConstructor) => isEmpty_default(tokenConstructor.categoryMatches)) ? tokenStructuredMatcherNoCategories : tokenStructuredMatcher;
...
var ErrorHandler = class {
	...
	SAVE_ERROR(error$2) {
		if (isRecognitionException(error$2)) {
			error$2.context = {
				ruleStack: this.getHumanReadableRuleStack(),
...
var GastRecorder = class {
	...
	subruleInternalRecord(ruleToCall, occurrence, options) {
		...
		if (!ruleToCall || has_default(ruleToCall, "ruleName") === false) {
			const error$2 = /* @__PURE__ */ new Error(`<SUBRULE${getIdxSuffix(occurrence)}> argument is invalid expecting a Parser method reference but got: <${JSON.stringify(ruleToCall)}>\n inside top level rule: <${this.recordingProdStack[0].name}>`);
			error$2.KNOWN_RECORDER_ERROR = true;
			throw error$2;
		}
	...
	consumeInternalRecord(tokType, occurrence, options) {
		...
		if (!hasShortKeyProperty(tokType)) {
			const error$2 = /* @__PURE__ */ new Error(`<CONSUME${getIdxSuffix(occurrence)}> argument is invalid expecting a TokenType reference but got: <${JSON.stringify(tokType)}>\n inside top level rule: <${this.recordingProdStack[0].name}>`);
			error$2.KNOWN_RECORDER_ERROR = true;
			throw error$2;
		}
		const prevProd = last_default(this.recordingProdStack);
...
function assertMethodIdxIsValid(idx) {
	if (idx < 0 || idx > MAX_METHOD_IDX) {
		const error$2 = /* @__PURE__ */ new Error(`Invalid DSL Method idx value: <${idx}>\n\tIdx value must be a none negative value smaller than ${MAX_METHOD_IDX + 1}`);
		error$2.KNOWN_RECORDER_ERROR = true;
		throw error$2;
	}
}
		...
		this.TRACE_INIT("performSelfAnalysis", () => {
			...
			if (isEmpty_default(this.definitionErrors)) {
				...
				this.TRACE_INIT("ComputeLookaheadFunctions", () => {
					var _a$1, _b;
					(_b = (_a$1 = this.lookaheadStrategy).initialize) === null || _b === void 0 || _b.call(_a$1, { rules: values_default(this.gastProductionsCache) });
...
var LLStarLookaheadStrategy = class extends LLkLookaheadStrategy {
	constructor(options) {
		var _a$1;
		super();
		this.logging = (_a$1 = options === null || options === void 0 ? void 0 : options.logging) !== null && _a$1 !== void 0 ? _a$1 : ((message) => console.log(message));
	}
	initialize(options) {
		...
		if (isLL1Sequence(partialAlts, false) && !dynamicTokensEnabled) {
			...
			if (hasPredicates) return function(orAlts) {
				...
				if (orAlts !== void 0 && prediction !== void 0) {
					const gate = (_a$1 = orAlts[prediction]) === null || _a$1 === void 0 ? void 0 : _a$1.GATE;
...
var init_main = __esmMin((() => {
	...
	(function(WorkspaceFolder$1) {
		function is$1(value) {
			const candidate = value;
			return Is$7.objectLiteral(candidate) && URI$1.is(candidate.uri) && Is$7.string(candidate.name);
		}
...
var require_cancellation = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var ral_1$5 = require_ral();
	var Is$6 = require_is$1();
	var events_1$4 = require_events();
	...
	(function(CancellationToken$11) {
		...
		function is$1(value) {
			const candidate = value;
			return candidate && (candidate === CancellationToken$11.None || candidate === CancellationToken$11.Cancelled || Is$6.boolean(candidate.isCancellationRequested) && !!candidate.onCancellationRequested);
		}
		CancellationToken$11.is = is$1;
...
var MultiMap = class {
	...
	forEach(callbackfn) {
		this.map.forEach((array$2, key) => array$2.forEach((value) => callbackfn(value, key, this)));
	}
	[Symbol.iterator]() {
		return this.entries().iterator();
	}
	entries() {
		return stream(this.map.entries()).flatMap(([key, array$2]) => array$2.map((value) => [key, value]));
	}
	keys() {
	...
	reviveReference(container, property, root, reference, options) {
		...
		if (reference.$ref) {
			...
			if (refs.length === 0) {
				...
				error$2 ?? (error$2 = "Could not resolve multi-reference");
			} else return {
				$refText: refText ?? "",
				items: refs
			};
...
(function(ValidationCategory$1) {
	ValidationCategory$1.defaults = [
		"fast",
		"slow",
		"built-in"
	];
	ValidationCategory$1.all = ValidationCategory$1.defaults;
...
var require_messages$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	exports.ResponseError = class ResponseError$1 extends Error {
		constructor(code, message, data) {
			super(message);
			this.code = is.number(code) ? code : ErrorCodes.UnknownErrorCode;
			this.data = data;
			Object.setPrototypeOf(this, ResponseError$1.prototype);
		}
		toJson() {
			const result = {
				code: this.code,
...
var require_disposable = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var Disposable$1;
	(function(Disposable$2) {
		function create(func$2) {
			return { dispose: func$2 };
		}
		Disposable$2.create = create;
	})(Disposable$1 || (exports.Disposable = Disposable$1 = {}));
}));
var require_sharedArrayCancellation = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.SharedArrayReceiverStrategy = exports.SharedArraySenderStrategy = void 0;
	var cancellation_1$2 = require_cancellation();
...
var require_messageReader = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var ral_1$3 = require_ral();
	var Is$5 = require_is$1();
	var events_1$3 = require_events();
	var semaphore_1$1 = require_semaphore();
	var MessageReader;
	...
	var AbstractMessageReader = class {
		...
		asError(error$2) {
			...
			else return /* @__PURE__ */ new Error(`Reader received error. Reason: ${Is$5.string(error$2.message) ? error$2.message : "unknown"}`);
		}
	};
...
var require_messageWriter = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var ral_1$2 = require_ral();
	var Is$4 = require_is$1();
	var semaphore_1 = require_semaphore();
	var events_1$2 = require_events();
	...
	var AbstractMessageWriter = class {
		...
		asError(error$2) {
			if (error$2 instanceof Error) return error$2;
			else return /* @__PURE__ */ new Error(`Writer received error. Reason: ${Is$4.string(error$2.message) ? error$2.message : "unknown"}`);
		}
	};
...
var require_connection$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var Is$3 = require_is$1();
	var messages_1$23 = require_messages$1();
	var linkedMap_1$1 = require_linkedMap();
	var events_1$1 = require_events();
	var cancellation_1$1 = require_cancellation();
	...
	function createMessageConnection$1(messageReader, messageWriter, _logger, options) {
		...
		function triggerMessageQueue() {
			if (timer$1 || messageQueue.size === 0) return;
			timer$1 = (0, ral_1$1.default)().timer.setImmediate(() => {
				timer$1 = void 0;
				processMessageQueue();
			});
		}
		...
		const connection = {
			sendNotification: (type, ...args) => {
				...
				if (Is$3.string(type)) {
					method = type;
					const first$1 = args[0];
					let paramStart = 0;
					let parameterStructures = messages_1$23.ParameterStructures.auto;
					if (messages_1$23.ParameterStructures.is(first$1)) {
						paramStart = 1;
						parameterStructures = first$1;
					}
...
var require_api$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var messages_1$22 = require_messages$1();
	...
	var connection_1$1 = require_connection$1();
...
var require_messages = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var vscode_jsonrpc_1$3 = require_main$1();
...
var require_protocol_implementation = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var messages_1$21 = require_messages();
...
var require_protocol_typeDefinition = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var messages_1$20 = require_messages();
...
var require_protocol_workspaceFolder = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var messages_1$19 = require_messages();
...
var require_protocol_configuration = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var messages_1$18 = require_messages();
...
var require_protocol_colorProvider = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var messages_1$17 = require_messages();
...
var require_protocol_foldingRange = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var messages_1$16 = require_messages();
...
var require_protocol_declaration = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var messages_1$15 = require_messages();
...
var require_protocol_selectionRange = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var messages_1$14 = require_messages();
...
var require_protocol_progress = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var vscode_jsonrpc_1$2 = require_main$1();
	var messages_1$13 = require_messages();
...
var require_protocol_callHierarchy = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var messages_1$12 = require_messages();
...
var require_protocol_semanticTokens = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var messages_1$11 = require_messages();
	var TokenFormat;
...
var require_protocol_showDocument = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var messages_1$10 = require_messages();
...
var require_protocol_linkedEditingRange = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var messages_1$9 = require_messages();
...
var require_protocol_fileOperations = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var messages_1$8 = require_messages();
...
var require_protocol_moniker = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var messages_1$7 = require_messages();
	var UniquenessLevel;
...
var require_protocol_typeHierarchy = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var messages_1$6 = require_messages();
...
var require_protocol_inlineValue = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var messages_1$5 = require_messages();
...
var require_protocol_inlayHint = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var messages_1$4 = require_messages();
...
var require_protocol_diagnostic = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var vscode_jsonrpc_1$1 = require_main$1();
	var Is$2 = require_is();
	var messages_1$3 = require_messages();
...
var require_protocol_notebook = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var vscode_languageserver_types_1$1 = (init_main(), __toCommonJS(main_exports));
	var Is$1 = require_is();
	var messages_1$2 = require_messages();
...
var require_protocol_inlineCompletion = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var messages_1$1 = require_messages();
...
var require_api = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var LSPErrorCodes$1;
	(function(LSPErrorCodes$2) {
		LSPErrorCodes$2.lspReservedErrorRangeStart = -32899;
		LSPErrorCodes$2.RequestFailed = -32803;
		LSPErrorCodes$2.ServerCancelled = -32802;
		LSPErrorCodes$2.ContentModified = -32801;
		LSPErrorCodes$2.RequestCancelled = -32800;
		LSPErrorCodes$2.lspReservedErrorRangeEnd = -32800;
	})(LSPErrorCodes$1 || (exports.LSPErrorCodes = LSPErrorCodes$1 = {}));
}));
...
var DefaultIndexManager = class {
	...
	async updateContent(document, cancelToken = cancellation_exports.CancellationToken.None) {
		const exports$1 = await this.serviceRegistry.getServices(document.uri).references.ScopeComputation.collectExportedSymbols(document, cancelToken);
...
function isJSDoc(node, options) {
	...
	return Boolean(firstRegex?.exec(first$1)) && Boolean(lastRegex?.exec(last));
}
...
function _resolve(obj, prop, module$1, injector) {
	if (prop in obj) {
		...
		try {
			...
			obj[prop] = error$2 instanceof Error ? error$2 : void 0;
			throw error$2;
		}
		return obj[prop];
	} else return;
