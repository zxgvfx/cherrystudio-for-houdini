...
import { a as KnowledgeBaseGroupIdInputSchema, c as KnowledgeItemTypeSchema, r as KnowledgeBaseEntitySchema } from "./knowledge-CVZUSImo.js";
...
const useKnowledgeBases = (options = {}) => {
	...
	return {
		bases: (0, import_react.useMemo)(() => data?.items ?? [], [data]),
		isLoading,
		error,
		refetch
	};
