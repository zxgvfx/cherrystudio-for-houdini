const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./highlighted-body-OFNGDK62-DjXO466m.js","./lib-BGOUa2xQ.js","./chunk-DiqNceaa.js","./marked.esm-Dt1bmnBy.js","./react-dom-CKbeLgrG.js","./react-BgPOU4At.js","./jsx-runtime-DCB_IiL2.js","./mermaid-GHXKKRXX-BaRubaEq.js"])))=>i.map(i=>d[i]);
...
`;) t--;
	return e.slice(0, t);
}, cr = (0, import_react.lazy)(() => __vitePreload(() => import("./highlighted-body-OFNGDK62-DjXO466m.js"), __vite__mapDeps([0,1,2,3,4,5,6]), import.meta.url).then((e) => ({ default: e.HighlightedCodeBlockBody }))), st = ({ code: e, language: t, className: o, children: n, isIncomplete: r = false, startLine: s$1, lineNumbers: a, ...l }) => {
...
var es = /startLine=(\d+)/, ts = /\bnoLineNumbers\b/, os = (0, import_react.lazy)(() => __vitePreload(() => import("./mermaid-GHXKKRXX-BaRubaEq.js"), __vite__mapDeps([7,1,2,3,4,5,6]), import.meta.url).then((e) => ({ default: e.Mermaid }))), ns = /language-([^\s]+)/;
function qe(e, t) {
