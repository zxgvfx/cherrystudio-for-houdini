...
var EditableNumber = ({ value, min, max, step = .01, precision, placeholder, disabled = false, onChange, onBlur, changeOnBlur = false, style, className, size = "middle", align = "end", suffix, prefix, formatter, block = false }) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
			...
			className: cn("border-input bg-background flex w-full cursor-text items-center rounded-md border px-3 text-sm shadow-xs outline-none transition-[color,box-shadow]", "focus-visible:border-primary", disabled && "pointer-events-none cursor-not-allowed opacity-50", alignClasses[align], sizeClasses[size], className),
			onClick: handleFocus,
