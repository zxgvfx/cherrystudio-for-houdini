const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./katex-B8B3PC4k.js","./katex-DL1vLdSP.js"])))=>i.map(i=>d[i]);
import { t as __vitePreload } from "./preload-helper-Ds6i2_-X.js";
import { t as purify } from "./purify.es-DVK4qXZQ.js";
import { i as setLogLevel, n as __name, r as log, t as __export } from "./src-Dn7yUkKm.js";
var Channel = {
	min: {
		r: 0,
		g: 0,
...
var renderKatexUnsanitized = /* @__PURE__ */ __name(async (text, config2) => {
	...
	if (!(isMathMLSupported() || config2.legacyMathML || config2.forceLegacyMathML)) return text.replace(katexRegex, "MathML is unsupported in this environment.");
	{
		const { default: katex } = await __vitePreload(async () => {
			const { default: katex$1 } = await import("./katex-B8B3PC4k.js");
