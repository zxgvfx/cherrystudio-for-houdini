import { H as safeParseAsync, I as toJSONSchema } from "./v4-_VdBfIuS.js";
...
function createProviderDefinedToolFactory({ id, name: name$1, inputSchema }) {
...
function createProviderDefinedToolFactoryWithOutputSchema({ id, name: name$1, inputSchema, outputSchema }) {
...
function parseArrayDef(def, refs) {
	...
	if (((_a$1 = def.type) == null ? void 0 : _a$1._def) && ((_c = (_b = def.type) == null ? void 0 : _b._def) == null ? void 0 : _c.typeName) !== ZodFirstPartyTypeKind.ZodAny) res.items = parseDef(def.type._def, {
		...refs,
...
function addFormat(schema, value, message, refs) {
	var _a$1;
	if (schema.format || ((_a$1 = schema.anyOf) == null ? void 0 : _a$1.some((x) => x.format))) {
...
function addPattern(schema, regex, message, refs) {
	var _a$1;
	if (schema.pattern || ((_a$1 = schema.allOf) == null ? void 0 : _a$1.some((x) => x.pattern))) {
			...
			if (inCharGroup) {
				if (source[i].match(/[a-z]/)) {
					if (inCharRange) {
						...
						inCharRange = false;
					} else if (source[i + 1] === "-" && ((_a$1 = source[i + 2]) == null ? void 0 : _a$1.match(/[a-z]/))) {
						pattern += source[i];
						inCharRange = true;
...
function parseRecordDef(def, refs) {
	...
	const schema = {
		type: "object",
		additionalProperties: (_a$1 = parseDef(def.valueType._def, {
			...refs,
			currentPath: [...refs.currentPath, "additionalProperties"]
		})) != null ? _a$1 : refs.allowedAdditionalProperties
	};
...
var parseOptionalDef = (def, refs) => {
	var _a$1;
	if (refs.currentPath.toString() === ((_a$1 = refs.propertyPath) == null ? void 0 : _a$1.toString())) return parseDef(def.innerType._def, refs);
...
function parseDef(def, refs, forceResolution = false) {
	...
	if (refs.override) {
		const overrideResult = (_a$1 = refs.override) == null ? void 0 : _a$1.call(refs, def, refs, seenItem, forceResolution);
...
var zodToJsonSchema = (schema, options) => {
	...
	let definitions = typeof options === "object" && options.definitions ? Object.entries(options.definitions).reduce((acc, [name2$1, schema2]) => {
		var _a2$1;
		return {
			...acc,
			[name2$1]: (_a2$1 = parseDef(schema2._def, {
				...refs,
				currentPath: [
					...refs.basePath,
					refs.definitionPath,
			...
			}, true)) != null ? _a2$1 : parseAnyDef()
		};
	}, {}) : void 0;
	const name$1 = typeof options === "string" ? options : (options == null ? void 0 : options.nameStrategy) === "title" ? void 0 : options == null ? void 0 : options.name;
	const main = (_a$1 = parseDef(schema._def, name$1 === void 0 ? refs : {
		...refs,
		currentPath: [
			...refs.basePath,
			refs.definitionPath,
...
function zod4Schema(zodSchema2, options) {
	...
	return jsonSchema(z4JSONSchema, { validate: async (value) => {
...
export { mediaTypeToExtension as A, parseProviderOptions as B, postFormDataToApi as C, postJsonToApi as D, removeUndefinedEntries as E, resolve as F, safeParseJSON as G, safeValidateTypes as H, tool as I, validateTypes as J, withUserAgentSuffix as K, withoutTrailingSlash as L, AISDKError as M, APICallError as N, EmptyResponseBodyError as O, InvalidPromptError as P, InvalidResponseDataError as Q, JSONParseError as R, NoSuchModelError as S, TooManyEmbeddingValuesForCallError as T, TypeValidationError as U, UnsupportedFunctionalityError as V, getErrorMessage$1 as W, isJSONArray as X, isJSONObject as Y, asSchema as b, combineHeaders as c, convertBase64ToUint8Array as d, convertToBase64 as e, convertUint8ArrayToBase64 as f, createBinaryResponseHandler as g, createEventSourceResponseHandler as h, createIdGenerator as i, createJsonErrorResponseHandler as j, createJsonResponseHandler as k, createProviderDefinedToolFactory as l, createProviderDefinedToolFactoryWithOutputSchema as m, delay as n, executeTool as o, extractResponseHeaders as p, generateId as q, getErrorMessage as r, getFromApi as s, isAbortError as t, isParsableJson as u, isUrlSupported as v, jsonSchema as w, loadApiKey as x, loadOptionalSetting as y, loadSetting as z };
