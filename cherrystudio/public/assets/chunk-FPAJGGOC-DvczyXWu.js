import { i as __reExport, o as __toESM, r as __export, t as __commonJSMin } from "./chunk-0ogMdkZ1.js";
import { a as _baseUniq_default, c as filter_default, d as _baseIteratee_default, n as forEach_default, s as _baseFlatten_default, t as reduce_default } from "./reduce-CBXB-mBy.js";
import { t as isEmpty_default } from "./isEmpty-eU5w6VY6.js";
import { a as map_default, n as min_default, t as flatten_default } from "./flatten-BrMCaMvI.js";
...
var TreeStreamImpl = class extends StreamImpl {
	constructor(root$1, children, options) {
		super(() => ({
			iterators: (options === null || options === void 0 ? void 0 : options.includeRoot) ? [[root$1][Symbol.iterator]()] : [children(root$1)[Symbol.iterator]()],
			pruned: false
		}), (state) => {
			if (state.pruned) {
				state.iterators.pop();
...
function getNextNode(node, hidden = true) {
	while (node.container) {
		const parent = node.container;
		let index = parent.content.indexOf(node);
		const last$1 = parent.content.length - 1;
		while (index < last$1) {
			index++;
...
function streamContents(node, options) {
	...
	return new StreamImpl(() => ({
		...
		while (state.keyIndex < state.keys.length) {
			const property$1 = state.keys[state.keyIndex];
			if (!property$1.startsWith("$")) {
				const value = node[property$1];
				if (isAstNode(value)) {
					state.keyIndex++;
...
function streamAllContents(root$1, options) {
	if (!root$1) throw new Error("Root node must be an AstNode.");
	return new TreeStreamImpl(root$1, (node) => streamContents(node, options));
}
function streamAst(root$1, options) {
	if (!root$1) throw new Error("Root node must be an AstNode.");
	else if ((options === null || options === void 0 ? void 0 : options.range) && !isAstNodeInRange(root$1, options.range)) return new TreeStreamImpl(root$1, () => []);
	return new TreeStreamImpl(root$1, (node) => streamContents(node, options), { includeRoot: true });
}
...
function assignMandatoryProperties(reflection$2, node) {
	...
	for (const property$1 of typeMetaData.properties) if (property$1.defaultValue !== void 0 && genericNode[property$1.name] === void 0) genericNode[property$1.name] = copyDefaultValue(property$1.defaultValue);
}
...
function findNodesForProperty(node, property$1) {
	if (!node || !property$1) return [];
	return findNodesForPropertyInternal(node, property$1, node.astNode, true);
}
function findNodeForProperty(node, property$1, index) {
	if (!node || !property$1) return;
	const nodes = findNodesForPropertyInternal(node, property$1, node.astNode, true);
	if (nodes.length === 0) return;
	if (index !== void 0) index = Math.max(0, Math.min(index, nodes.length - 1));
	else index = 0;
	return nodes[index];
}
function findNodesForPropertyInternal(node, property$1, element, first$1) {
	if (!first$1) {
		const nodeFeature = getContainerOfType(node.grammarSource, isAssignment);
		if (nodeFeature && nodeFeature.feature === property$1) return [node];
	}
	if (isCompositeCstNode(node) && node.astNode === element) return node.content.flatMap((e) => findNodesForPropertyInternal(e, property$1, element, false));
	return [];
}
...
function baseTrim(string$1) {
	return string$1 ? string$1.slice(0, _trimmedEndIndex_default(string$1) + 1).replace(reTrimStart, "") : string$1;
}
...
function isMasked(func$1) {
	return !!maskSrcKey && maskSrcKey in func$1;
}
var _isMasked_default = isMasked;
var funcToString$1 = Function.prototype.toString;
function toSource(func$1) {
	if (func$1 != null) {
		try {
			return funcToString$1.call(func$1);
		} catch (e) {}
		try {
			return func$1 + "";
		} catch (e) {}
...
function apply(func$1, thisArg, args) {
	switch (args.length) {
		case 0: return func$1.call(thisArg);
		case 1: return func$1.call(thisArg, args[0]);
		case 2: return func$1.call(thisArg, args[0], args[1]);
		case 3: return func$1.call(thisArg, args[0], args[1], args[2]);
	}
	return func$1.apply(thisArg, args);
}
...
function shortOut(func$1) {
	...
	return function() {
		...
		return func$1.apply(void 0, arguments);
	};
}
...
var _defineProperty_default = function() {
	try {
		var func$1 = _getNative_default(Object, "defineProperty");
		func$1({}, "", {});
		return func$1;
	} catch (e) {}
}();
var _setToString_default = _shortOut_default(!_defineProperty_default ? identity_default : function(func$1, string$1) {
	return _defineProperty_default(func$1, "toString", {
		"configurable": true,
		"enumerable": false,
		"value": constant_default(string$1),
		"writable": true
	});
});
function arrayEach(array$1, iteratee) {
	var index = -1, length = array$1 == null ? 0 : array$1.length;
	while (++index < length) if (iteratee(array$1[index], index, array$1) === false) break;
	return array$1;
}
...
function baseIndexOf(array$1, value, fromIndex) {
	return value === value ? _strictIndexOf_default(array$1, value, fromIndex) : _baseFindIndex_default(array$1, _baseIsNaN_default, fromIndex);
}
var _baseIndexOf_default = baseIndexOf;
function arrayIncludes(array$1, value) {
	return !!(array$1 == null ? 0 : array$1.length) && _baseIndexOf_default(array$1, value, 0) > -1;
}
...
function assignValue(object, key, value) {
	...
	if (!(hasOwnProperty$14.call(object, key) && eq_default(objValue, value)) || value === void 0 && !(key in object)) _baseAssignValue_default(object, key, value);
}
...
function overRest(func$1, start, transform) {
	start = nativeMax$3(start === void 0 ? func$1.length - 1 : start, 0);
	return function() {
		...
		return _apply_default(func$1, this, otherArgs);
	};
}
var _overRest_default = overRest;
function baseRest(func$1, start) {
	return _setToString_default(_overRest_default(func$1, start, identity_default), func$1 + "");
}
...
function baseIsArguments(value) {
	return isObjectLike_default(value) && _baseGetTag_default(value) == argsTag$3;
}
...
var isArguments_default = _baseIsArguments_default(function() {
	...
	return isObjectLike_default(value) && hasOwnProperty$13.call(value, "callee") && !propertyIsEnumerable$1.call(value, "callee");
};
function stubFalse() {
	return false;
}
...
function arrayLikeKeys(value, inherited) {
	var isArr = isArray_default(value), isArg = !isArr && isArguments_default(value), isBuff = !isArr && !isArg && isBuffer_default(value), isType$1 = !isArr && !isArg && !isBuff && isTypedArray_default(value), skipIndexes = isArr || isArg || isBuff || isType$1, result = skipIndexes ? _baseTimes_default(value.length, String) : [], length = result.length;
	for (var key in value) if ((inherited || hasOwnProperty$12.call(value, key)) && !(skipIndexes && (key == "length" || isBuff && (key == "offset" || key == "parent") || isType$1 && (key == "buffer" || key == "byteLength" || key == "byteOffset") || _isIndex_default(key, length)))) result.push(key);
	return result;
}
var _arrayLikeKeys_default = arrayLikeKeys;
function overArg(func$1, transform) {
	return function(arg) {
		return func$1(transform(arg));
	};
}
...
var assign_default = _createAssigner_default(function(object, source) {
	if (_isPrototype_default(source) || isArrayLike_default(source)) {
		_copyObject_default(source, keys_default(source), object);
		return;
	}
	for (var key in source) if (hasOwnProperty$10.call(source, key)) _assignValue_default(object, key, source[key]);
});
...
function assocIndexOf(array$1, key) {
	...
	while (length--) if (eq_default(array$1[length][0], key)) return length;
	return -1;
}
...
function memoize(func$1, resolver) {
	if (typeof func$1 != "function" || resolver != null && typeof resolver != "function") throw new TypeError(FUNC_ERROR_TEXT$1);
	var memoized = function() {
		var args = arguments, key = resolver ? resolver.apply(this, args) : args[0], cache = memoized.cache;
		if (cache.has(key)) return cache.get(key);
		var result = func$1.apply(this, args);
...
function memoizeCapped(func$1) {
	var result = memoize_default(func$1, function(key) {
...
var reEscapeChar = /\\(\\)?/g;
var _stringToPath_default = _memoizeCapped_default(function(string$1) {
	var result = [];
	if (string$1.charCodeAt(0) === 46) result.push("");
	string$1.replace(rePropName, function(match, number$1, quote, subString) {
		result.push(quote ? subString.replace(reEscapeChar, "$1") : number$1 || match);
	});
	return result;
});
...
var get_default = get;
function arrayPush(array$1, values$1) {
	var index = -1, length = values$1.length, offset = array$1.length;
	while (++index < length) array$1[offset + index] = values$1[index];
	return array$1;
}
...
function baseFlatten(array$1, depth, predicate, isStrict, result) {
...
var _baseFlatten_default$1 = baseFlatten;
function flatten(array$1) {
	return (array$1 == null ? 0 : array$1.length) ? _baseFlatten_default$1(array$1, 1) : [];
}
var flatten_default$1 = flatten;
...
if (_DataView_default && getTag(new _DataView_default(/* @__PURE__ */ new ArrayBuffer(1))) != dataViewTag$3 || _Map_default && getTag(new _Map_default()) != mapTag$5 || _Promise_default && getTag(_Promise_default.resolve()) != promiseTag || _Set_default && getTag(new _Set_default()) != setTag$5 || _WeakMap_default && getTag(new _WeakMap_default()) != weakMapTag$1) getTag = function(value) {
	var result = _baseGetTag_default(value), Ctor = result == objectTag$2 ? value.constructor : void 0, ctorString = Ctor ? _toSource_default(Ctor) : "";
...
function initCloneArray(array$1) {
	var length = array$1.length, result = new array$1.constructor(length);
	if (length && typeof array$1[0] == "string" && hasOwnProperty$6.call(array$1, "index")) {
...
function initCloneByTag(object, tag, isDeep) {
	...
	switch (tag) {
		...
		case regexpTag$3: return _cloneRegExp_default(object);
...
function baseIsMap(value) {
	return isObjectLike_default(value) && _getTag_default(value) == mapTag$3;
}
...
function baseIsSet(value) {
	return isObjectLike_default(value) && _getTag_default(value) == setTag$3;
}
...
function equalArrays(array$1, other, bitmask, customizer, equalFunc, stack) {
...
var _baseIteratee_default$1 = baseIteratee;
...
function createAggregator(setter, initializer) {
	return function(collection, iteratee) {
		...
		return func$1(collection, setter, _baseIteratee_default$1(iteratee, 2), accumulator);
	};
}
...
var defaults_default = _baseRest_default(function(object, sources) {
	...
	while (++index < length) {
		...
		while (++propsIndex < propsLength) {
			...
			if (value === void 0 || eq_default(value, objectProto[key]) && !hasOwnProperty$3.call(object, key)) object[key] = source[key];
		}
	}
	return object;
});
...
function baseDifference(array$1, values$1, iteratee, comparator) {
	var index = -1, includes$1 = _arrayIncludes_default, isCommon = true, length = array$1.length, result = [], valuesLength = values$1.length;
	if (!length) return result;
	if (iteratee) values$1 = _arrayMap_default(values$1, _baseUnary_default(iteratee));
	if (comparator) {
		includes$1 = _arrayIncludesWith_default;
		isCommon = false;
	} else if (values$1.length >= LARGE_ARRAY_SIZE$1) {
		includes$1 = _cacheHas_default;
		isCommon = false;
		values$1 = new _SetCache_default(values$1);
	}
	outer: while (++index < length) {
		...
		if (isCommon && computed === computed) {
			...
			result.push(value);
		} else if (!includes$1(values$1, computed, comparator)) result.push(value);
	}
	return result;
}
var _baseDifference_default = baseDifference;
var difference_default = _baseRest_default(function(array$1, values$1) {
	return isArrayLikeObject_default(array$1) ? _baseDifference_default(array$1, _baseFlatten_default$1(values$1, 1, isArrayLikeObject_default, true)) : [];
});
...
function every(collection, predicate, guard) {
	...
	return func$1(collection, _baseIteratee_default$1(predicate, 3));
}
...
function filter(collection, predicate) {
	return (isArray_default(collection) ? _arrayFilter_default : _baseFilter_default)(collection, _baseIteratee_default$1(predicate, 3));
}
...
function createFind(findIndexFunc) {
	return function(collection, predicate, fromIndex) {
		...
		if (!isArrayLike_default(collection)) {
			var iteratee = _baseIteratee_default$1(predicate, 3);
...
function findIndex(array$1, predicate, fromIndex) {
	...
	return _baseFindIndex_default(array$1, _baseIteratee_default$1(predicate, 3), index);
}
...
function map(collection, iteratee) {
	return (isArray_default(collection) ? _arrayMap_default : _baseMap_default)(collection, _baseIteratee_default$1(iteratee, 3));
}
var map_default$1 = map;
function flatMap$1(collection, iteratee) {
	return _baseFlatten_default$1(map_default$1(collection, iteratee), 1);
}
var flatMap_default$1 = flatMap$1;
var hasOwnProperty$2 = Object.prototype.hasOwnProperty;
var groupBy_default = _createAggregator_default(function(result, value, key) {
...
var isRegExp_default = nodeIsRegExp ? _baseUnary_default(nodeIsRegExp) : _baseIsRegExp_default;
...
function pickBy(object, predicate) {
	...
	predicate = _baseIteratee_default$1(predicate);
...
function reduce(collection, iteratee, accumulator) {
	var func$1 = isArray_default(collection) ? _arrayReduce_default : _baseReduce_default, initAccum = arguments.length < 3;
	return func$1(collection, _baseIteratee_default$1(iteratee, 4), accumulator, initAccum, _baseEach_default);
}
var reduce_default$1 = reduce;
function reject(collection, predicate) {
	return (isArray_default(collection) ? _arrayFilter_default : _baseFilter_default)(collection, negate_default(_baseIteratee_default$1(predicate, 3)));
}
...
function baseUniq(array$1, iteratee, comparator) {
	var index = -1, includes$1 = _arrayIncludes_default, length = array$1.length, isCommon = true, result = [], seen = result;
	if (comparator) {
		isCommon = false;
		includes$1 = _arrayIncludesWith_default;
	} else if (length >= LARGE_ARRAY_SIZE) {
		var set = iteratee ? null : _createSet_default(array$1);
...
var _baseUniq_default$1 = baseUniq;
function uniq(array$1) {
	return array$1 && array$1.length ? _baseUniq_default$1(array$1) : [];
}
...
var AbstractProduction = class {
	...
	accept(visitor$1) {
		...
		forEach_default$1(this.definition, (prod) => {
...
function serializeGrammar(topRules) {
	return map_default$1(topRules, serializeProduction);
}
function serializeProduction(node) {
	function convertDefinition(definition) {
		return map_default$1(definition, serializeProduction);
	}
	/* istanbul ignore else */
...
var RestWalker = class {
	walk(prod, prevRest = []) {
		forEach_default$1(prod.definition, (subProd, index) => {
	...
	walkOr(orProd, currRest, prevRest) {
		const fullOrRest = currRest.concat(prevRest);
		forEach_default$1(orProd.definition, (alt) => {
...
function firstForBranching(prod) {
	return uniq_default(flatten_default$1(map_default$1(prod.definition, (innerProd) => {
...
function computeAllProdsFollows(topProductions) {
	const reSyncFollows = {};
	forEach_default$1(topProductions, (topProd) => {
			...
			for (let i = 0; i < terms.length; i++) {
				...
				switch (atom$1.type) {
					...
					case "Set":
						...
						forEach_default$1(atom$1.value, (code) => {
...
function analyzeTokenTypes(tokenTypes, options) {
	...
	tracer("Transform Patterns", () => {
		hasCustom = false;
		allTransformedPatterns = map_default$1(onlyRelevantTypes, (currType) => {
	...
	tracer("misc mapping", () => {
		patternIdxToType = map_default$1(onlyRelevantTypes, (currType) => currType.tokenTypeIdx);
		patternIdxToGroup = map_default$1(onlyRelevantTypes, (clazz) => {
		...
		patternIdxToLongerAltIdxArr = map_default$1(onlyRelevantTypes, (clazz) => {
			const longerAltType = clazz.LONGER_ALT;
			if (longerAltType) return isArray_default(longerAltType) ? map_default$1(longerAltType, (type) => indexOf_default(onlyRelevantTypes, type)) : [indexOf_default(onlyRelevantTypes, longerAltType)];
		});
		patternIdxToPushMode = map_default$1(onlyRelevantTypes, (clazz) => clazz.PUSH_MODE);
		patternIdxToPopMode = map_default$1(onlyRelevantTypes, (clazz) => has_default(clazz, "POP_MODE"));
	});
	let patternIdxToCanLineTerminator;
	tracer("Line Terminator Handling", () => {
		const lineTerminatorCharCodes = getCharCodes(options.lineTerminatorCharacters);
		patternIdxToCanLineTerminator = map_default$1(onlyRelevantTypes, (tokType) => false);
		if (options.positionTracking !== "onlyOffset") patternIdxToCanLineTerminator = map_default$1(onlyRelevantTypes, (tokType) => {
	...
	tracer("Misc Mapping #2", () => {
		patternIdxToIsCustom = map_default$1(onlyRelevantTypes, isCustomPattern);
		patternIdxToShort = map_default$1(allTransformedPatterns, isShortPattern);
		emptyGroups = reduce_default$1(onlyRelevantTypes, (acc, clazz) => {
			const groupName = clazz.GROUP;
			if (isString_default(groupName) && !(groupName === Lexer.SKIPPED)) acc[groupName] = [];
			return acc;
		}, {});
		patternIdxToConfig = map_default$1(allTransformedPatterns, (x, idx) => {
			return {
	...
	if (!options.safeMode) tracer("First Char Optimization", () => {
		charCodeToPatternIdxToConfig = reduce_default$1(onlyRelevantTypes, (result, currTokType, idx) => {
			if (typeof currTokType.PATTERN === "string") addToMapOfArrays(result, charCodeToOptimizedIndex(currTokType.PATTERN.charCodeAt(0)), patternIdxToConfig[idx]);
				...
				forEach_default$1(currTokType.START_CHARS_HINT, (charOrInt) => {
	...
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#UNICODE_OPTIMIZE`);
				...
				/* istanbul ignore if */
				if (isEmpty_default$1(optimizedCodes)) canBeOptimized = false;
				forEach_default$1(optimizedCodes, (code) => {
...
function validateRegExpPattern(tokenTypes) {
	let errors = [];
	const withRegExpPatterns = filter_default$1(tokenTypes, (currTokType) => isRegExp_default(currTokType[PATTERN]));
...
function findMissingPatterns(tokenTypes) {
	const tokenTypesWithMissingPattern = filter_default$1(tokenTypes, (currType) => {
		return !has_default(currType, PATTERN);
	});
	return {
		errors: map_default$1(tokenTypesWithMissingPattern, (currType) => {
			return {
		...
		valid: difference_default(tokenTypes, tokenTypesWithMissingPattern)
	};
}
function findInvalidPatterns(tokenTypes) {
	const tokenTypesWithInvalidPattern = filter_default$1(tokenTypes, (currType) => {
		const pattern = currType[PATTERN];
		return !isRegExp_default(pattern) && !isFunction_default(pattern) && !has_default(pattern, "exec") && !isString_default(pattern);
	});
	return {
		errors: map_default$1(tokenTypesWithInvalidPattern, (currType) => {
			return {
		...
		valid: difference_default(tokenTypes, tokenTypesWithInvalidPattern)
	};
}
var end_of_input = /[^\\][$]/;
function findEndOfInputAnchor(tokenTypes) {
	...
	return map_default$1(filter_default$1(tokenTypes, (currType) => {
		const pattern = currType.PATTERN;
		try {
...
function findDuplicatePatterns(tokenTypes) {
	const found = [];
	let identicalPatterns = map_default$1(tokenTypes, (outerType) => {
		return reduce_default$1(tokenTypes, (result, innerType) => {
	...
	return map_default$1(filter_default$1(identicalPatterns, (currIdenticalSet) => {
		return currIdenticalSet.length > 1;
	}), (setOfIdentical) => {
		const tokenTypeNames = map_default$1(setOfIdentical, (currType) => {
			return currType.name;
		});
		return {
			message: `The same RegExp pattern ->${head_default(setOfIdentical).PATTERN}<-has been used in all of the following Token Types: ${tokenTypeNames.join(", ")} <-`,
...
function findInvalidGroupType(tokenTypes) {
	return map_default$1(filter_default$1(tokenTypes, (clazz) => {
...
function findUnreachablePatterns(tokenTypes) {
	const errors = [];
	const canBeTested = reduce_default$1(tokenTypes, (result, tokType, idx) => {
	...
	forEach_default$1(tokenTypes, (tokType, testIdx) => {
		forEach_default$1(canBeTested, ({ str, idx, tokenType }) => {
...
function performRuntimeChecks(lexerDefinition, trackLines, lineTerminatorCharacters) {
	const errors = [];
	if (!has_default(lexerDefinition, "defaultMode")) errors.push({
	...
	if (has_default(lexerDefinition, "modes") && has_default(lexerDefinition, "defaultMode") && !has_default(lexerDefinition.modes, lexerDefinition.defaultMode)) errors.push({
		message: `A MultiMode Lexer cannot be initialized with a ${DEFAULT_MODE}: <${lexerDefinition.defaultMode}>which does not exist\n`,
		type: LexerDefinitionErrorType.MULTI_MODE_LEXER_DEFAULT_MODE_VALUE_DOES_NOT_EXIST
	});
	if (has_default(lexerDefinition, "modes")) forEach_default$1(lexerDefinition.modes, (currModeValue, currModeName) => {
		forEach_default$1(currModeValue, (currTokType, currIdx) => {
			if (isUndefined_default(currTokType)) errors.push({
				message: `A Lexer cannot be initialized using an undefined Token Type. Mode:<${currModeName}> at index: <${currIdx}>\n`,
				type: LexerDefinitionErrorType.LEXER_DEFINITION_CANNOT_CONTAIN_UNDEFINED
			});
			else if (has_default(currTokType, "LONGER_ALT")) forEach_default$1(isArray_default(currTokType.LONGER_ALT) ? currTokType.LONGER_ALT : [currTokType.LONGER_ALT], (currLongerAlt) => {
...
function performWarningRuntimeChecks(lexerDefinition, trackLines, lineTerminatorCharacters) {
	...
	const concreteTokenTypes = reject_default(compact_default(flatten_default$1(values_default(lexerDefinition.modes))), (currType) => currType[PATTERN] === Lexer.NA);
	const terminatorCharCodes = getCharCodes(lineTerminatorCharacters);
	if (trackLines) forEach_default$1(concreteTokenTypes, (tokType) => {
...
function cloneEmptyGroups(emptyGroups) {
	const clonedResult = {};
	forEach_default$1(keys_default(emptyGroups), (currKey) => {
...
function getCharCodes(charsOrCodes) {
	return map_default$1(charsOrCodes, (numOrString) => {
		if (isString_default(numOrString)) return numOrString.charCodeAt(0);
		else return numOrString;
	});
}
function addToMapOfArrays(map$1, key, value) {
	if (map$1[key] === void 0) map$1[key] = [value];
	else map$1[key].push(value);
}
...
function augmentTokenTypes(tokenTypes) {
	...
	forEach_default$1(tokenTypesAndParents, (tokType) => {
...
function expandCategories(tokenTypes) {
	...
	let searching = true;
	while (searching) {
		categories = compact_default(flatten_default$1(map_default$1(categories, (currTokType) => currTokType.CATEGORIES)));
		const newCategories = difference_default(categories, result);
		result = result.concat(newCategories);
		if (isEmpty_default$1(newCategories)) searching = false;
		else categories = newCategories;
	}
	return result;
}
function assignTokenDefaultProps(tokenTypes) {
	forEach_default$1(tokenTypes, (currTokType) => {
...
function assignCategoriesTokensProp(tokenTypes) {
	forEach_default$1(tokenTypes, (currTokType) => {
		...
		forEach_default$1(currTokType.categoryMatchesMap, (val, key) => {
...
function singleAssignCategoriesToksMap(path, nextNode) {
	forEach_default$1(path, (pathNode) => {
		nextNode.categoryMatchesMap[pathNode.tokenTypeIdx] = true;
	});
	forEach_default$1(nextNode.CATEGORIES, (nextCategory) => {
...
var Lexer = class {
	constructor(lexerDefinition, config = DEFAULT_LEXER_CONFIG) {
		...
		this.TRACE_INIT("Lexer Constructor", () => {
			...
			forEach_default$1(actualDefinition.modes, (currModeValue, currModeName) => {
			...
			forEach_default$1(actualDefinition.modes, (currModDef, currModName) => {
			...
			if (!isEmpty_default$1(this.lexerDefinitionErrors) && !this.config.deferDefinitionErrorsHandling) {
				const allErrMessagesString = map_default$1(this.lexerDefinitionErrors, (error$1) => {
					return error$1.message;
				}).join("-----------------------\n");
				throw new Error("Errors detected in definition of Lexer:\n" + allErrMessagesString);
			}
			forEach_default$1(this.lexerDefinitionWarning, (warningDescriptor) => {
			...
			this.TRACE_INIT("Failed Optimization Warnings", () => {
				const unOptimizedModes = reduce_default$1(this.canModeBeOptimized, (cannotBeOptimized, canBeOptimized, modeName) => {
					if (canBeOptimized === false) cannotBeOptimized.push(modeName);
					return cannotBeOptimized;
				}, []);
				if (config.ensureOptimizations && !isEmpty_default$1(unOptimizedModes)) throw Error(`Lexer Modes: < ${unOptimizedModes.join(", ")} > cannot be optimized.\n	 Disable the "ensureOptimizations" lexer config flag to silently ignore this and run the lexer in an un-optimized mode.
...
const defaultParserErrorProvider = {
	...
	buildNoViableAltMessage({ expectedPathsPerAlt, actual, previous, customUserDescription, ruleName }) {
		...
		const errSuffix = "\nbut found: '" + head_default(actual).image + "'";
		if (customUserDescription) return errPrefix + customUserDescription + errSuffix;
		else return `Expecting: one of these possible Token sequences:\n${map_default$1(map_default$1(reduce_default$1(expectedPathsPerAlt, (result, currAltPaths) => result.concat(currAltPaths), []), (currPath) => `[${map_default$1(currPath, (currTokenType) => tokenLabel(currTokenType)).join(", ")}]`), (itemMsg, idx) => `  ${idx + 1}. ${itemMsg}`).join("\n")}` + errSuffix;
	},
	buildEarlyExitMessage({ expectedIterationPaths, actual, customUserDescription, ruleName }) {
		const errPrefix = "Expecting: ";
		const errSuffix = "\nbut found: '" + head_default(actual).image + "'";
		if (customUserDescription) return errPrefix + customUserDescription + errSuffix;
		else return `Expecting: expecting at least one iteration which starts with one of these possible Token sequences::\n  <${map_default$1(expectedIterationPaths, (currPath) => `[${map_default$1(currPath, (currTokenType) => tokenLabel(currTokenType)).join(",")}]`).join(" ,")}>` + errSuffix;
	}
};
...
const defaultGrammarValidatorErrorProvider = {
	...
	buildAlternationPrefixAmbiguityError(options) {
		const pathMsg = map_default$1(options.prefixPath, (currTok) => tokenLabel(currTok)).join(", ");
	...
	buildLeftRecursionError(options) {
		...
		return `Left Recursion found in grammar.\nrule: <${ruleName}> can be invoked from itself (directly or indirectly)\nwithout consuming any Tokens. The grammar path that causes this is: \n ${`${ruleName} --> ${map_default$1(options.leftRecursionPath, (currRule) => currRule.name).concat([ruleName]).join(" --> ")}`}\n To fix this refactor your grammar to remove the left recursion.\nsee: https://en.wikipedia.org/wiki/LL_parser#Left_factoring.`;
	},
...
var GastRefResolverVisitor = class extends GAstVisitor {
	...
	resolveRefs() {
		forEach_default$1(values_default(this.nameToTopRule), (prod) => {
...
var AbstractNextPossibleTokensWalker = class extends RestWalker {
	...
	updateExpectedNext() {
		if (isEmpty_default$1(this.ruleStack)) {
			this.nextProductionName = "";
			this.nextProductionOccurrence = 0;
...
function possiblePathsFrom(targetDef, maxLength, currPath = []) {
	...
	while (currPath.length < maxLength && i < targetDef.length) {
		...
		if (prod instanceof Alternative) return getAlternativesForProd(prod.definition);
			...
			forEach_default$1(prod.definition, (currAlt) => {
				if (isEmpty_default$1(currAlt.definition) === false) result = getAlternativesForProd(currAlt.definition);
			});
			return result;
...
function nextPossibleTokensAfter(initialDef, tokenVector, tokMatcher, maxLookAhead) {
	...
	while (!isEmpty_default$1(possiblePaths)) {
		...
		if (isEmpty_default$1(currDef)) continue;
 ...
 /* istanbul ignore else */
		if (currIdx < tokenVectorLength - 1) {
			...
			const nextPath = {
				idx: currIdx,
				def: prod.definition.concat([secondIteration], drop_default(currDef)),
				ruleStack: currRuleStack,
				occurrenceStack: currOccurrenceStack
			};
			possiblePaths.push(nextPath);
			...
			const nextPathWith = {
				idx: currIdx,
				def: prod.definition.concat([nthRepetition], drop_default(currDef)),
				ruleStack: currRuleStack,
				occurrenceStack: currOccurrenceStack
			};
			possiblePaths.push(nextPathWith);
			...
			const currAltPath = {
				idx: currIdx,
				def: prod.definition[i].definition.concat(drop_default(currDef)),
				ruleStack: currRuleStack,
				occurrenceStack: currOccurrenceStack
			};
...
function buildAlternativesLookAheadFunc(alts, hasPredicates, tokenMatcher$1, dynamicTokensEnabled) {
	...
	if (hasPredicates) return function(orAlts) {
		const predicates = map_default$1(orAlts, (currAlt) => currAlt.GATE);
		for (let t = 0; t < numOfAlts; t++) {
			...
			nextPath: for (let j = 0; j < currNumOfPaths; j++) {
				...
				for (let i = 0; i < currPathLength; i++) if (tokenMatcher$1(this.LA(i + 1), currPath[i]) === false) continue nextPath;
				return t;
			}
		}
	};
	else if (areAllOneTokenLookahead && !dynamicTokensEnabled) {
		const choiceToAlt = reduce_default$1(map_default$1(alts, (currAlt) => {
			return flatten_default$1(currAlt);
		}), (result, currAlt, idx) => {
			forEach_default$1(currAlt, (currTokType) => {
				if (!has_default(result, currTokType.tokenTypeIdx)) result[currTokType.tokenTypeIdx] = idx;
				forEach_default$1(currTokType.categoryMatches, (currExtendingType) => {
...
function buildSingleAlternativeLookaheadFunction(alt, tokenMatcher$1, dynamicTokensEnabled) {
	...
	if (areAllOneTokenLookahead && !dynamicTokensEnabled) {
		const singleTokensTypes = flatten_default$1(alt);
		if (singleTokensTypes.length === 1 && isEmpty_default$1(singleTokensTypes[0].categoryMatches)) {
			const expectedTokenUniqueKey = singleTokensTypes[0].tokenTypeIdx;
			return function() {
				return this.LA(1).tokenTypeIdx === expectedTokenUniqueKey;
			};
		} else {
			const choiceToAlt = reduce_default$1(singleTokensTypes, (result, currTokType, idx) => {
...
function lookAheadSequenceFromAlternatives(altsDefs, k) {
	const partialAlts = map_default$1(altsDefs, (currAlt) => possiblePathsFrom([currAlt], 1));
	const finalResult = initializeArrayOfArrays(partialAlts.length);
	const altsHashes = map_default$1(partialAlts, (currAltPaths) => {
		const dict = {};
		forEach_default$1(currAltPaths, (item) => {
			forEach_default$1(pathToHashKeys(item.partialPath), (currKey) => {
				dict[currKey] = true;
			});
		});
		return dict;
	...
	for (let pathLength = 1; pathLength <= k; pathLength++) {
		...
		for (let altIdx = 0; altIdx < currDataset.length; altIdx++) {
			...
			for (let currPathIdx = 0; currPathIdx < currAltPathsAndSuffixes.length; currPathIdx++) {
				...
				if (isUniquePrefixHash(altsHashes, prefixKeys, altIdx) || isEmpty_default$1(suffixDef) || currPathPrefix.length === k) {
					...
					forEach_default$1(newPartialPathsAndSuffixes, (item) => {
						forEach_default$1(pathToHashKeys(item.partialPath), (key) => {
...
function areTokenCategoriesNotUsed(lookAheadPaths) {
	return every_default(lookAheadPaths, (singleAltPaths) => every_default(singleAltPaths, (singlePath) => every_default(singlePath, (token) => isEmpty_default$1(token.categoryMatches))));
}
function validateLookahead(options) {
	return map_default$1(options.lookaheadStrategy.validate({
		rules: options.rules,
...
function validateGrammar$1(topLevels, tokenTypes, errMsgProvider, grammarName) {
	const duplicateErrors = flatMap_default$1(topLevels, (currTopLevel) => validateDuplicateProductions(currTopLevel, errMsgProvider));
	const termsNamespaceConflictErrors = checkTerminalAndNoneTerminalsNameSpace(topLevels, tokenTypes, errMsgProvider);
	const tooManyAltsErrors = flatMap_default$1(topLevels, (curRule) => validateTooManyAlts(curRule, errMsgProvider));
	const duplicateRulesError = flatMap_default$1(topLevels, (curRule) => validateRuleDoesNotAlreadyExist(curRule, topLevels, grammarName, errMsgProvider));
...
function validateDuplicateProductions(topLevelRule, errMsgProvider) {
	...
	return map_default$1(values_default(pickBy_default(groupBy_default(allRuleProductions, identifyProductionForDuplicates), (currGroup) => {
...
function validateRuleDoesNotAlreadyExist(rule, allRules, className, errMsgProvider) {
	const errors = [];
	if (reduce_default$1(allRules, (result, curRule) => {
...
function validateNoLeftRecursion(topRule, currRule, errMsgProvider, path = []) {
	...
	if (isEmpty_default$1(nextNonTerminals)) return [];
	else {
		const ruleName = topRule.name;
		if (includes_default(nextNonTerminals, topRule)) errors.push({
		...
		const errorsFromNextSteps = flatMap_default$1(difference_default(nextNonTerminals, path.concat([topRule])), (currRefRule) => {
...
function getFirstNoneTerminal(definition) {
	let result = [];
	if (isEmpty_default$1(definition)) return result;
	...
	else if (firstProd instanceof Alternation) result = flatten_default$1(map_default$1(firstProd.definition, (currSubDef) => getFirstNoneTerminal(currSubDef.definition)));
...
function validateEmptyOrAlternative(topLevelRule, errMsgProvider) {
	...
	return flatMap_default$1(ors, (currOr) => {
		return flatMap_default$1(dropRight_default(currOr.definition), (currAlternative, currAltIdx) => {
			if (isEmpty_default$1(nextPossibleTokensAfter([currAlternative], [], tokenStructuredMatcher, 1))) return [{
...
function validateSomeNonEmptyLookaheadPath(topLevelRules, maxLookahead, errMsgProvider) {
	const errors = [];
	forEach_default$1(topLevelRules, (currTopRule) => {
		const collectorVisitor$1 = new RepetitionCollector();
		currTopRule.accept(collectorVisitor$1);
		const allRuleProductions = collectorVisitor$1.allProductions;
		forEach_default$1(allRuleProductions, (currProd) => {
			...
			if (isEmpty_default$1(flatten_default$1(pathsInsideProduction))) {
...
function checkAlternativesAmbiguities(alternatives, alternation$1, rule, errMsgProvider) {
	...
	return map_default$1(reduce_default$1(alternatives, (result, currAlt, currAltIdx) => {
		if (alternation$1.definition[currAltIdx].ignoreAmbiguities === true) return result;
		forEach_default$1(currAlt, (currPath) => {
			const altsCurrPathAppearsIn = [currAltIdx];
			forEach_default$1(alternatives, (currOtherAlt, currOtherAltIdx) => {
		...
		const ambgIndices = map_default$1(currAmbDescriptor.alts, (currAltIdx) => currAltIdx + 1);
		return {
...
function checkPrefixAlternativesAmbiguities(alternatives, alternation$1, rule, errMsgProvider) {
	const pathsAndIndices = reduce_default$1(alternatives, (result, currAlt, idx) => {
		const currPathsAndIdx = map_default$1(currAlt, (currPath) => {
			return {
				idx,
				path: currPath
			};
	...
	return compact_default(flatMap_default$1(pathsAndIndices, (currPathAndIdx) => {
		if (alternation$1.definition[currPathAndIdx.idx].ignoreAmbiguities === true) return [];
		const targetIdx = currPathAndIdx.idx;
		const targetPath = currPathAndIdx.path;
		return map_default$1(filter_default$1(pathsAndIndices, (searchPathAndIdx) => {
...
function checkTerminalAndNoneTerminalsNameSpace(topLevels, tokenTypes, errMsgProvider) {
	const errors = [];
	const tokenNames = map_default$1(tokenTypes, (currToken) => currToken.name);
	forEach_default$1(topLevels, (currRule) => {
...
function resolveGrammar(options) {
	...
	const topRulesTable = {};
	forEach_default$1(options.rules, (rule) => {
...
var Recoverable = class {
	...
	tryInRepetitionRecovery(grammarRule, grammarRuleArgs, lookAheadFunc, expectedTokType) {
		...
		const generateErrorMessage = () => {
			...
			const error$1 = new MismatchedTokenException(this.errorMessageProvider.buildMismatchTokenMessage({
	...
	canRecoverWithSingleTokenInsertion(expectedTokType, follows) {
		...
		if (isEmpty_default$1(follows)) return false;
		const mismatchedTok = this.LA(1);
		return find_default(follows, (possibleFollowsTokType) => {
	...
	isInCurrentRuleReSyncSet(tokenTypeIdx) {
		...
		return includes_default(this.getFollowSetFromFollowKey(followKey), tokenTypeIdx);
	}
	findReSyncTokenType() {
	...
	buildFullFollowKeyStack() {
		...
		return map_default$1(explicitRuleStack, (ruleName, idx) => {
	...
	flattenFollowSet() {
		return flatten_default$1(map_default$1(this.buildFullFollowKeyStack(), (currKey) => {
	...
	getHumanReadableRuleStack() {
		return map_default$1(this.RULE_STACK, (currShortName) => this.shortRuleNameToFullName(currShortName));
	}
};
...
const AT_LEAST_ONE_IDX = 1024;
const MANY_SEP_IDX = 1280;
const AT_LEAST_ONE_SEP_IDX = 1536;
...
var LLkLookaheadStrategy = class {
	...
	validate(options) {
		...
		if (isEmpty_default$1(leftRecursionErrors)) {
	...
	validateNoLeftRecursion(rules) {
		return flatMap_default$1(rules, (currTopRule) => validateNoLeftRecursion(currTopRule, currTopRule, defaultGrammarValidatorErrorProvider));
	}
	validateEmptyOrAlternatives(rules) {
		return flatMap_default$1(rules, (currTopRule) => validateEmptyOrAlternative(currTopRule, defaultGrammarValidatorErrorProvider));
	}
	validateAmbiguousAlternationAlternatives(rules, maxLookahead) {
		return flatMap_default$1(rules, (currTopRule) => validateAmbiguousAlternationAlternatives(currTopRule, maxLookahead, defaultGrammarValidatorErrorProvider));
	}
...
var LooksAhead = class {
	...
	preComputeLookaheadFunctions(rules) {
		forEach_default$1(rules, (currRule) => {
			this.TRACE_INIT(`${currRule.name} Rule Lookahead`, () => {
				...
				forEach_default$1(alternation$1, (currProd) => {
				...
				forEach_default$1(repetitionMandatoryWithSeparator, (currProd) => {
				...
				forEach_default$1(repetitionWithSeparator, (currProd) => {
...
function createBaseSemanticVisitorConstructor(grammarName, ruleNames) {
	...
	derivedConstructor.prototype = {
		visit: function(cstNode, param) {
			...
			if (isUndefined_default(cstNode)) return;
			return this[cstNode.name](cstNode.children, param);
		},
		validateVisitor: function() {
			const semanticDefinitionErrors = validateVisitor(this, ruleNames);
			if (!isEmpty_default$1(semanticDefinitionErrors)) {
				const errorMessages = map_default$1(semanticDefinitionErrors, (currDefError) => currDefError.msg);
...
function createBaseVisitorConstructorWithDefaults(grammarName, ruleNames, baseConstructor) {
	...
	forEach_default$1(ruleNames, (ruleName) => {
...
function validateMissingCstMethods(visitorInstance, ruleNames) {
	return compact_default(map_default$1(filter_default$1(ruleNames, (currRuleName) => {
...
var RecognizerEngine = class {
	initRecognizerEngine(tokenVocabulary, config) {
		...
		if (isArray_default(tokenVocabulary)) {
			if (isEmpty_default$1(tokenVocabulary)) throw Error("A Token Vocabulary cannot be empty.\n	Note that the first argument for the parser constructor\n	is no longer a Token vector (since v4.0).");
		...
		if (isArray_default(tokenVocabulary)) this.tokensMap = reduce_default$1(tokenVocabulary, (acc, tokType) => {
			acc[tokType.name] = tokType;
			return acc;
		}, {});
		else if (has_default(tokenVocabulary, "modes") && every_default(flatten_default$1(values_default(tokenVocabulary.modes)), isTokenType)) this.tokensMap = reduce_default$1(uniq_default(flatten_default$1(values_default(tokenVocabulary.modes))), (acc, tokType) => {
			acc[tokType.name] = tokType;
			return acc;
		}, {});
		...
		this.tokenMatcher = every_default(has_default(tokenVocabulary, "modes") ? flatten_default$1(values_default(tokenVocabulary.modes)) : values_default(tokenVocabulary), (tokenConstructor) => isEmpty_default$1(tokenConstructor.categoryMatches)) ? tokenStructuredMatcherNoCategories : tokenStructuredMatcher;
...
function recordOrProd(mainProdArg, occurrence) {
	...
	newOrProd.hasPredicates = some_default(alts, (currAlt) => isFunction_default(currAlt.GATE));
	prevProd.definition.push(newOrProd);
	forEach_default$1(alts, (currAlt) => {
		...
		this.TRACE_INIT("performSelfAnalysis", () => {
			...
			this.TRACE_INIT("Grammar Recording", () => {
				try {
					...
					forEach_default$1(this.definedRulesNames, (currRuleName) => {
			...
			this.TRACE_INIT("Grammar Validations", () => {
				if (isEmpty_default$1(resolverErrors) && this.skipValidations === false) {
			...
			if (isEmpty_default$1(this.definitionErrors)) {
			...
			if (!Parser.DEFER_DEFINITION_ERRORS_HANDLING && !isEmpty_default$1(this.definitionErrors)) {
				defErrorsMsgs = map_default$1(this.definitionErrors, (defError) => defError.message);
...
function repetition(atn, rule, repetition$1) {
	const starState = newState(atn, rule, repetition$1, { type: 5 });
	defineDecisionState(atn, starState);
	return star(atn, rule, repetition$1, makeAlts(atn, rule, starState, repetition$1, block(atn, rule, repetition$1)));
}
function repetitionSep(atn, rule, repetition$1) {
	const starState = newState(atn, rule, repetition$1, { type: 5 });
	defineDecisionState(atn, starState);
	return star(atn, rule, repetition$1, makeAlts(atn, rule, starState, repetition$1, block(atn, rule, repetition$1)), tokenRef(atn, rule, repetition$1.separator, repetition$1));
}
function repetitionMandatory(atn, rule, repetition$1) {
	const plusState = newState(atn, rule, repetition$1, { type: 4 });
	defineDecisionState(atn, plusState);
	return plus(atn, rule, repetition$1, makeAlts(atn, rule, plusState, repetition$1, block(atn, rule, repetition$1)));
}
function repetitionMandatorySep(atn, rule, repetition$1) {
	const plusState = newState(atn, rule, repetition$1, { type: 4 });
	defineDecisionState(atn, plusState);
	return plus(atn, rule, repetition$1, makeAlts(atn, rule, plusState, repetition$1, block(atn, rule, repetition$1)), tokenRef(atn, rule, repetition$1.separator, repetition$1));
}
function alternation(atn, rule, alternation$1) {
	const start = newState(atn, rule, alternation$1, { type: 1 });
	defineDecisionState(atn, start);
	return makeAlts(atn, rule, start, alternation$1, ...map_default(alternation$1.definition, (e) => atom(atn, rule, e)));
}
function option(atn, rule, option$1) {
	const start = newState(atn, rule, option$1, { type: 1 });
	defineDecisionState(atn, start);
	return optional(atn, rule, option$1, makeAlts(atn, rule, start, option$1, block(atn, rule, option$1)));
}
...
function plus(atn, rule, plus$1, handle, sep) {
	...
	const loop = newState(atn, rule, plus$1, { type: 11 });
	defineDecisionState(atn, loop);
	const end = newState(atn, rule, plus$1, { type: 12 });
...
function star(atn, rule, star$1, handle, sep) {
	...
	const entry = newState(atn, rule, star$1, { type: 10 });
	defineDecisionState(atn, entry);
	const loopEnd = newState(atn, rule, star$1, { type: 12 });
	const loop = newState(atn, rule, star$1, { type: 9 });
	entry.loopback = loop;
...
function makeBlock(atn, alts) {
	...
	const last$1 = alts[altsLength - 1];
	return {
		left: first$1.left,
		right: last$1.right
	};
...
(function(Is$2) {
	...
	function numberRange(value, min, max) {
		return toString$2.call(value) === "[object Number]" && min <= value && value <= max;
	}
	Is$2.numberRange = numberRange;
	function integer$1(value) {
		return toString$2.call(value) === "[object Number]" && -2147483648 <= value && value <= 2147483647;
	}
	Is$2.integer = integer$1;
	function uinteger$1(value) {
		return toString$2.call(value) === "[object Number]" && 0 <= value && value <= 2147483647;
	}
...
var LangiumParser = class extends AbstractLangiumParser {
	...
	action($type, action) {
		if (!this.isRecording()) {
			let last$1 = this.current;
			if (action.feature && action.operator) {
				last$1 = this.construct();
				this.nodeBuilder.removeNode(last$1.$cstNode);
				this.nodeBuilder.buildCompositeNode(action).content.push(last$1.$cstNode);
				const newItem = { $type };
				this.stack.push(newItem);
				this.assign(action.operator, action.feature, last$1, last$1.$cstNode, false);
			} else last$1.$type = $type;
		}
	}
	construct() {
...
function buildUnorderedGroup(ctx, group) {
	...
	const alternatives = (args) => ctx.parser.alternatives(orIdx, methods.map((method, idx) => {
		...
		if (gate) alt.GATE = () => gate(args);
			...
			return !(trackedAlternatives === null || trackedAlternatives === void 0 ? void 0 : trackedAlternatives[idx]);
		};
		return alt;
	}));
...
__reExport(cancellation_exports, /* @__PURE__ */ __toESM(require_cancellation(), 1), void 0, 1);
...
(() => {
	...
	(() => {
		...
		else if ("object" == typeof navigator) t$1 = navigator.userAgent.indexOf("Windows") >= 0;
		const e$1 = /^\w[\w\d+.-]*$/, i = /^\//, o = /^\/\//;
		function s(t$2, r$1) {
...
var DefaultLangiumDocuments = class {
	...
	invalidateDocument(uri) {
		...
		if (langiumDoc) {
			this.serviceRegistry.getServices(uri).references.Linker.unlink(langiumDoc);
...
var DefaultLinker = class {
	...
	getCandidate(refInfo) {
		const description = this.scopeProvider.getScope(refInfo).getElement(refInfo.reference.$refText);
		return description !== null && description !== void 0 ? description : this.createLinkingError(refInfo);
	}
	buildReference(node, property$1, refNode, refText) {
		const linker = this;
		const reference = {
			$refNode: refNode,
			$refText: refText,
			get ref() {
				...
				} else if (this._ref === ref_resolving) throw new Error(`Cyclic reference resolution detected: ${linker.astNodeLocator.getAstNodePath(node)}/${property$1} (symbol '${refText}')`);
...
var MultiMap = class {
	...
	delete(key, value) {
		if (value === void 0) return this.map.delete(key);
			...
			const values$1 = this.map.get(key);
			if (values$1) {
				const index = values$1.indexOf(value);
				if (index >= 0) {
					if (values$1.length === 1) this.map.delete(key);
					else values$1.splice(index, 1);
					return true;
				}
			}
			return false;
	...
	has(key, value) {
		if (value === void 0) return this.map.has(key);
			...
			const values$1 = this.map.get(key);
			if (values$1) return values$1.indexOf(value) >= 0;
			return false;
		}
	}
	add(key, value) {
	...
	addAll(key, values$1) {
		if (this.map.has(key)) this.map.get(key).push(...values$1);
		else this.map.set(key, Array.from(values$1));
		return this;
	}
	forEach(callbackfn) {
...
var DefaultJsonSerializer = class {
	...
	deserialize(content, options) {
		...
		const root$1 = JSON.parse(content);
		this.linkNode(root$1, root$1, deserializeOptions);
		return root$1;
	}
	...
	linkNode(node, root$1, options, container, containerProperty, containerIndex) {
		for (const [propertyName, item] of Object.entries(node)) if (Array.isArray(item)) for (let index = 0; index < item.length; index++) {
			const element = item[index];
			if (isIntermediateReference(element)) item[index] = this.reviveReference(node, propertyName, root$1, element, options);
			else if (isAstNode(element)) this.linkNode(element, root$1, options, node, propertyName, index);
		}
		else if (isIntermediateReference(item)) node[propertyName] = this.reviveReference(node, propertyName, root$1, item, options);
		else if (isAstNode(item)) this.linkNode(item, root$1, options, node, propertyName);
		const mutable = node;
		mutable.$container = container;
		mutable.$containerProperty = containerProperty;
		mutable.$containerIndex = containerIndex;
	}
	reviveReference(container, property$1, root$1, reference, options) {
		let refText = reference.$refText;
		let error$1 = reference.$error;
		if (reference.$ref) {
			const ref = this.getRefNode(root$1, reference.$ref, options.uriConverter);
			if (isAstNode(ref)) {
	...
	getRefNode(root$1, uri, uriConverter) {
		try {
			const fragmentIndex = uri.indexOf("#");
			if (fragmentIndex === 0) {
				const node$1 = this.astNodeLocator.getAstNode(root$1, uri.substring(1));
...
var DefaultReferenceDescriptionProvider = class {
	...
	createDescription(refInfo) {
		...
		if (!targetNodeDescr || !refCstNode) return;
...
var DefaultAstNodeLocator = class {
	...
	getAstNode(node, path) {
		return path.split(this.segmentSeparator).reduce((previousValue, currentValue) => {
			...
			if (propertyIndex > 0) {
				const property$1 = currentValue.substring(0, propertyIndex);
				const arrayIndex = parseInt(currentValue.substring(propertyIndex + 1));
				const array$1 = previousValue[property$1];
...
var event_exports = {};
__reExport(event_exports, /* @__PURE__ */ __toESM(require_events(), 1), void 0, 1);
...
var DefaultDocumentBuilder = class {
			...
			if (document.state === DocumentState.Validated) {
				if (typeof options.validation === "boolean" && options.validation) {
					...
					if (previousCategories) {
						const categories = ((_b = options.validation.categories) !== null && _b !== void 0 ? _b : ValidationCategory.all).filter((c) => !previousCategories.includes(c));
	...
	async update(changed, deleted, cancelToken = cancellation_exports.CancellationToken.None) {
		...
		for (const changedUri of changed) {
			if (!this.langiumDocuments.invalidateDocument(changedUri)) {
		...
		this.langiumDocuments.all.filter((doc) => !allChangedUris.has(doc.uri.toString()) && this.shouldRelink(doc, allChangedUris)).forEach((doc) => {
			this.serviceRegistry.getServices(doc.uri).references.Linker.unlink(doc);
	...
	async buildDocuments(documents, options, cancelToken) {
		...
		await this.runCancelable(documents, DocumentState.ComputedScopes, cancelToken, async (doc) => {
			doc.precomputedScopes = await this.serviceRegistry.getServices(doc.uri).references.ScopeComputation.computeLocalScopes(doc, cancelToken);
		});
...
var DefaultIndexManager = class {
	...
	getFileDescriptions(uri, nodeType) {
		...
		return this.symbolByTypeIndex.get(uri, nodeType, () => {
			var _a$1;
			return ((_a$1 = this.symbolIndex.get(uri)) !== null && _a$1 !== void 0 ? _a$1 : []).filter((e) => this.astReflection.isSubtype(e.type, nodeType));
		});
	}
	remove(uri) {
		const uriString = uri.toString();
	...
	async updateContent(document, cancelToken = cancellation_exports.CancellationToken.None) {
		const exports$1 = await this.serviceRegistry.getServices(document.uri).references.ScopeComputation.computeExports(document, cancelToken);
	...
	async traverseFolder(workspaceFolder, folderPath, fileExtensions, collector) {
		...
		await Promise.all(content.map(async (entry) => {
			if (this.includeEntry(workspaceFolder, entry, fileExtensions)) {
				...
				else if (entry.isFile) collector(await this.langiumDocuments.getOrCreateDocument(entry.uri));
			}
		}));
	}
...
function isJSDoc(node, options) {
	...
	const last$1 = lines[lines.length - 1];
	const firstRegex = normalizedOptions.start;
	const lastRegex = normalizedOptions.end;
	return Boolean(firstRegex === null || firstRegex === void 0 ? void 0 : firstRegex.exec(first$1)) && Boolean(lastRegex === null || lastRegex === void 0 ? void 0 : lastRegex.exec(last$1));
}
...
function tokenize(context) {
	...
	for (let i = 0; i < context.lines.length; i++) {
		const first$1 = i === 0;
		const last$1 = i === context.lines.length - 1;
...
function parseJSDocElement(context, last$1) {
...
function renderInlineTag(tag, content, options) {
	...
	if (tag === "linkplain" || tag === "linkcode" || tag === "link") {
		...
		return (_b = (_a = options.renderLink) === null || _a === void 0 ? void 0 : _a.call(options, content, display)) !== null && _b !== void 0 ? _b : renderLinkDefault(content, display);
	}
}
...
var JSDocDocumentationProvider = class {
	...
	findNameInPrecomputedScopes(node, name) {
		...
		do {
			const description = precomputed.get(currentNode).find((e) => e.name === name);
...
function _inject(module$1, injector) {
	const proxy = new Proxy({}, {
		...
		get: (obj, prop) => {
			...
			else return _resolve(obj, prop, module$1, injector || proxy);
		},
		getOwnPropertyDescriptor: (obj, prop) => (_resolve(obj, prop, module$1, injector || proxy), Object.getOwnPropertyDescriptor(obj, prop)),
		has: (_, prop) => prop in module$1,
		ownKeys: () => [...Object.getOwnPropertyNames(module$1)]
	});
	return proxy;
}
var __requested__ = Symbol();
function _resolve(obj, prop, module$1, injector) {
	if (prop in obj) {
		...
		return obj[prop];
	} else if (prop in module$1) {
		const value = module$1[prop];
