...
import { r as getFileDirectory } from "./file-CVv-vzb2.js";
var logger = loggerService.withContext("NotesService");
var MARKDOWN_EXT = ".md";
...
async function createFolders(folders) {
	...
	for (const folder of ordered) try {
		...
		logger.error("Failed to create folder while uploading notes", error);
		throw error;
	}
}
...
export { renameNode as a, uploadNotes as c, projectNotesTree as i, addNote as n, resolveNotesPath as o, delNode as r, sortTree as s, addDir as t };
