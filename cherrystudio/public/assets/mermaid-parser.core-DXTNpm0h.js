const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./info-NVLQJR56-Cny5xS5N.js","./chunk-FPAJGGOC-B-Nn_3t0.js","./isEmpty-CYv_ehDI.js","./_baseFor-Coo_DsK8.js","./reduce-CsRsNN4I.js","./flatten-CkPJLFBz.js","./chunk-0ogMdkZ1.js","./chunk-LBM3YZW2-DpnMUD4W.js","./packet-BFZMPI3H-C5a48i7x.js","./chunk-76Q3JFCE-DSf5U1EZ.js","./pie-7BOR55EZ-1L5nDtkT.js","./chunk-T53DSG4Q-DaOZ58Qa.js","./architecture-U656AL7Q-DLdORgQX.js","./chunk-O7ZBX7Z2-ebI8zaxS.js","./gitGraph-F6HP7TQM-C-BGsCst.js","./chunk-S6J4BHB3-BVLH03d7.js","./radar-NHE76QYJ-D1_GoWOU.js","./chunk-LHMN2FUI-BKnbafyQ.js","./treemap-KMMF4GRG-Cb129jea.js","./chunk-FWNWRKHM-DowjeSnx.js"])))=>i.map(i=>d[i]);
import { t as __vitePreload } from "./preload-helper-0g9Mvw_b.js";
import { f as __name } from "./chunk-FPAJGGOC-B-Nn_3t0.js";
var parsers = {};
var initializers = {
	info: /* @__PURE__ */ __name(async () => {
		const { createInfoServices: createInfoServices2 } = await __vitePreload(async () => {
			const { createInfoServices: createInfoServices2$1 } = await import("./info-NVLQJR56-Cny5xS5N.js");
	...
	packet: /* @__PURE__ */ __name(async () => {
		const { createPacketServices: createPacketServices2 } = await __vitePreload(async () => {
			const { createPacketServices: createPacketServices2$1 } = await import("./packet-BFZMPI3H-C5a48i7x.js");
	...
	pie: /* @__PURE__ */ __name(async () => {
		const { createPieServices: createPieServices2 } = await __vitePreload(async () => {
			const { createPieServices: createPieServices2$1 } = await import("./pie-7BOR55EZ-1L5nDtkT.js");
	...
	architecture: /* @__PURE__ */ __name(async () => {
		const { createArchitectureServices: createArchitectureServices2 } = await __vitePreload(async () => {
			const { createArchitectureServices: createArchitectureServices2$1 } = await import("./architecture-U656AL7Q-DLdORgQX.js");
	...
	gitGraph: /* @__PURE__ */ __name(async () => {
		const { createGitGraphServices: createGitGraphServices2 } = await __vitePreload(async () => {
			const { createGitGraphServices: createGitGraphServices2$1 } = await import("./gitGraph-F6HP7TQM-C-BGsCst.js");
	...
	radar: /* @__PURE__ */ __name(async () => {
		const { createRadarServices: createRadarServices2 } = await __vitePreload(async () => {
			const { createRadarServices: createRadarServices2$1 } = await import("./radar-NHE76QYJ-D1_GoWOU.js");
	...
	treemap: /* @__PURE__ */ __name(async () => {
		const { createTreemapServices: createTreemapServices2 } = await __vitePreload(async () => {
			const { createTreemapServices: createTreemapServices2$1 } = await import("./treemap-KMMF4GRG-Cb129jea.js");
