...
import { $a as _defineProperty, $i as isEqual_default, Ba as init_ref, Dn as init_es$7, Fn as init_es$6, Ga as useMemo$1, Gi as init_useLayoutEffect, Gr as init_pickAttrs, Ha as supportRef, Ja as getDOM, Ki as useLayoutEffect_default, Kr as pickAttrs, La as composeRef, Ma as init_createClass, Na as _classCallCheck, Ni as get, Nn as es_default$8, Nr as init_isVisible, Pa as init_classCallCheck, Pi as init_get, Pr as isVisible_default, Qa as init_objectSpread2, Qi as init_isEqual, Ra as fillRef, Sr as init_getScrollBarSize, Tn as es_default$9, Ua as useComposeRef, Ur as KeyCode_default, Wa as init_useMemo, Wr as init_KeyCode, Xa as require_react_dom, Ya as init_findDOMNode, Za as _objectSpread2, ai as init_es$9, ao as toArray, br as getScrollBarSize, ca as _slicedToArray, co as _extends, da as raf_default, dn as addEventListenerWrap, ea as _objectWithoutProperties, eo as init_defineProperty, er as init_isMobile, fa as _toConsumableArray, fn as init_addEventListener, ga as es_default$2, hi as useMergedState, io as init_toArray, ja as _createClass, jn as MenuItem_default, la as init_slicedToArray, lo as init_extends, mi as init_useMergedState, oa as canUseDom, oo as _typeof, pa as init_toConsumableArray, pi as init_es$10, qi as useLayoutUpdateEffect, ri as es_default$7, ro as warning_default, sa as init_canUseDom, so as init_typeof, ta as init_objectWithoutProperties, to as init_warning, tr as isMobile_default, ua as init_raf, uo as require_classnames, va as init_es$8, vi as init_useEvent, xr as getTargetScrollBarSize, yi as useEvent } from "./jsx-runtime-B4r10XlC.js";
import { t as require_react } from "./react-CGLB_Dcb.js";
import { J as init_es$11, Tt as isStyleSupport, X as init_commonUtils, Y as BaseInput_default, Z as triggerFocus, bt as es_default$1, wt as init_styleChecker, xt as init_es$12 } from "./Component-BnbUztei.js";
var import_react$62, TabContext_default;
var init_TabContext = __esmMin((() => {
	import_react$62 = /* @__PURE__ */ __toESM(require_react());
	TabContext_default = /* @__PURE__ */ (0, import_react$62.createContext)(null);
}));
var import_react$61, useIndicator, useIndicator_default;
var init_useIndicator = __esmMin((() => {
	...
	useIndicator = function useIndicator$1(options) {
		...
		var _useState2 = _slicedToArray((0, import_react$61.useState)(), 2), inkStyle = _useState2[0], setInkStyle = _useState2[1];
		var inkBarRafRef = (0, import_react$61.useRef)();
		var getLength = import_react$61.useCallback(function(origin) {
		...
		(0, import_react$61.useEffect)(function() {
			var newInkStyle = {};
...
function useOffsets(tabs, tabSizes, holderScrollWidth) {
	return (0, import_react$60.useMemo)(function() {
		var _tabs$;
...
var import_react$60, DEFAULT_SIZE$1;
...
function useSyncState(defaultState, onChange) {
	var stateRef = import_react$59.useRef(defaultState);
	var forceUpdate = _slicedToArray(import_react$59.useState({}), 2)[1];
...
function useTouchMove(ref, onOffset) {
	var _useState2 = _slicedToArray((0, import_react$58.useState)(), 2), touchPosition = _useState2[0], setTouchPosition = _useState2[1];
	var _useState4 = _slicedToArray((0, import_react$58.useState)(0), 2), lastTimestamp = _useState4[0], setLastTimestamp = _useState4[1];
	var _useState6 = _slicedToArray((0, import_react$58.useState)(0), 2), lastTimeDiff = _useState6[0], setLastTimeDiff = _useState6[1];
	var _useState8 = _slicedToArray((0, import_react$58.useState)(), 2), lastOffset = _useState8[0], setLastOffset = _useState8[1];
	var motionRef = (0, import_react$58.useRef)();
	...
	var lastWheelDirectionRef = (0, import_react$58.useRef)();
	function onWheel(e) {
	...
	var touchEventsRef = (0, import_react$58.useRef)(null);
	...
	import_react$57.useEffect(function() {
...
var import_react$57, import_react$58, MIN_SWIPE_DISTANCE, STOP_SWIPE_DISTANCE, REFRESH_INTERVAL, SPEED_OFF_MULTIPLE;
...
function useUpdate(callback) {
	var _useState2 = _slicedToArray((0, import_react$56.useState)(0), 2), count = _useState2[0], setCount = _useState2[1];
	var effectRef = (0, import_react$56.useRef)(0);
	var callbackRef = (0, import_react$56.useRef)();
...
function useUpdateState(defaultState) {
	var batchRef = (0, import_react$56.useRef)([]);
	var forceUpdate = _slicedToArray((0, import_react$56.useState)({}), 2)[1];
	var state = (0, import_react$56.useRef)(typeof defaultState === "function" ? defaultState() : defaultState);
...
var import_react$55, DEFAULT_SIZE;
...
var import_react$54, AddButton, AddButton_default;
var init_AddButton = __esmMin((() => {
	import_react$54 = /* @__PURE__ */ __toESM(require_react());
	AddButton = /* @__PURE__ */ import_react$54.forwardRef(function(props, ref) {
		...
		return /* @__PURE__ */ import_react$54.createElement("button", {
			ref,
			type: "button",
...
var import_react$53, ExtraContent, ExtraContent_default;
var init_ExtraContent = __esmMin((() => {
	init_typeof();
	import_react$53 = /* @__PURE__ */ __toESM(require_react());
	ExtraContent = /* @__PURE__ */ import_react$53.forwardRef(function(props, ref) {
		var position = props.position, prefixCls = props.prefixCls, extra = props.extra;
		if (!extra) return null;
		var content;
		var assertExtra = {};
		if (_typeof(extra) === "object" && !/* @__PURE__ */ import_react$53.isValidElement(extra)) assertExtra = extra;
		else assertExtra.right = extra;
		if (position === "right") content = assertExtra.right;
		if (position === "left") content = assertExtra.left;
		return content ? /* @__PURE__ */ import_react$53.createElement("div", {
...
var import_classnames$19, import_react$51, import_react$52, OperationNode, OperationNode_default;
var init_OperationNode = __esmMin((() => {
	...
	init_util();
	init_AddButton();
	OperationNode = /* @__PURE__ */ import_react$51.forwardRef(function(props, ref) {
		...
		var _useState2 = _slicedToArray((0, import_react$52.useState)(false), 2), open = _useState2[0], setOpen = _useState2[1];
		var _useState4 = _slicedToArray((0, import_react$52.useState)(null), 2), selectedKey = _useState4[0], setSelectedKey = _useState4[1];
		...
		var menu = /* @__PURE__ */ import_react$51.createElement(es_default$9, {
			...
			return /* @__PURE__ */ import_react$51.createElement(MenuItem_default, {
				key,
				id: "".concat(popupId, "-").concat(key),
				role: "option",
				"aria-controls": id && "".concat(id, "-panel-").concat(key),
				disabled
			}, /* @__PURE__ */ import_react$51.createElement("span", null, label), removable && /* @__PURE__ */ import_react$51.createElement("button", {
				type: "button",
		...
		var overlayClassName = (0, import_classnames$19.default)(_defineProperty({}, "".concat(dropdownPrefix, "-rtl"), rtl));
		var moreNode = mobile ? null : /* @__PURE__ */ import_react$51.createElement(es_default$8, _extends({
			prefixCls: dropdownPrefix,
			overlay: menu,
			visible: tabs.length ? open : false,
			onVisibleChange: setOpen,
			overlayClassName: (0, import_classnames$19.default)(overlayClassName, popupClassName),
			mouseEnterDelay: .1,
			mouseLeaveDelay: .1,
			getPopupContainer
		}, moreProps), /* @__PURE__ */ import_react$51.createElement("button", {
			type: "button",
		...
		return /* @__PURE__ */ import_react$51.createElement("div", {
			className: (0, import_classnames$19.default)("".concat(prefixCls, "-nav-operations"), className),
			style,
			ref
		}, moreNode, /* @__PURE__ */ import_react$51.createElement(AddButton_default, {
			prefixCls,
			locale,
			editable
		}));
	});
	OperationNode_default = /* @__PURE__ */ import_react$51.memo(OperationNode, function(_, next) {
		return next.tabMoving;
	});
}));
var import_classnames$18, import_react$50, TabNode, TabNode_default;
var init_TabNode = __esmMin((() => {
	...
	TabNode = function TabNode$1(props) {
		...
		var labelNode = import_react$50.useMemo(function() {
			return icon && typeof label === "string" ? /* @__PURE__ */ import_react$50.createElement("span", null, label) : label;
		}, [label, icon]);
		var btnRef = import_react$50.useRef(null);
		import_react$50.useEffect(function() {
			if (focus && btnRef.current) btnRef.current.focus();
		}, [focus]);
		var node = /* @__PURE__ */ import_react$50.createElement("div", {
			key,
			"data-node-key": genDataNodeKey(key),
			className: (0, import_classnames$18.default)(tabPrefix, _defineProperty(_defineProperty(_defineProperty(_defineProperty({}, "".concat(tabPrefix, "-with-remove"), removable), "".concat(tabPrefix, "-active"), active), "".concat(tabPrefix, "-disabled"), disabled), "".concat(tabPrefix, "-focus"), focus)),
			style,
			onClick: onInternalClick
		}, /* @__PURE__ */ import_react$50.createElement("div", {
			ref: btnRef,
			role: "tab",
			...
			onFocus,
			onBlur
		}, focus && /* @__PURE__ */ import_react$50.createElement("div", {
			"aria-live": "polite",
			style: {
				width: 0,
				height: 0,
		...
		}, "Tab ".concat(currentPosition, " of ").concat(tabCount)), icon && /* @__PURE__ */ import_react$50.createElement("span", { className: "".concat(tabPrefix, "-icon") }, icon), label && labelNode), removable && /* @__PURE__ */ import_react$50.createElement("button", {
			type: "button",
			role: "tab",
			"aria-label": removeAriaLabel || "remove",
			tabIndex: active ? 0 : -1,
...
var import_classnames$17, import_react$48, import_react$49, getTabSize, getSize, getUnitValue, TabNavList, TabNavList_default;
var init_TabNavList = __esmMin((() => {
	...
	TabNavList = /* @__PURE__ */ import_react$48.forwardRef(function(props, ref) {
		...
		var _React$useContext = import_react$48.useContext(TabContext_default), prefixCls = _React$useContext.prefixCls, tabs = _React$useContext.tabs;
		var containerRef = (0, import_react$49.useRef)(null);
		var extraLeftRef = (0, import_react$49.useRef)(null);
		var extraRightRef = (0, import_react$49.useRef)(null);
		var tabsWrapperRef = (0, import_react$49.useRef)(null);
		var tabListRef = (0, import_react$49.useRef)(null);
		var operationsRef = (0, import_react$49.useRef)(null);
		var innerAddButtonRef = (0, import_react$49.useRef)(null);
		...
		var _useState2 = _slicedToArray((0, import_react$49.useState)([0, 0]), 2), containerExcludeExtraSize = _useState2[0], setContainerExcludeExtraSize = _useState2[1];
		var _useState4 = _slicedToArray((0, import_react$49.useState)([0, 0]), 2), tabContentSize = _useState4[0], setTabContentSize = _useState4[1];
		var _useState6 = _slicedToArray((0, import_react$49.useState)([0, 0]), 2), addSize = _useState6[0], setAddSize = _useState6[1];
		var _useState8 = _slicedToArray((0, import_react$49.useState)([0, 0]), 2), operationSize = _useState8[0], setOperationSize = _useState8[1];
		...
		var touchMovingRef = (0, import_react$49.useRef)(null);
		var _useState10 = _slicedToArray((0, import_react$49.useState)(), 2), lockAnimation = _useState10[0], setLockAnimation = _useState10[1];
		...
		(0, import_react$49.useEffect)(function() {
			clearTouchMoving();
		...
		var _useState12 = _slicedToArray((0, import_react$49.useState)(), 2), focusKey = _useState12[0], setFocusKey = _useState12[1];
		var _useState14 = _slicedToArray((0, import_react$49.useState)(false), 2), isMouse = _useState14[0], setIsMouse = _useState14[1];
		...
		var tabNodes = tabs.map(function(tab, i) {
			var key = tab.key;
			return /* @__PURE__ */ import_react$48.createElement(TabNode_default, {
				id,
				prefixCls,
				key,
				tab,
		...
		return /* @__PURE__ */ import_react$48.createElement(es_default$2, { onResize: onListHolderResize }, /* @__PURE__ */ import_react$48.createElement("div", {
			ref: useComposeRef(ref, containerRef),
			role: "tablist",
			"aria-orientation": tabPositionTopOrBottom ? "horizontal" : "vertical",
			className: (0, import_classnames$17.default)("".concat(prefixCls, "-nav"), className),
			style,
			onKeyDown: function onKeyDown() {
				doLockAnimation();
			}
		}, /* @__PURE__ */ import_react$48.createElement(ExtraContent_default, {
			ref: extraLeftRef,
			position: "left",
			extra,
			prefixCls
		}), /* @__PURE__ */ import_react$48.createElement(es_default$2, { onResize: onListHolderResize }, /* @__PURE__ */ import_react$48.createElement("div", {
			className: (0, import_classnames$17.default)(wrapPrefix, _defineProperty(_defineProperty(_defineProperty(_defineProperty({}, "".concat(wrapPrefix, "-ping-left"), pingLeft), "".concat(wrapPrefix, "-ping-right"), pingRight), "".concat(wrapPrefix, "-ping-top"), pingTop), "".concat(wrapPrefix, "-ping-bottom"), pingBottom)),
			ref: tabsWrapperRef
		}, /* @__PURE__ */ import_react$48.createElement(es_default$2, { onResize: onListHolderResize }, /* @__PURE__ */ import_react$48.createElement("div", {
			ref: tabListRef,
		...
		}, tabNodes, /* @__PURE__ */ import_react$48.createElement(AddButton_default, {
			ref: innerAddButtonRef,
			prefixCls,
			locale,
			editable,
			style: _objectSpread2(_objectSpread2({}, tabNodes.length === 0 ? void 0 : tabNodeStyle), {}, { visibility: hasDropdown ? "hidden" : null })
		}), /* @__PURE__ */ import_react$48.createElement("div", {
			className: (0, import_classnames$17.default)("".concat(prefixCls, "-ink-bar"), _defineProperty({}, "".concat(prefixCls, "-ink-bar-animated"), animated.inkBar)),
			style: indicatorStyle
		}))))), /* @__PURE__ */ import_react$48.createElement(OperationNode_default, _extends({}, props, {
			removeAriaLabel: locale === null || locale === void 0 ? void 0 : locale.removeAriaLabel,
			ref: operationsRef,
			prefixCls,
			tabs: hiddenTabs,
...
var import_classnames$16, import_react$47, TabPane, TabPane_default;
var init_TabPane = __esmMin((() => {
	...
	TabPane = /* @__PURE__ */ import_react$47.forwardRef(function(props, ref) {
		...
		return /* @__PURE__ */ import_react$47.createElement("div", {
			...
			"aria-hidden": !active,
			style,
			className: (0, import_classnames$16.default)(prefixCls, active && "".concat(prefixCls, "-active"), className),
			ref
		}, children);
	});
	TabPane_default = TabPane;
}));
var import_react$46, _excluded$11, _excluded2$2, TabNavListWrapper, Wrapper_default;
var init_Wrapper = __esmMin((() => {
	...
	init_TabContext();
	init_TabPane();
	_excluded$11 = ["renderTabBar"], _excluded2$2 = ["label", "key"];
	TabNavListWrapper = function TabNavListWrapper$1(_ref) {
		var renderTabBar = _ref.renderTabBar, restProps = _objectWithoutProperties(_ref, _excluded$11);
		var tabs = import_react$46.useContext(TabContext_default).tabs;
		if (renderTabBar) return renderTabBar(_objectSpread2(_objectSpread2({}, restProps), {}, { panes: tabs.map(function(_ref2) {
			...
			return /* @__PURE__ */ import_react$46.createElement(TabPane_default, _extends({
				tab: label,
				key,
				tabKey: key
			}, restTabProps));
		}) }), TabNavList_default);
		return /* @__PURE__ */ import_react$46.createElement(TabNavList_default, restProps);
	};
	Wrapper_default = TabNavListWrapper;
}));
var import_classnames$15, import_react$45, _excluded$10, TabPanelList, TabPanelList_default;
var init_TabPanelList = __esmMin((() => {
	...
	TabPanelList = function TabPanelList$1(props) {
		...
		var _React$useContext = import_react$45.useContext(TabContext_default), prefixCls = _React$useContext.prefixCls, tabs = _React$useContext.tabs;
		var tabPaneAnimated = animated.tabPane;
		var tabPanePrefixCls = "".concat(prefixCls, "-tabpane");
		return /* @__PURE__ */ import_react$45.createElement("div", { className: (0, import_classnames$15.default)("".concat(prefixCls, "-content-holder")) }, /* @__PURE__ */ import_react$45.createElement("div", { className: (0, import_classnames$15.default)("".concat(prefixCls, "-content"), "".concat(prefixCls, "-content-").concat(tabPosition), _defineProperty({}, "".concat(prefixCls, "-content-animated"), tabPaneAnimated)) }, tabs.map(function(item) {
			var key = item.key, forceRender = item.forceRender, paneStyle = item.style, paneClassName = item.className, itemDestroyInactiveTabPane = item.destroyInactiveTabPane, restTabProps = _objectWithoutProperties(item, _excluded$10);
			var active = key === activeKey;
			return /* @__PURE__ */ import_react$45.createElement(es_default$7, _extends({
				key,
				visible: active,
				forceRender,
				...
				return /* @__PURE__ */ import_react$45.createElement(TabPane_default, _extends({}, restTabProps, {
					...
					className: (0, import_classnames$15.default)(paneClassName, motionClassName),
					ref
				}));
			});
		})));
...
var import_classnames$14, import_react$43, import_react$44, _excluded$9, uuid, Tabs, Tabs_default;
var init_Tabs = __esmMin((() => {
	...
	uuid = 0;
	Tabs = /* @__PURE__ */ import_react$43.forwardRef(function(props, ref) {
		...
		var tabs = import_react$43.useMemo(function() {
		...
		var _useState2 = _slicedToArray((0, import_react$44.useState)(false), 2), mobile = _useState2[0], setMobile = _useState2[1];
		...
		var _useState4 = _slicedToArray((0, import_react$44.useState)(function() {
		...
		return /* @__PURE__ */ import_react$43.createElement(TabContext_default.Provider, { value: {
			tabs,
			prefixCls
		} }, /* @__PURE__ */ import_react$43.createElement("div", _extends({
			ref,
			id,
			className: (0, import_classnames$14.default)(prefixCls, "".concat(prefixCls, "-").concat(tabPosition), _defineProperty(_defineProperty(_defineProperty({}, "".concat(prefixCls, "-mobile"), mobile), "".concat(prefixCls, "-editable"), editable), "".concat(prefixCls, "-rtl"), rtl), className)
		}, restProps), /* @__PURE__ */ import_react$43.createElement(Wrapper_default, _extends({}, tabNavBarProps, { renderTabBar })), /* @__PURE__ */ import_react$43.createElement(TabPanelList_default, _extends({ destroyInactiveTabPane }, sharedProps, { animated: mergedAnimated }))));
	});
	Tabs_default = Tabs;
}));
var es_exports$3 = /* @__PURE__ */ __export({ default: () => es_default$6 }, 1);
var es_default$6;
var init_es$5 = __esmMin((() => {
	init_Tabs();
	es_default$6 = Tabs_default;
}));
...
var init_InputNumber = __esmMin((() => {
	...
	InternalInputNumber = /* @__PURE__ */ import_react$38.forwardRef(function(props, ref) {
		...
		var collectInputValue = function collectInputValue$1(inputStr) {
			...
			if (!compositionRef.current) {
				var finalDecimal = es_default$5(mergedParser(inputStr));
		...
		var onInternalStep = function onInternalStep$1(up) {
			...
			var updatedValue = triggerValueUpdate((decimalValue || es_default$5(0)).add(stepDecimal.toString()), false);
	...
	InputNumber = /* @__PURE__ */ import_react$38.forwardRef(function(props, ref) {
		...
		return /* @__PURE__ */ import_react$38.createElement(BaseInput_default, {
			...
			className: classNames$19 === null || classNames$19 === void 0 ? void 0 : classNames$19.input
		}, rest)));
	});
...
export { es_default$6 as _, convertChildrenToColumns as a, FooterComponents as c, es_default$3 as d, es_exports$1 as f, init_es$3 as g, es_exports$2 as h, genTable as i, EXPAND_COLUMN as l, es_default$4 as m, init_es as n, init_useColumns as o, init_es$2 as p, genVirtualTable as r, INTERNAL_COL_DEFINE as s, es_exports as t, INTERNAL_HOOKS as u, es_exports$3 as v, init_es$5 as y };
