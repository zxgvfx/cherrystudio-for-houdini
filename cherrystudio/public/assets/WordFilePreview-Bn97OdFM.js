...
import { t as FilePreviewToolbarButton } from "./FilePreviewToolbarButton-D2NN1_DC.js";
import { t as require_jszip_min } from "./jszip.min-BD5M7xLZ.js";
var import_jszip_min = /* @__PURE__ */ __toESM(require_jszip_min(), 1);
var RelationshipTypes;
(function(RelationshipTypes$1) {
	RelationshipTypes$1["OfficeDocument"] = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/officeDocument";
	RelationshipTypes$1["FontTable"] = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/fontTable";
	RelationshipTypes$1["Image"] = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/image";
	RelationshipTypes$1["Numbering"] = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/numbering";
	RelationshipTypes$1["Styles"] = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/styles";
	RelationshipTypes$1["StylesWithEffects"] = "http://schemas.microsoft.com/office/2007/relationships/stylesWithEffects";
	RelationshipTypes$1["Theme"] = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/theme";
	RelationshipTypes$1["Settings"] = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/settings";
	RelationshipTypes$1["WebSettings"] = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/webSettings";
	RelationshipTypes$1["Hyperlink"] = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/hyperlink";
	RelationshipTypes$1["Footnotes"] = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/footnotes";
	RelationshipTypes$1["Endnotes"] = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/endnotes";
	RelationshipTypes$1["Footer"] = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/footer";
	RelationshipTypes$1["Header"] = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/header";
	RelationshipTypes$1["ExtendedProperties"] = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/extended-properties";
	RelationshipTypes$1["CoreProperties"] = "http://schemas.openxmlformats.org/package/2006/relationships/metadata/core-properties";
	RelationshipTypes$1["CustomProperties"] = "http://schemas.openxmlformats.org/package/2006/relationships/metadata/custom-properties";
	RelationshipTypes$1["Comments"] = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/comments";
	RelationshipTypes$1["CommentsExtended"] = "http://schemas.microsoft.com/office/2011/relationships/commentsExtended";
	RelationshipTypes$1["AltChunk"] = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/aFChunk";
...
function convertLength(val, usage = LengthUsage.Dxa) {
	...
	if (usage.min && usage.max) num = clamp$1(num, usage.min, usage.max);
...
var SectionType;
(function(SectionType$1) {
	SectionType$1["Continuous"] = "continuous";
	SectionType$1["NextPage"] = "nextPage";
	SectionType$1["NextColumn"] = "nextColumn";
	SectionType$1["EvenPage"] = "evenPage";
	SectionType$1["OddPage"] = "oddPage";
...
var DomType;
(function(DomType$1) {
	DomType$1["Document"] = "document";
	DomType$1["Paragraph"] = "paragraph";
	DomType$1["Run"] = "run";
	DomType$1["Break"] = "break";
	DomType$1["NoBreakHyphen"] = "noBreakHyphen";
	DomType$1["Table"] = "table";
	DomType$1["Row"] = "row";
	DomType$1["Cell"] = "cell";
	DomType$1["Hyperlink"] = "hyperlink";
	DomType$1["SmartTag"] = "smartTag";
	DomType$1["Drawing"] = "drawing";
	DomType$1["Image"] = "image";
	DomType$1["Text"] = "text";
	DomType$1["Tab"] = "tab";
	DomType$1["Symbol"] = "symbol";
	DomType$1["BookmarkStart"] = "bookmarkStart";
	DomType$1["BookmarkEnd"] = "bookmarkEnd";
	DomType$1["Footer"] = "footer";
	DomType$1["Header"] = "header";
	DomType$1["FootnoteReference"] = "footnoteReference";
	DomType$1["EndnoteReference"] = "endnoteReference";
	DomType$1["Footnote"] = "footnote";
	DomType$1["Endnote"] = "endnote";
	DomType$1["SimpleField"] = "simpleField";
	DomType$1["ComplexField"] = "complexField";
	DomType$1["Instruction"] = "instruction";
	DomType$1["VmlPicture"] = "vmlPicture";
	DomType$1["MmlMath"] = "mmlMath";
	DomType$1["MmlMathParagraph"] = "mmlMathParagraph";
	DomType$1["MmlFraction"] = "mmlFraction";
	DomType$1["MmlFunction"] = "mmlFunction";
	DomType$1["MmlFunctionName"] = "mmlFunctionName";
	DomType$1["MmlNumerator"] = "mmlNumerator";
	DomType$1["MmlDenominator"] = "mmlDenominator";
	DomType$1["MmlRadical"] = "mmlRadical";
	DomType$1["MmlBase"] = "mmlBase";
	DomType$1["MmlDegree"] = "mmlDegree";
	DomType$1["MmlSuperscript"] = "mmlSuperscript";
	DomType$1["MmlSubscript"] = "mmlSubscript";
	DomType$1["MmlPreSubSuper"] = "mmlPreSubSuper";
	DomType$1["MmlSubArgument"] = "mmlSubArgument";
	DomType$1["MmlSuperArgument"] = "mmlSuperArgument";
	DomType$1["MmlNary"] = "mmlNary";
	DomType$1["MmlDelimiter"] = "mmlDelimiter";
	DomType$1["MmlRun"] = "mmlRun";
	DomType$1["MmlEquationArray"] = "mmlEquationArray";
	DomType$1["MmlLimit"] = "mmlLimit";
	DomType$1["MmlLimitLower"] = "mmlLimitLower";
	DomType$1["MmlMatrix"] = "mmlMatrix";
	DomType$1["MmlMatrixRow"] = "mmlMatrixRow";
	DomType$1["MmlBox"] = "mmlBox";
	DomType$1["MmlBar"] = "mmlBar";
	DomType$1["MmlGroupChar"] = "mmlGroupChar";
	DomType$1["VmlElement"] = "vmlElement";
	DomType$1["Inserted"] = "inserted";
	DomType$1["Deleted"] = "deleted";
	DomType$1["DeletedText"] = "deletedText";
	DomType$1["Comment"] = "comment";
	DomType$1["CommentReference"] = "commentReference";
	DomType$1["CommentRangeStart"] = "commentRangeStart";
	DomType$1["CommentRangeEnd"] = "commentRangeEnd";
	DomType$1["AltChunk"] = "altChunk";
})(DomType || (DomType = {}));
...
function updateTabStop(elem, tabs, defaultTabSize, pixelToPoint = 72 / 96) {
	...
	if (tab.style == "right" || tab.style == "center") {
		const tabStops$1 = Array.from(p.querySelectorAll(`.${elem.className}`));
		const nextIdx = tabStops$1.indexOf(elem) + 1;
		const range = document.createRange();
		range.setStart(elem, 1);
		if (nextIdx < tabStops$1.length) range.setEndBefore(tabStops$1[nextIdx]);
...
var HtmlRenderer = class {
	...
	async render(document$1, bodyContainer, styleContainer = null, options) {
		...
		if (document$1.themePart) {
			styleContainer.appendChild(this.createComment("docxjs document theme values"));
			this.renderTheme(document$1.themePart, styleContainer);
		}
		if (document$1.stylesPart != null) {
			this.styleMap = this.processStyles(document$1.stylesPart.styles);
			styleContainer.appendChild(this.createComment("docxjs document styles"));
			styleContainer.appendChild(this.renderStyles(document$1.stylesPart.styles));
		}
		if (document$1.numberingPart) {
			this.prodessNumberings(document$1.numberingPart.domNumberings);
			styleContainer.appendChild(this.createComment("docxjs document numbering styles"));
			styleContainer.appendChild(this.renderNumbering(document$1.numberingPart.domNumberings, styleContainer));
		}
		if (document$1.footnotesPart) this.footnoteMap = keyBy(document$1.footnotesPart.notes, (x) => x.id);
		if (document$1.endnotesPart) this.endnoteMap = keyBy(document$1.endnotesPart.notes, (x) => x.id);
		if (document$1.settingsPart) this.defaultTabSize = document$1.settingsPart.settings?.defaultTabStop;
		if (!options.ignoreFonts && document$1.fontTablePart) this.renderFontTable(document$1.fontTablePart, styleContainer);
		var sectionElements = this.renderSections(document$1.documentPart.body);
		if (this.options.inWrapper) bodyContainer.appendChild(this.renderWrapper(sectionElements));
		else appendChildren(bodyContainer, sectionElements);
	...
	renderFontTable(fontsPart, styleContainer) {
		for (let f of fontsPart.fonts) for (let ref of f.embedFontRefs) this.tasks.push(this.document.loadFont(ref.id, ref.key).then((fontData) => {
			const cssValues = {
	...
	createSectionContent(props) {
		...
		if (props.columns && props.columns.numberOfColumns) {
			...
			if (props.columns.separator) elem.style.columnRule = "1px solid black";
		}
		return elem;
	}
	renderSections(document$1) {
		const result = [];
		this.processElement(document$1);
		const sections = this.splitBySection(document$1.children, document$1.props);
		...
		for (let i = 0, l = pages.length; i < l; i++) {
			...
			this.renderStyleValues(document$1.cssStyle, pageElement);
			...
			if (this.options.renderFootnotes) this.renderNotes(this.currentFootnoteIds, this.footnoteMap, pageElement);
			if (this.options.renderEndnotes && i == l - 1) this.renderNotes(this.currentEndnoteIds, this.endnoteMap, pageElement);
...
`;
	...
	renderElement(elem) {
		switch (elem.type) {
			...
			case DomType.NoBreakHyphen: return this.createElement("wbr");
	...
	renderContainerNS(elem, ns$2, tagName, props) {
		return this.createElementNS(ns$2, tagName, props, this.renderElements(elem.children));
	}
	...
	renderHyperlink(elem) {
		...
		this.renderStyleValues(elem.cssStyle, result);
		let href = "";
		if (elem.id) href = this.document.documentPart.rels.find((it) => it.id == elem.id && it.targetMode === "External")?.target ?? href;
		if (elem.anchor) href += `#${elem.anchor}`;
		result.href = href;
		return result;
	}
	renderSmartTag(elem) {
	...
	renderBreak(elem) {
		if (elem.break == "textWrapping") return this.createElement("br");
		return null;
	}
	renderInserted(elem) {
	...
	renderRun(elem) {
		...
		} else this.renderElements(elem.children, result);
		return result;
	}
	renderTable(elem) {
	...
	renderMmlRadical(elem) {
		...
		if (elem.props?.hideDegree) return this.createElementNS(ns.mathML, "msqrt", null, this.renderElements([base]));
	...
	renderMmlNary(elem) {
		...
		if (supElem || subElem) children.push(this.createElementNS(ns.mathML, "munderover", null, [
			charElem,
			subElem,
			supElem
		]));
		else if (supElem) children.push(this.createElementNS(ns.mathML, "mover", null, [charElem, supElem]));
		else if (subElem) children.push(this.createElementNS(ns.mathML, "munder", null, [charElem, subElem]));
	...
	renderMmlPreSubSuper(elem) {
		...
		children.push(this.createElementNS(ns.mathML, "msubsup", null, [
			stubElem,
			subElem,
			supElem
		]));
	...
	renderMmlGroupChar(elem) {
		...
		if (elem.props.char) result.appendChild(this.createElementNS(ns.mathML, "mo", null, [elem.props.char]));
		return result;
	}
	renderMmlBar(elem) {
	...
	renderMllList(elem) {
		...
		this.renderClass(elem, result);
		this.renderStyleValues(elem.cssStyle, result);
		for (let child of this.renderElements(elem.children)) result.appendChild(this.createElementNS(ns.mathML, "mtr", null, [this.createElementNS(ns.mathML, "mtd", null, [child])]));
		return result;
	}
	renderStyleValues(style, ouput) {
		for (let k in style) if (k.startsWith("$")) ouput.setAttribute(k.slice(1), style[k]);
		else ouput.style[k] = style[k];
	}
	...
	styleToString(selectors, values$1, cssText = null) {
		let result = `${selectors} {\r\n`;
		for (const key in values$1) {
			if (key.startsWith("$")) continue;
			result += `  ${key}: ${values$1[key]};\r\n`;
		}
	...
	createElementNS(ns$2, tagName, props, children) {
		var result = ns$2 ? this.htmlDocument.createElementNS(ns$2, tagName) : this.htmlDocument.createElement(tagName);
...
async function renderDocument(document$1, bodyContainer, styleContainer, userOptions) {
	const ops = {
		...defaultOptions,
		...userOptions
	};
	return await new HtmlRenderer(window.document).render(document$1, bodyContainer, styleContainer, ops);
}
...
function assertNoZip64Uint16Marker(value) {
	if (value === ZIP_UINT16_MAX) throw new Error("DOCX preview does not support ZIP64 archives");
}
function assertNoZip64Uint32Marker(value) {
	if (value === ZIP_UINT32_MAX) throw new Error("DOCX preview does not support ZIP64 archives");
}
function assertDocxZipLimits(bytes, limits = DOCX_ZIP_LIMITS) {
	...
	if (diskNumber !== 0 || centralDirectoryDisk !== 0 || entriesOnDisk !== entryCount) throw new Error("DOCX preview does not support multi-disk ZIP archives");
	...
	if (entryCount > limits.maxEntries) throw new Error(`DOCX preview supports ZIP archives with up to ${limits.maxEntries} entries`);
	const centralDirectoryEnd = centralDirectoryOffset + centralDirectorySize;
	if (centralDirectoryEnd > eocdOffset || centralDirectoryEnd < centralDirectoryOffset) throw new Error("DOCX preview requires a valid ZIP central directory");
	let cursor = centralDirectoryOffset;
	let totalUncompressedBytes = 0;
	for (let index = 0; index < entryCount; index += 1) {
		if (cursor + ZIP_CENTRAL_FILE_HEADER_BYTES > centralDirectoryEnd) throw new Error("DOCX preview requires a valid ZIP central directory");
		if (view.getUint32(cursor, true) !== ZIP_CENTRAL_FILE_HEADER_SIGNATURE) throw new Error("DOCX preview requires a valid ZIP central directory");
		...
		if (uncompressedBytes > limits.maxEntryUncompressedBytes) throw new Error(`DOCX preview supports ZIP entries up to ${limits.maxEntryUncompressedBytes} uncompressed bytes`);
		totalUncompressedBytes += uncompressedBytes;
		if (totalUncompressedBytes > limits.maxTotalUncompressedBytes) throw new Error(`DOCX preview supports ZIP archives up to ${limits.maxTotalUncompressedBytes} total uncompressed bytes`);
...
function WordFilePreviewToolbar({ canNextPage, canPreviousPage, canResetZoom, canZoomIn, canZoomOut, currentPage, onNextPage, onPreviousPage, onResetZoom, onZoomIn, onZoomOut, pageCount, zoomLabel }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(FilePreviewToolbar, {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
				"data-ui": "ui.word-file-preview-toolbar.docx-preview-page-indicator",
				"aria-live": "polite",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				"data-ui": "ui.word-file-preview-toolbar.docx-preview-zoom-value",
...
var logger = loggerService.withContext("WordFilePreview");
var DOCX_PREVIEW_DEFAULT_ZOOM = 1;
var DOCX_PREVIEW_ZOOM_STEP = .1;
var DOCX_PREVIEW_MIN_ZOOM = .5;
var DOCX_PREVIEW_MAX_ZOOM = 2;
var DOCX_PREVIEW_MAX_SOURCE_BYTES = 25 * 1024 * 1024;
var SAFE_HYPERLINK_PROTOCOLS = new Set([
	"http:",
	"https:",
	"mailto:"
]);
var clamp = (value, min, max) => Math.min(Math.max(value, min), max);
var formatDocxZoom = (zoom) => `${Math.round(zoom * 100)}%`;
...
function assertSourceSize(size) {
	if (size > DOCX_PREVIEW_MAX_SOURCE_BYTES) throw new Error("DOCX preview supports files up to 25 MB");
}
function getRenderedPages(body) {
	const sections = Array.from(body.querySelectorAll("section"));
	if (sections.length > 0) return sections;
	return Array.from(body.children).filter((child) => child instanceof HTMLElement);
}
function sanitizeHyperlinks(body) {
...
function WordFilePreview({ filePath, fileName, metadata, refreshKey }) {
	const { t } = useTranslation();
	const containerRef = (0, import_react.useRef)(null);
	const bodyRef = (0, import_react.useRef)(null);
	const styleRef = (0, import_react.useRef)(null);
	const renderTokenRef = (0, import_react.useRef)(0);
	...
	const [zoom, setZoom] = (0, import_react.useState)(DOCX_PREVIEW_DEFAULT_ZOOM);
	...
	const jumpToPage = (0, import_react.useCallback)((pageNumber) => {
		...
		bodyRef.current?.querySelector(`#docx-preview-page-${nextPage}`)?.scrollIntoView?.({ block: "start" });
		focusContainer();
	}, [focusContainer, pageCount]);
	const zoomBy = (0, import_react.useCallback)((direction) => {
		setZoom((value) => clamp(Number((value + (direction === "in" ? DOCX_PREVIEW_ZOOM_STEP : -DOCX_PREVIEW_ZOOM_STEP)).toFixed(2)), DOCX_PREVIEW_MIN_ZOOM, DOCX_PREVIEW_MAX_ZOOM));
		focusContainer();
	}, [focusContainer]);
	...
	(0, import_react.useEffect)(() => {
		...
		const pages = Array.from(bodyContainer.querySelectorAll(".docx-preview-page"));
	...
	const contentStyle = { zoom };
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(FilePreviewLayout.Frame, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(WordFilePreviewToolbar, {
		...
		"data-ui": "ui.word-file-preview",
		"data-testid": "word-file-preview",
		className: "relative h-full min-h-0 w-full overflow-hidden bg-background",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				"data-ui": "ui.word-file-preview.region",
				ref: containerRef,
				role: "region",
				"aria-label": fileName,
				...
				tabIndex: 0,
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ref: styleRef }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					"data-ui": "ui.word-file-preview.docx-preview-content",
					ref: bodyRef,
			...
			loading ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				"data-ui": "ui.word-file-preview.status",
				role: "status",
			...
			error ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				"data-ui": "ui.word-file-preview.alert",
				role: "alert",
...
export { WordFilePreview as default };
