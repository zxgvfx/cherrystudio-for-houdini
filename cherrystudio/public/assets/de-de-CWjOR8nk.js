...
const assistants = {
	...
	"clear": {
		...
		"menu_title": "Lösche alle Assistenten-Konversationen",
	...
	"settings": {
		...
		"regular_phrases": {
			...
			"contentLabel": "Inhalt",
			"contentPlaceholder": "Bitte geben Sie den Phraseninhalt ein, unterstützen Sie die Verwendung von Variablen und drücken Sie die Tab-Taste, um schnell zur zu ändernden Variable zu springen. Beispiel:  \nHilf mir, eine Route von ${from} nach ${to} zu planen und sende sie an ${email}.",
...
const code = {
	...
	"format_json": "Format",
	"hero_tagline": "Wähle ein CLI-Tool zur Konfiguration",
	...
	"no_providers_description": "Aktiviere einen unterstützten Anbieter unter Einstellungen → Modell-Service",
...
const file_preview = {
	...
	"pdf": { "too_large": {
		...
		"description": "PDF-Dateien, die größer als {{limit}} MiB sind, können nicht in der Vorschau angezeigt werden.",
...
const models = {
	...
	"multi_select": { "label": "Multi-Modell-Parallelität (schließt sich gegenseitig mit Multi-Assistent aus)" },
...
const openclaw = {
	...
	"node_missing": {
		"description": "OpenClaw benötigt Node.js 22+. Bitte installiere zuerst Node.js und klicke dann erneut auf Installieren.",
	...
	"node_version_low": {
		"description": "OpenClaw erfordert Node.js 22.0 oder höher. Deine aktuelle Version ist v{{version}}. Bitte aktualisiere Node.js zuerst.",
	...
	"not_installed": {
		...
		"install_button": "Installiere OpenClaw",
...
const paintings = {
	...
	"select_model": "Modell auswählen",
	"showcase": {
		"caption": "Wähle eine Vorlage aus und passe anschließend den Prompt unten an.",
		"styles_label": "Prompt-Vorlagen",
		"title": "Raum für dein nächstes Meisterwerk."
	},
	"style_options": {
		"anime": "Anime",
		"auto": "Auto",
...
const translate = {
	...
	"input": { "placeholder": "Text, Textdatei, Bild (OCR unterstützt) können eingefügt oder gezogen werden" },
	"language": {
