...
import { b as LanguageSelect_default } from "./LanguageSelect-D02L87Wm.js";
import { aL as ArrowLeftOutlined_default, aX as SwapOutlined_default, ai as EnterOutlined_default, c as init_es, co as LoadingOutlined_default, cy as CloseOutlined_default, eA as useTranslation, eW as defaultLanguage, ex as require_jsx_runtime, ez as i18n_default, f4 as loggerService } from "./es-B_kyM-eZ.js";
import { aO as ModelAvatar_default, as as fetchChatCompletion, b7 as getAssistantMessage, ba as getUserMessage, c3 as MessageErrorBoundary_default, cE as MessageContent_default, cm as useTranslate, cx as translateText, d as store_default, d7 as useHotkeys, dI as useTheme, e$ as divider_default, e7 as useTimer, eD as Scrollbar_default, eG as typography_default, eI as tag_default, eT as input_default, er as useTopicMessages, es as useAssistant, ev as useDefaultModel, f as useAppSelector, f1 as col_default$1, fD as throttledBlockUpdate, fM as abortCompletion, fN as ConversationService, fQ as replacePromptVariables, fU as newMessagesActions, fV as selectMessagesForTopic, fo as select_default, fx as alert_default, fy as cancelThrottledBlockUpdate, gW as getDefaultTopic, gc as useSettings, ge as formatErrorMessage, gj as isAbortError, gk as ChunkType, gq as getMainTextContent, gs as updateOneBlock, gt as upsertManyBlocks, gu as upsertOneBlock, j4 as runAsyncFunction, j7 as classNames, k9 as isMac, kA as ThemeMode, kc as IpcChannel, kn as databases_default, kr as createMainTextBlock, kt as createThinkingBlock, kv as require_lodash, kw as AssistantMessageStatus, kx as MessageBlockStatus, l2 as LanguagesEnum } from "./store-CN98hBHC.js";
import { b as require_react } from "./react-nO8b1aHv.js";
import { G as CopyIcon_default, V as space_default, _ as tooltip_default, al as button_default, bu as dt } from "./ImageViewer-KXB8VvoX.js";
import { b as CircleArrowLeft } from "./circle-arrow-left-CgDuKdRV.js";
import { b as Copy } from "./copy-07cSu9Qf.js";
import { b as FileText } from "./file-text-D86T6Z-T.js";
import { b as Languages } from "./languages-u0szbzQA.js";
import { b as Lightbulb } from "./lightbulb-Dxzcatk0.js";
import { b as MessageSquare } from "./message-square-CBvhQjJe.js";
