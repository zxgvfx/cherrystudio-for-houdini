...
import { L as toHtml, T as normalizeTheme } from "./dist-oTn6Mzbo.js";
import { c as createHighlighter, d as createOnigurumaEngine, h as bundledLanguages, p as bundledThemes, t as createJavaScriptRegexEngine } from "./dist-ry9cWLbi.js";
import { n as useCodeStyle } from "./useCodeStyle-hWHmowmT.js";
import { t as Columns2 } from "./columns-2-8N8fQ1T8.js";
import { t as Rows2 } from "./rows-2-DNUKbPp6.js";
...
async function getSharedHighlighter({ themes, langs, preferredHighlighter = "shiki-js" }) {
	highlighter ??= createHighlighter({
		themes: [],
		langs: ["text"],
		engine: preferredHighlighter === "shiki-wasm" ? createOnigurumaEngine(__vitePreload(() => import("./wasm-RpsC0kfk.js"), [], import.meta.url)) : createJavaScriptRegexEngine()
	});
...
registerCustomTheme("pierre-dark", async () => {
	const m = await __vitePreload(() => import("./pierre-dark-CdtsZHgO.js"), [], import.meta.url);
	return {
		...m.default ?? m,
		name: "pierre-dark"
	};
...
registerCustomTheme("pierre-light", async () => {
	const m = await __vitePreload(() => import("./pierre-light-RbgCCGF6.js"), [], import.meta.url);
	return {
		...m.default ?? m,
		name: "pierre-light"
	};
