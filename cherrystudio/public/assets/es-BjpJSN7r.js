import { a as __toESM, n as __esmMin, r as __export } from "./chunk-BilcBJ05.js";
import { Ai as init_useMergedState, Co as init_typeof, Eo as require_classnames, Fi as useEvent, Oa as _toConsumableArray, Pi as init_useEvent, So as _typeof, Ta as init_slicedToArray, To as init_extends, _a as init_objectWithoutProperties, _o as init_warning, ai as KeyCode_default, ca as useLayoutEffect_default, fo as require_react_dom, ga as _objectWithoutProperties, go as init_defineProperty, ha as isEqual_default, ho as _defineProperty, ji as useMergedState, ka as init_toConsumableArray, ma as init_isEqual, mo as init_objectSpread2, oi as init_KeyCode, po as _objectSpread2, sa as init_useLayoutEffect, wa as _slicedToArray, wo as _extends, yo as warning_default } from "./es-CLFTGHaZ.js";
...
var init_Handles = __esmMin((() => {
	...
	Handles = /* @__PURE__ */ import_react$10.forwardRef(function(props, ref) {
		...
		var _React$useState2 = _slicedToArray(import_react$10.useState(false), 2), activeVisible = _React$useState2[0], setActiveVisible = _React$useState2[1];
		var _React$useState4 = _slicedToArray(import_react$10.useState(-1), 2), activeIndex = _React$useState4[0], setActiveIndex = _React$useState4[1];
...
function useDrag(containerRef, direction, rawValues, min, max, formatValue, triggerChange, finishChange, offsetValues, editable, minCount) {
	var _React$useState2 = _slicedToArray(import_react$3.useState(null), 2), draggingValue = _React$useState2[0], setDraggingValue = _React$useState2[1];
	var _React$useState4 = _slicedToArray(import_react$3.useState(-1), 2), draggingIndex = _React$useState4[0], setDraggingIndex = _React$useState4[1];
	var _React$useState6 = _slicedToArray(import_react$3.useState(false), 2), draggingDelete = _React$useState6[0], setDraggingDelete = _React$useState6[1];
	var _React$useState8 = _slicedToArray(import_react$3.useState(rawValues), 2), cacheValues = _React$useState8[0], setCacheValues = _React$useState8[1];
	var _React$useState10 = _slicedToArray(import_react$3.useState(rawValues), 2), originValues = _React$useState10[0], setOriginValues = _React$useState10[1];
	...
	return [
		...
		draggingValue,
		draggingDelete,
		import_react$3.useMemo(function() {
...
export { UnstableContext as i, es_exports as n, init_es as r, es_default as t };
