const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./esm-C2e-dv3J.js","./extends-DTNb3m69.js","./dist-CoUlMpOM.js"])))=>i.map(i=>d[i]);
...
function loadCmThemes() {
	cmThemesPromise ??= __vitePreload(() => import("./esm-C2e-dv3J.js"), __vite__mapDeps([0,1,2]), import.meta.url);
