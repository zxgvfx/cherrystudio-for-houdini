...
import { c as writeComposerRichClipboardContent } from "./composerClipboard-CLOfQP5i.js";
var import_dayjs_min = /* @__PURE__ */ __toESM(require_dayjs_min());
async function exportTableToExcel(data) {
	if (data.length === 0) return false;
	const XLSX = await __vitePreload(() => import("./xlsx-BHroXO06.js"), [], import.meta.url);
