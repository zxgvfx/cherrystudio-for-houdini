...
import { L as toHtml, T as normalizeTheme } from "./dist-Cu7DuZHc.js";
import { c as createHighlighter, d as createOnigurumaEngine, h as bundledLanguages, p as bundledThemes, t as createJavaScriptRegexEngine } from "./dist-J1XnJP4k.js";
import { n as useCodeStyle } from "./useCodeStyle-ZK5esKOR.js";
import { t as Columns2 } from "./columns-2-DJJTKlZR.js";
import { t as Rows2 } from "./rows-2-Dds5pNby.js";
...
async function getSharedHighlighter({ themes, langs, preferredHighlighter = "shiki-js" }) {
	highlighter ??= createHighlighter({
		themes: [],
		langs: ["text"],
		engine: preferredHighlighter === "shiki-wasm" ? createOnigurumaEngine(__vitePreload(() => import("./wasm-DKbFjCaA.js"), [], import.meta.url)) : createJavaScriptRegexEngine()
	});
...
registerCustomTheme("pierre-dark", async () => {
	const m = await __vitePreload(() => import("./pierre-dark-Kd2-Zrfv.js"), [], import.meta.url);
	return {
		...m.default ?? m,
		name: "pierre-dark"
	};
...
registerCustomTheme("pierre-light", async () => {
	const m = await __vitePreload(() => import("./pierre-light-CgUps9FV.js"), [], import.meta.url);
	return {
		...m.default ?? m,
		name: "pierre-light"
	};
