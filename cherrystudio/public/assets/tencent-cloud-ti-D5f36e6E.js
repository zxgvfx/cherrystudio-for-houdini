...
function TencentCloudTiAvatar({ size = 32, shape = "circle", className }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Avatar, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AvatarFallback, {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TencentCloudTiLight, { style: {
				width: size,
				height: size
			} })
		})
...
var TencentCloudTi = ({ variant, className, ...props }) => {
	if (variant === "light") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TencentCloudTiLight, {
		...props,
		className
	});
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TencentCloudTiLight, {
		...props,
		className
	});
};
const TencentCloudTiIcon = /* @__PURE__ */ Object.assign(TencentCloudTi, {
	Avatar: TencentCloudTiAvatar,
	colorPrimary: "#00A3FF"
});
export { TencentCloudTiIcon as t };
