...
import { a as isComposerMessageTokenKind, i as isComposerMessageTextTokenKind } from "./composerTokenPolicy-BR1gNZTA.js";
...
function getComposerTokenClipboardText(token) {
	...
	if (token.kind === "link" || token.kind === "pipelineNode") return token.promptText ?? token.label;
	return token.label;
}
