...
var DocumentProcessingSettings = () => {
	...
	const menuEntries = (0, import_react.useMemo)(() => getFeatureSections(processors, availableProcessors.processorIds).find((section) => section.feature === "document_to_markdown")?.entries ?? EMPTY_MENU_ENTRIES, [availableProcessors.processorIds, processors]);
