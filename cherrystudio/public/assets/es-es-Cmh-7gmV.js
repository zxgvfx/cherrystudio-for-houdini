...
const assistants = {
	...
	"clear": {
		...
		"menu_title": "Eliminar todas las conversaciones con el asistente",
	...
	"settings": {
		...
		"regular_phrases": {
			...
			"contentPlaceholder": "Introduce el contenido de la frase; admite el uso de variables y presiona Tab para localizar rápidamente la variable a modificar. Por ejemplo:\nAyúdame a planificar una ruta desde ${from} hasta ${to} y envíala a ${email}.",
...
const code = {
	...
	"providerless_hint": "Esta herramienta se autentica a través de su propio flujo de inicio de sesión: simplemente elige un directorio de trabajo y lánzala. Ejecuta la herramienta una vez para iniciar sesión.",
	...
	"working_directory_hint": "El directorio de trabajo en el que se ejecuta la herramienta CLI"
};
const code_block = {
	"collapse": "Replegar",
	"copy": {
...
const file_preview = {
	...
	"pdf": { "too_large": {
		...
		"description": "Los archivos PDF de más de {{limit}} MiB no se pueden previsualizar.",
...
const models = {
	...
	"multi_select": { "label": "Paralelismo multi-modelo (mutuamente excluyente con multi-asistente)" },
...
const notes = {
	...
	"title": "notas",
	"tree_load_failed": "Error al cargar el directorio de notas",
...
const openclaw = {
	...
	"node_missing": {
		"description": "OpenClaw requiere Node.js/npm. Por favor, instala Node.js primero y luego reinicia Cherry Studio.",
...
const translate = {
	...
	"input": { "placeholder": "Puede pegar o arrastrar texto, archivos de texto o imágenes (compatible con OCR)" },
	"language": {
