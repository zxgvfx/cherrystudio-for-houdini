...
import { _ as createContextScope, a as useControllableState, c as useId, g as createSlottable, i as usePortalContainer, o as Presence, p as Primitive, s as Portal$1, u as DismissableLayer, v as useComposedRefs, y as composeEventHandlers } from "./portal-container-CJZY5KbV.js";
import { a as createPopperScope, i as Root2, n as Arrow, r as Content, t as Anchor } from "./dist-uhrWF5Y5.js";
import { t as Root } from "./dist-BCEH2mJk.js";
...
function TooltipRoot({ delayDuration = 0, ...props }) {
...
function TooltipContent({ className, sideOffset = 0, children, portalContainer, showArrow = true, ...props }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Portal, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Content2, {
			...
			...mergeUiProps(props, "part:tooltip-content"),
			children: [children, showArrow && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Arrow2, {
				width: 12,
				height: 6,
...
const Tooltip = ({ children, content, title, placement, delay = 0, sideOffset = 0, showArrow = true, fullWidthTrigger = false, classNames, className, isDisabled, isOpen, onOpenChange, onClick, portalContainer }) => {
	const tooltipContent = content ?? title;
	const defaultPortalContainer = usePortalContainer();
	const triggerWrapperClassName = cn("relative z-10", fullWidthTrigger ? "block w-full min-w-0 max-w-full" : "inline-block", classNames?.placeholder);
	if (!tooltipContent || isDisabled) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		"data-ui": "ui.tooltip",
	...
	} else if (onOpenChange) controlledProps.onOpenChange = onOpenChange;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TooltipProvider, {
		delayDuration: delay,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Root3, {
			delayDuration: delay,
			...controlledProps,
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TooltipTrigger, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Content2, {
					...
					children: [tooltipContent, showArrow && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Arrow2, {
						width: 12,
						height: 6,
						className: arrowStyles
					})]
...
var NormalTooltip = ({ children, content, side, align, sideOffset, asChild = true, triggerProps, contentProps, showArrow = true, ...tooltipProps }) => {
...
export { Tooltip as n, NormalTooltip as t };
