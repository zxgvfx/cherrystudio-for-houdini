...
const assistants = {
	...
	"clear": {
		...
		"menu_title": "すべてのアシスタントとの会話を削除してください",
	...
	"settings": {
		...
		"regular_phrases": {
			"add": "フレーズを追加",
			"contentLabel": "コンテンツ",
			"contentPlaceholder": "フレーズの内容を入力してください。変数を使用することもでき、Tabキーを押すと変数を素早く見つけて修正できます。  \n例：  \n${from}から${to}までのルートを計画し、${email}に送信してください。",
			"delete": "フレーズを削除",
...
const file_preview = {
	"directory": {
		"description": "このフォルダ内のファイルを選択してプレビューしてください。",
		"title": "これはフォルダです"
	},
	"html": {
		"empty": {
	...
	"pdf": { "too_large": {
		"action": "デフォルトのアプリで開く",
		"description": "{{limit}} MiBを超えるPDFファイルはプレビューできません。",
...
const message = /* @__PURE__ */ JSON.parse("{\"agents\":{\"import\":{\"error\":\"インポートに失敗しました\"},\"imported\":\"インポートに成功しました\"},\"api\":{\"check\":{\"model\":{\"title\":\"検出に使用するモデルを選択してください\"}},\"connection\":{\"failed\":\"接続に失敗しました\",\"success\":\"接続に成功しました\"}},\"assistant\":{\"added\":{\"content\":\"助手が追加されました\"}},\"attachments\":{\"pasted_image\":\"クリップボード画像\",\"pasted_text\":\"クリップボードファイル\"},\"backup\":{\"cleanup_failed\":\"バックアップは完了しましたが、古いバックアップを削除できませんでした。\",\"failed\":\"バックアップに失敗しました\",\"start\":{\"success\":\"バックアップを開始しました\"},\"success\":\"バックアップに成功しました\"},\"branch\":{\"error\":\"分支作成に失敗しました\"},\"chat\":{\"completion\":{\"paused\":\"チャットの完了が一時停止されました\"}},\"citation\":\"{{count}}個の引用内容\",\"citation_source\":\"引用元 {{number}}\",\"citations\":\"引用内容\",\"conversation_reset\":\"以前の会話履歴が見つかりませんでした — 新しい会話を続行します\",\"copied\":\"コピーしました！\",\"copy\":{\"failed\":\"コピーに失敗しました\",\"success\":\"コピーしました！\"},\"delete\":{\"confirm\":{\"content\":\"選択した{{count}}件のメッセージを削除しますか？\",\"title\":\"削除確認\"},\"failed\":\"削除に失敗しました\",\"first_turn_not_supported\":\"最初のユーザーメッセージは削除できません。\",\"root_unavailable\":\"メッセージはまだ読み込み中で、まだ削除できません。\",\"success\":\"削除が成功しました\"},\"dialog\":{\"failed\":\"プレビューに失敗しました\"},\"download\":{\"failed\":\"ダウンロードに失敗しました\",\"success\":\"ダウンロードに成功しました\"},\"empty_url\":\"画像をダウンロードできません。プロンプトに不適切なコンテンツや禁止用語が含まれている可能性があります\",\"error\":{\"avatar_image_too_large\":\"画像が大きすぎます（最大 {{limit}}）\",\"chunk_overlap_too_large\":\"チャンクのオーバーラップがチャンクサイズより大きくなることはできません\",\"copy\":\"複製に失敗しました\",\"dimension_too_large\":\"内容のサイズが大きすぎます\",\"dismiss_failed\":\"エラーメッセージを閉じることができませんでした\",\"enter\":{\"api\":{\"host\":\"APIホストを入力してください\",\"label\":\"APIキーを入力してください\"},\"model\":\"モデルを選択してください\",\"name\":\"ナレッジベース名を入力してください\"},\"excel\":{\"export\":\"Excelのエクスポートに失敗しました\"},\"fetchTopicName\":\"トピック名の取得に失敗しました\",\"file\":{\"process_failed\":\"ファイル {{name}} を処理できませんでした\",\"text_extraction_failed\":\"{{name}}からテキストの抽出に失敗しました\"},\"get_embedding_dimensions\":\"埋込み次元を取得できませんでした\",\"image_process_failed\":\"画像の処理に失敗しました。もう一度お試しください。\",\"invalid\":{\"api\":{\"host\":\"無効なAPIアドレスです\",\"label\":\"無効なAPIキーです\"},\"enter\":{\"model\":\"モデルを選択してください\"},\"nutstore\":\"無効なNutstore設定です\",\"nutstore_token\":\"無効なNutstoreトークンです\",\"proxy\":{\"url\":\"無効なプロキシURL\"},\"webdav\":\"無効なWebDAV設定\"},\"joplin\":{\"export\":\"Joplin へのエクスポートに失敗しました。Joplin が実行中であることを確認してください\",\"no_config\":\"Joplin 認証トークン または URL が設定されていません\"},\"markdown\":{\"export\":{\"preconf\":\"Markdown ファイルを事前設定されたパスにエクスポートできませんでした\",\"specified\":\"Markdown ファイルのエクスポートに失敗しました\"}},\"notes\":{\"export\":\"ノートのエクスポートに失敗しました\"},\"notion\":{\"export\":\"Notionへのエクスポートに失敗しました。接続状態と設定を確認してください\",\"no_api_key\":\"Notion ApiKey または Notion DatabaseID が設定されていません\",\"no_content\":\"Notionにエクスポートできる内容がありません。\"},\"operation_unavailable\":\"メッセージ操作は利用できません。もう一度お試しください。\",\"siyuan\":{\"export\":\"思源ノートのエクスポートに失敗しました。接続状態を確認し、ドキュメントに従って設定を確認してください\",\"no_config\":\"思源ノートのAPIアドレスまたはトークンが設定されていません\"},\"table\":{\"invalid\":\"有効なテーブルデータを取得できません\"},\"unknown\":\"未知のエラー\",\"yuque\":{\"export\":\"語雀へのエクスポートに失敗しました。接続状態と設定を確認してください\",\"no_config\":\"語雀のAPIアドレスまたはトークンが設定されていません\"}},\"group\":{\"delete\":{\"content\":\"分組メッセージを削除するとユーザーの質問と助け手の回答がすべて削除されます\",\"title\":\"分組メッセージを削除\"},\"retry_failed\":\"エラーになったメッセージを再試行\"},\"ignore\":{\"knowledge\":{\"base\":\"インターネットモードが有効になっています。ナレッジベースを無視します\"}},\"loading\":{\"notion\":{\"exporting_progress\":\"Notionにエクスポート中 ...\",\"preparing\":\"Notionへのエクスポートを準備中...\"}},\"mention\":{\"title\":\"モデルを切り替える\"},\"message\":{\"code_style\":\"コードスタイル\",\"compact\":{\"title\":\"会話圧縮\"},\"delete\":{\"content\":\"このメッセージを削除してもよろしいですか？\",\"title\":\"メッセージを削除\"},\"multi_model_style\":{\"fold\":{\"compress\":\"緊湊配置に切り替える\",\"expand\":\"展開配置に切り替える\",\"label\":\"タブ表示\"},\"grid\":\"カード表示\",\"horizontal\":\"横並び\",\"label\":\"複数モデル回答スタイル\",\"vertical\":\"縦積み\"},\"style\":{\"bubble\":\"バブル\",\"label\":\"メッセージスタイル\",\"plain\":\"プレーン\"},\"user_content\":{\"collapse\":\"折りたたむ\",\"expand\":\"拡大\"},\"video\":{\"error\":{\"local_file_missing\":\"ローカル動画ファイルのパスが見つかりません\",\"unsupported_type\":\"サポートされていない動画タイプです\",\"youtube_url_missing\":\"YouTube動画のURLが見つかりません\"}}},\"processing\":\"処理中...\",\"regenerate\":{\"confirm\":\"再生成すると現在のメッセージが置き換えられます\"},\"restore\":{\"failed\":\"復元に失敗しました\",\"success\":\"復元に成功しました\"},\"save\":{\"success\":{\"title\":\"保存に成功しました\"}},\"searching\":\"検索中...\",\"success\":{\"excel\":{\"export\":\"Excelのエクスポートが正常に完了しました\"},\"joplin\":{\"export\":\"Joplin へのエクスポートに成功しました\"},\"markdown\":{\"export\":{\"preconf\":\"Markdown ファイルを事前設定されたパスに正常にエクスポートしました\",\"specified\":\"Markdown ファイルを正常にエクスポートしました\"}},\"notes\":{\"export\":\"成功的にノートにエクスポートされました\"},\"notion\":{\"export\":\"Notionへのエクスポートに成功しました\"},\"siyuan\":{\"export\":\"思源ノートへのエクスポートに成功しました\"},\"yuque\":{\"export\":\"語雀へのエクスポートに成功しました\"}},\"switch\":{\"disabled\":\"現在の応答が完了するまで切り替えを無効にします\"},\"tools\":{\"abort_failed\":\"ツール呼び出し中断失敗\",\"aborted\":\"ツール呼び出し中断\",\"activity\":{\"analyze\":\"分析\",\"analyzing\":\"分析\",\"archive\":\"アーカイブ\",\"assistantTask\":\"タスク\",\"availableFeatures\":\"利用可能な機能\",\"availableResources\":\"利用可能なリソース\",\"branch\":\"コードブランチ\",\"build\":\"ビルド\",\"building\":\"建築\",\"calendar\":\"カレンダー\",\"check\":\"確認\",\"checking\":\"確認中\",\"codeFiles\":\"コードファイル\",\"codeHostInfo\":\"コードホスティング情報\",\"configFiles\":\"プロジェクトのドキュメントと設定ファイル\",\"copy\":\"コピー\",\"copying\":\"コピー\",\"create\":\"作成\",\"creating\":\"作成\",\"currentFolder\":\"現在のフォルダ\",\"data\":\"データ\",\"delete\":\"削除\",\"deleting\":\"削除\",\"documentFiles\":\"ドキュメントファイル\",\"download\":\"ダウンロード\",\"downloading\":\"ダウンロード中\",\"email\":\"メール\",\"environmentInfo\":\"環境情報\",\"executeCommand\":\"コマンドを実行\",\"executingCommand\":\"コマンドを実行中\",\"extensionFailed\":\"拡張機能が失敗しました\",\"extract\":\"抽出\",\"extracting\":\"抽出\",\"file\":\"ファイル\",\"fileList\":\"ファイルリスト\",\"folder\":\"フォルダ\",\"handle\":\"扱う\",\"handling\":\"取り扱い\",\"imageFiles\":\"画像ファイル\",\"install\":\"インストール\",\"installing\":\"インストール中\",\"matchingFiles\":\"一致するファイル\",\"modify\":\"変更\",\"modifying\":\"修正\",\"move\":\"移動\",\"moving\":\"移動\",\"open\":\"開く\",\"opening\":\"オープニング\",\"plan\":\"実行計画\",\"projectChanges\":\"プロジェクトの変更\",\"projectChecks\":\"プロジェクトチェック\",\"projectDependencies\":\"プロジェクトの依存関係\",\"projectFiles\":\"プロジェクトファイル\",\"projectRootFiles\":\"プロジェクトルートファイル\",\"projectTask\":\"プロジェクトタスク\",\"relatedContent\":\"関連コンテンツ\",\"repository\":\"コードリポジトリ\",\"search\":\"見つける\",\"searching\":\"見つける\",\"send\":\"送信\",\"sending\":\"送信\",\"start\":\"開始\",\"starting\":\"開始\",\"switch\":\"スイッチ\",\"switching\":\"切り替え\",\"sync\":\"同期\",\"syncing\":\"同期中\",\"taskId\":\"タスク{{id}}\",\"taskList\":\"タスクリスト\",\"translationFiles\":\"翻訳ファイル\",\"upload\":\"アップロード\",\"uploading\":\"アップロード中\",\"usedExtension\":\"拡張機能を使用しました\",\"usingExtension\":\"拡張機能を使用する\",\"view\":\"表示\",\"viewing\":\"閲覧\",\"webPage\":\"ウェブページ\",\"webSearch\":\"ウェブコンテンツ\",\"workspace\":\"ワークスペース\",\"write\":\"保存\",\"writing\":\"保存\"},\"agent_background\":\"バックグラウンドで実行中\",\"approvalRequired\":\"ツール「{{tool}}」は承認が必要です\",\"autoApproveEnabled\":\"このツールは自動承認が有効になっています\",\"cancelled\":\"キャンセル\",\"collapse\":\"折りたたむ\",\"completed\":\"完了\",\"error\":\"エラーが発生しました\",\"groupHeader\":\"{{count}}ツール呼び出し\",\"invoking\":\"呼び出し中\",\"labels\":{\"bash\":\"バッシュ\",\"edit\":\"編集\",\"exitPlanMode\":\"ExitPlanMode\",\"glob\":\"グローブ\",\"grep\":\"グレップ\",\"mcpServerTool\":\"MCPサーバーツール\",\"multiEdit\":\"マルチエディット\",\"notebookEdit\":\"ノートブック編集\",\"readFile\":\"ファイルを読む\",\"search\":\"検索\",\"skill\":\"スキル\",\"task\":\"タスク\",\"taskCreate\":\"タスクを作成\",\"taskGet\":\"タスクを表示\",\"taskList\":\"タスクを一覧表示\",\"taskOutput\":\"タスク出力を表示\",\"taskStop\":\"タスクを停止\",\"taskUpdate\":\"タスクを更新\",\"todoWrite\":\"やること 書く\",\"tool\":\"ツール\",\"webFetch\":\"ウェブフェッチ\",\"webSearch\":\"ウェブ検索\",\"workflow\":\"ワークフロー\",\"write\":\"書く\"},\"noData\":\"このツールに利用可能なデータはありません\",\"pending\":\"保留中\",\"placeholder\":{\"elapsed\":{\"days\":\"{{days}}日 {{hours}}時間 {{minutes}}分 {{seconds}}秒\",\"hours\":\"{{hours}}時間{{minutes}}分{{seconds}}秒\",\"minutes\":\"{{minutes}}分{{seconds}}秒\",\"seconds\":\"{{seconds}}秒\"},\"generating\":\"回答を書く\",\"preparing\":\"応答を準備中\",\"thinking\":\"考える\",\"usingTools\":\"タスクに取り組んでいる\"},\"preview\":\"プレビュー\",\"processed\":\"処理済み\",\"raw\":\"生データ\",\"runningCount\":\"{{count}}個のツールが実行中\",\"runningHeader\":\"作業中…\",\"sections\":{\"args\":\"議論\",\"command\":\"コマンド\",\"content\":\"コンテンツ\",\"exitCode\":\"終了コード\",\"input\":\"入力\",\"output\":\"出力\",\"prompt\":\"プロンプト\",\"searchQuery\":\"検索クエリ\",\"searchResults\":\"検索結果\",\"stderr\":\"標準エラー出力\",\"stdout\":\"標準出力\"},\"status\":{\"done\":\"完了\",\"error\":\"エラー\",\"failed\":\"失敗\",\"running\":\"走っている\",\"success\":\"成功\"},\"streaming\":\"ストリーミング\",\"thinkingHeader\":\"考える\",\"truncated\":\"出力が切り捨てられました（元のサイズ: {{size}}）\",\"units\":{\"done_one\":\"{{count}} 完了\",\"done_other\":\"{{count}} 完了\",\"file_one\":\"{{count}} ファイル\",\"file_other\":\"{{count}}個のファイル\",\"item_one\":\"{{count}}個のアイテム\",\"item_other\":\"{{count}}件のアイテム\",\"line_one\":\"{{count}}行\",\"line_other\":\"{{count}}行\",\"plan_one\":\"{{count}} プラン\",\"plan_other\":\"{{count}}件のプラン\",\"result_one\":\"{{count}}件の結果\",\"result_other\":\"{{count}}件の結果\"},\"workflow\":{\"orchestrating\":\"ワークフローのオーケストレーション\",\"run_id\":\"実行ID\",\"script\":\"ワークフロースクリプト\",\"script_path\":\"スクリプトパス\",\"started\":\"ワークフローを開始しました\",\"summary\":\"要約\",\"workflow\":\"ワークフロー\"}},\"topic\":{\"added\":\"新しいトピックが追加されました\"},\"upgrade\":{\"success\":{\"button\":\"再起動\",\"content\":\"アップグレードを完了するためにアプリケーションを再起動してください\",\"title\":\"アップグレードに成功しました\"}},\"warn\":{\"export\":{\"exporting\":\"他のエクスポートが実行中です。前のエクスポートが完了するまでお待ちください。\"}},\"warning\":{\"file\":{\"pdf_exceeds_limit\":\"PDFファイル {{name}} はサイズ制限（{{limit}}）を超えているため、テキスト抽出にフォールバックします\",\"pdf_text_extraction_failed\":\"PDF「{{name}}」からテキストを抽出できませんでした\",\"pdf_upload_failed\":\"PDF「{{name}}」のアップロードに失敗しました。テキスト抽出にフォールバックします。\"},\"rate\":{\"limit\":\"送信が頻繁すぎます。{{seconds}} 秒待ってから再試行してください。\"}},\"websearch\":{\"cutoff\":\"検索内容を切り詰めています...\",\"fetch_complete\":\"{{count}}件の検索結果\",\"fetch_empty\":\"検索結果は見つかりませんでした\",\"partial_failure\":\"{{count}}件の検索結果、一部の検索に失敗しました\"}}");
const miniApp = {
...
const models = {
	...
	"multi_select": { "label": "マルチモデル並列（マルチアシスタントとは相互排他）" },
...
const notes = {
	...
	"target_name_exists": "この名前のノートまたはフォルダは既に存在します",
	"title": "ノート",
	"tree_load_failed": "ノートディレクトリの読み込みに失敗しました",
...
const openclaw = {
	...
	"node_missing": {
		"description": "OpenClawにはNode.js/npmが必要です。まずNode.jsをインストールしてから、Cherry Studioを再起動してください。",
...
const plugins = {
	...
	"showing_results_skills_one": "{{count}}件のスキルを表示",
...
const translate = {
	...
	"info": { "aborted": "翻訳中止" },
	"input": { "placeholder": "テキスト、テキストファイル、画像（OCR対応）を貼り付けたり、ドラッグして挿入したりできます" },
	"language": {
		"not_pair": "ソース言語が設定された言語と異なります",
		"same": "ソース言語と目標言語が同じです"
	},
	"language_settings": "言語設定",
	"menu": { "description": "對當前輸入框內容進行翻譯" },
...
const warning = { "missing_provider": "サプライヤーが存在しないため、デフォルトのサプライヤー {{provider}} にロールバックされました。これにより問題が発生する可能性があります。" };
const words = {
