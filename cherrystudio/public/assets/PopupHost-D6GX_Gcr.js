...
import { n as getCmThemeNames, t as getCmThemeByName } from "./utils-Bvfn4Suj.js";
...
import { c as loadThemeIfNeeded, i as getMarkdownIt, n as DEFAULT_THEMES, o as getShiki, r as getHighlighter, s as loadLanguageIfNeeded, t as DEFAULT_LANGUAGES } from "./shiki-pLteNJ2v.js";
...
import { r as popupService } from "./popup-BqV2ZD7D.js";
...
var ShikiStreamService = class {
	...
	async initWorker() {
		...
		this.workerInitPromise = (async () => {
			try {
				this.worker = new (await (__vitePreload(() => import("./shikiStream.worker-DlcERzHB.js"), [], import.meta.url))).default();
