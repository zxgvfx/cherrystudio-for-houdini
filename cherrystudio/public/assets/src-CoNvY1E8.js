import { n as __esmMin, o as __toCommonJS, r as __export, t as __commonJSMin } from "./rolldown-runtime-D8OvLAZx.js";
...
var require_logging = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	function makeConsoleLogger(name$1) {
		return (level, message, extraInfo) => {
			console[level](`${name$1} ${level}:`, message, extraInfo);
		};
	}
	...
	function logLevelSeverity(level) {
		switch (level) {
			...
			default: return (0, utils_1$2.assertNever)(level);
		}
	}
...
var require_errors = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var APIErrorCode;
	(function(APIErrorCode$1) {
		APIErrorCode$1["Unauthorized"] = "unauthorized";
		APIErrorCode$1["RestrictedResource"] = "restricted_resource";
		APIErrorCode$1["ObjectNotFound"] = "object_not_found";
		APIErrorCode$1["RateLimited"] = "rate_limited";
		APIErrorCode$1["InvalidJSON"] = "invalid_json";
		APIErrorCode$1["InvalidRequestURL"] = "invalid_request_url";
		APIErrorCode$1["InvalidRequest"] = "invalid_request";
		APIErrorCode$1["ValidationError"] = "validation_error";
		APIErrorCode$1["ConflictError"] = "conflict_error";
		APIErrorCode$1["InternalServerError"] = "internal_server_error";
		APIErrorCode$1["ServiceUnavailable"] = "service_unavailable";
	})(APIErrorCode = exports.APIErrorCode || (exports.APIErrorCode = {}));
	var ClientErrorCode;
	(function(ClientErrorCode$1) {
		ClientErrorCode$1["RequestTimeout"] = "notionhq_client_request_timeout";
		ClientErrorCode$1["ResponseError"] = "notionhq_client_response_error";
	})(ClientErrorCode = exports.ClientErrorCode || (exports.ClientErrorCode = {}));
	var NotionClientErrorBase = class extends Error {};
	function isNotionClientError(error) {
		return (0, utils_1$1.isObject)(error) && error instanceof NotionClientErrorBase;
	}
	exports.isNotionClientError = isNotionClientError;
	function isNotionClientErrorWithCode(error, codes) {
		return isNotionClientError(error) && error.code in codes;
	}
	exports.RequestTimeoutError = class RequestTimeoutError extends NotionClientErrorBase {
		...
		static isRequestTimeoutError(error) {
			return isNotionClientErrorWithCode(error, { [ClientErrorCode.RequestTimeout]: true });
		}
	...
	var UnknownHTTPResponseError = class extends HTTPResponseError {
		...
		static isUnknownHTTPResponseError(error) {
			return isNotionClientErrorWithCode(error, { [ClientErrorCode.ResponseError]: true });
		}
	};
	...
	function buildRequestError(response, bodyText) {
		...
		if (apiErrorResponseBody !== void 0) return new APIResponseError({
	...
	function parseAPIErrorResponseBody(body) {
		...
		if (!(0, utils_1$1.isObject)(parsed) || typeof parsed["message"] !== "string" || !isAPIErrorCode(parsed["code"])) return;
		return {
			...parsed,
			code: parsed["code"],
...
var require_api_endpoints = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
var package_exports = /* @__PURE__ */ __export({
	...
	types: () => types,
	version: () => version
}, 1), name, version, description, engines, homepage, bugs, repository, keywords, main, types, scripts, files, dependencies, devDependencies, package_default;
var init_package = __esmMin((() => {
	...
	bugs = { "url": "https://github.com/makenotion/notion-sdk-js/issues" };
	repository = {
		"type": "git",
	...
	files = ["build/package.json", "build/src/**"];
	dependencies = {
...
var require_Client = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var Client = class Client {
		constructor(options) {
			...
			__classPrivateFieldSet(this, _Client_logLevel, (_a = options === null || options === void 0 ? void 0 : options.logLevel) !== null && _a !== void 0 ? _a : logging_1$1.LogLevel.WARN, "f");
			__classPrivateFieldSet(this, _Client_logger, (_b = options === null || options === void 0 ? void 0 : options.logger) !== null && _b !== void 0 ? _b : (0, logging_1$1.makeConsoleLogger)(package_json_1.name), "f");
		...
		async request({ path, method, query, body, auth }) {
			this.log(logging_1$1.LogLevel.INFO, "request start", {
				method,
				path
			});
			...
			if (query) {
				for (const [key, value] of Object.entries(query)) if (value !== void 0) if (Array.isArray(value)) value.forEach((val) => url.searchParams.append(key, decodeURIComponent(val)));
				else url.searchParams.append(key, String(value));
			}
			let authorizationHeader;
			if (typeof auth === "object") {
				const unencodedCredential = `${auth.client_id}:${auth.client_secret}`;
				authorizationHeader = { authorization: `Basic ${Buffer.from(unencodedCredential).toString("base64")}` };
			} else authorizationHeader = this.authAsHeaders(auth);
			const headers = {
				...authorizationHeader,
				"Notion-Version": __classPrivateFieldGet(this, _Client_notionVersion, "f"),
				"user-agent": __classPrivateFieldGet(this, _Client_userAgent, "f")
			};
			if (bodyAsJsonString !== void 0) headers["content-type"] = "application/json";
			try {
				const response = await errors_1$1.RequestTimeoutError.rejectAfterTimeout(__classPrivateFieldGet(this, _Client_fetch, "f").call(this, url.toString(), {
				...
				if (!response.ok) throw (0, errors_1$1.buildRequestError)(response, responseText);
				const responseJson = JSON.parse(responseText);
				this.log(logging_1$1.LogLevel.INFO, "request success", {
					method,
					path
				});
				return responseJson;
			} catch (error) {
				if (!(0, errors_1$1.isNotionClientError)(error)) throw error;
				this.log(logging_1$1.LogLevel.WARN, "request fail", {
					code: error.code,
					message: error.message
				});
				if ((0, errors_1$1.isHTTPResponseError)(error)) this.log(logging_1$1.LogLevel.DEBUG, "failed response body", { body: error.body });
				throw error;
			}
		}
		log(level, message, extraInfo) {
			if ((0, logging_1$1.logLevelSeverity)(level) >= (0, logging_1$1.logLevelSeverity)(__classPrivateFieldGet(this, _Client_logLevel, "f"))) __classPrivateFieldGet(this, _Client_logger, "f").call(this, level, message, extraInfo);
		}
		authAsHeaders(auth) {
			const headers = {};
			const authHeaderValue = auth !== null && auth !== void 0 ? auth : __classPrivateFieldGet(this, _Client_auth, "f");
			if (authHeaderValue !== void 0) headers["authorization"] = `Bearer ${authHeaderValue}`;
			return headers;
		}
	};
...
var require_helpers = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	function isFullPageOrDatabase(response) {
		if (response.object === "database") return isFullDatabase(response);
		else return isFullPage(response);
	}
