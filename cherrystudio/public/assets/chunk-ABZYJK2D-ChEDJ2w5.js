const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./katex-CqqX73oQ.js","./katex-Cpd4UQ-s.js"])))=>i.map(i=>d[i]);
import { t as __vitePreload } from "./preload-helper-0g9Mvw_b.js";
import { t as purify } from "./purify.es-CuN2L7KX.js";
import { i as setLogLevel, n as __name, r as log, t as __export } from "./src-6zIEfxP7.js";
var Channel = {
	min: {
		r: 0,
		g: 0,
...
var renderKatexUnsanitized = /* @__PURE__ */ __name(async (text, config2) => {
	...
	if (!(isMathMLSupported() || config2.legacyMathML || config2.forceLegacyMathML)) return text.replace(katexRegex, "MathML is unsupported in this environment.");
	{
		const { default: katex } = await __vitePreload(async () => {
			const { default: katex$1 } = await import("./katex-CqqX73oQ.js");
