...
import { b as LanguageSelect_default, c as AntdProvider_default, d as require_lib } from "./LanguageSelect-Bez7-PAj.js";
import { b as require_jsx_runtime, ck as LoadingOutlined_default, d as init_es, eT as defaultLanguage, eu as i18n_default, ew as useTranslation, f0 as loggerService, f1 as IpcChannel } from "./jsx-runtime-DlGOqAJz.js";
import { ak as fetchChatCompletion, aq as ConversationService, b4 as getAssistantMessage, b7 as getUserMessage, c as persistor, cB as MessageContent_default, cY as getToastUtilities, cj as useTranslate, cm as detectLanguage, d as store_default, d$ as useTopicMessages, d0 as useHotkeys, dW as useTimer, dq as CodeStyleProvider, dx as ThemeProvider, eY as cancelThrottledBlockUpdate, f1 as throttledBlockUpdate, fE as pauseTrace, fO as useSettings, fd as newMessagesActions, fv as abortCompletion, g9 as formatErrorMessage, gO as getAssistantById, gP as getDefaultAssistant, gQ as getDefaultModel, gR as getDefaultTopic, gS as getDefaultTranslateAssistant, ge as isAbortError, gg as ChunkType, go as updateOneBlock, gp as upsertManyBlocks, gq as upsertOneBlock, jD as databases_default, jF as createErrorBlock, jG as createMainTextBlock, jI as createThinkingBlock, jK as require_lodash, jL as AssistantMessageStatus, jM as MessageBlockStatus, jq as isMac, jr as isWin, js as StoreSyncService_default, jt as Provider_default, kh as LanguagesEnum, ki as UNKNOWN } from "./store-COlONLDu.js";
...
import { $ as tooltip_default, V as dropdown_default, am as button_default, bA as ft, bz as dt, x as RefreshIcon_default } from "./ImageViewer-DCAHR-Ja.js";
import "./dist-DQWoXkv5.js";
import "./index-browser-CUxx6q5E.js";
import "./stylis-CZpjP453.js";
import "./Component-BRnxiPoI.js";
import "./createLucideIcon-BDzeED0C.js";
import { b as ArrowRight } from "./arrow-right-DUgg5qf3.js";
...
import { b as ChevronDown } from "./chevron-down-6JXQvE1F.js";
...
import { b as CircleQuestionMark } from "./circle-question-mark-ptzEdT1P.js";
import { b as CircleX } from "./circle-x-ChDqhDgG.js";
...
import { b as Droplet } from "./droplet-BIb38ofL.js";
...
import { b as Minus } from "./minus-DS2dIzxg.js";
import "./notebook-pen-CoCCW7j1.js";
import "./paperclip-C01ZkzDT.js";
import { b as Pause } from "./pause-DHxmoKuM.js";
import "./pencil-ruler-DTWfYUuc.js";
import "./pencil-C9t2AjFK.js";
import { b as Pin } from "./pin-q2KeNa0i.js";
...
import { b as Settings2 } from "./settings-2-CT4svHwZ.js";
...
import { b as X } from "./x-CbXiXQHi.js";
import "./zoom-in-BqkYBFcy.js";
import "./zoom-out-BuPEMPXg.js";
import "./es-DiAG0IsS.js";
import { b as CopyButton_default, c as slider_default } from "./CopyButton-BQ5b6fNY.js";
...
import { b as require_client } from "./client-C5yfYL0w.js";
import { b as PersistGate } from "./react-BMIRhHyB.js";
import "./en_US-U-tbdjPg.js";
import { b as DynamicIcon, d as useSelectionAssistant } from "./DynamicIcon-CFFOVBBY.js";
...
`;
const LoadingIconWrapper = dt.div`
  display: flex;
  align-items: center;
  justify-content: center;
  position: relative;
...
const ActionGeneral = import_react.memo(({ action, scrollToBottom }) => {
	const { t } = useTranslation();
...
`;
const OriginalContent$1 = dt.div`
  padding: 8px;
  margin-top: 8px;
  margin-bottom: 12px;
  ...
  width: 100%;
`;
const OriginalContentCopyWrapper$1 = dt.div`
  display: flex;
  justify-content: flex-end;
`;
const FooterPadding$1 = dt.div`
  min-height: 12px;
`;
const ErrorMsg$1 = dt.div`
  color: var(--color-error);
...
const OriginalContent = dt.div`
  ...
  width: 100%;
`;
const OriginalContentCopyWrapper = dt.div`
  display: flex;
  justify-content: flex-end;
`;
const FooterPadding = dt.div`
  min-height: 12px;
`;
const ErrorMsg = dt.div`
  color: var(--color-error);
  background: rgba(255, 0, 0, 0.15);
  border: 1px solid var(--color-error);
  padding: 8px 12px;
...
const LeftGroup = dt.div`
  ...
  min-width: 0;
`;
const DetectedLanguageTag = dt.div`
  display: flex;
  align-items: center;
  padding: 4px 8px;
  background-color: var(--color-background-soft);
...
const SettingsMenuItem = dt.div`
  ...
  cursor: default;
`;
const SettingsLabel = dt.span`
  font-size: 12px;
  color: var(--color-text-secondary);
`;
const HelpIcon = dt(CircleQuestionMark)`
  cursor: pointer;
  color: var(--color-text-3);
  flex-shrink: 0;
`;
const SettingsDropdownStyles = ft`
...
`;
const TitleBarIcon = dt.div`
  display: flex;
  align-items: center;
  justify-content: center;
  margin-left: 4px;
`;
const TitleBarCaption = dt.div`
  margin-left: 8px;
  font-size: 14px;
  font-weight: 400;
  flex: 1;
...
`;
const WinButton = dt(button_default)`
  display: flex;
  align-items: center;
  justify-content: center;
  width: 24px;
