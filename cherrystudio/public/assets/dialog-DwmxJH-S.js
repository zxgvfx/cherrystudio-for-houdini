...
function DialogContent({ className, children, closeOnOverlayClick = true, showCloseButton = true, motion = "directional", overlayClassName, onPointerDown, size = "default", ref, ...props }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogPortal, {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogClose$1, {
			...
			className: cn("bg-card text-card-foreground fixed top-[50%] left-[50%] z-[80] grid w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-3xl border-0 p-6 shadow-xl [-webkit-app-region:no-drag]", "data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-99 data-[state=open]:animation-duration-[260ms] data-[state=open]:ease-[cubic-bezier(0.16,1,0.3,1)]", "data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-99 data-[state=closed]:animation-duration-[200ms] data-[state=closed]:ease-[cubic-bezier(0.4,0,1,1)]", motion === "directional" && "data-[state=open]:slide-in-from-bottom-4 data-[state=closed]:slide-out-to-bottom-4", "fill-mode-both motion-reduce:animate-none", dialogContentSizeClass[size], className),
			onPointerDown: composeEventHandlers(onPointerDown, (event) => event.stopPropagation(), { checkForDefaultPrevented: false }),
