...
import { _ as createContextScope, a as useControllableState, c as useId, f as useCallbackRef, h as createSlot, i as usePortalContainer, l as useLayoutEffect2, o as Presence, p as Primitive, s as Portal, u as DismissableLayer, v as useComposedRefs, y as composeEventHandlers } from "./portal-container-Cc9NoOZQ.js";
import { a as createPopperScope, i as Root2, n as Arrow, r as Content, t as Anchor } from "./dist-Cc8kG5V_.js";
import { n as VISUALLY_HIDDEN_STYLES } from "./dist-DG2FHWbq.js";
import { t as cva } from "./dist-D9lByzdX.js";
import { a as FocusScope, i as useFocusGuards, n as Combination_default, t as hideOthers } from "./es2015-wfS3L7va.js";
import { n as createCollection, t as useDirection } from "./dist-C1S2CN6c.js";
...
var SelectContext = import_react.createContext(null);
function assignRef(ref, value) {
	if (typeof ref === "function") ref(value);
	else if (ref) ref.current = value;
}
var selectTriggerVariants = cva(cn("inline-flex items-center justify-between rounded-md border-1 text-sm transition-colors outline-none font-normal", "bg-transparent dark:bg-input/30", "text-foreground"), {
	variants: {
		state: {
...
function Select({ defaultOpen, onOpenChange, open: openProp, ...props }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectContext, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Select$1, {
			"data-slot": "select",
			open,
			onOpenChange: setOpen,
			...props
...
function SelectGroup({ ...props }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectGroup$1, {
		"data-ui": "part:select-group",
		"data-slot": "select-group",
		...mergeUiProps(props, "part:select-group")
	});
}
function SelectValue({ ...props }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectValue$1, {
		"data-ui": "part:select-value",
		"data-slot": "select-value",
		...mergeUiProps(props, "part:select-value")
	});
}
function SelectTrigger({ className, size = "default", children, ref, ...props }) {
	const selectContext = import_react.use(SelectContext);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SelectTrigger$1, {
		...
		className: cn(selectTriggerVariants({
			state,
			size
		}), "data-[placeholder]:text-muted-foreground [&_svg:not([class*='text-'])]:text-muted-foreground w-fit whitespace-nowrap *:data-[slot=select-value]:line-clamp-1 *:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center *:data-[slot=select-value]:gap-2 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4", className),
		...mergeUiProps(props, "part:select-trigger"),
		children: [children, /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectIcon, {
			asChild: true,
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(UiDataSlot, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDown, { className: "size-4 opacity-50" }) })
		})]
	});
}
function SelectContent({ className, children, position = "popper", align = "center", portalContainer, ref, ...props }) {
	const defaultPortalContainer = usePortalContainer();
	const selectContext = import_react.use(SelectContext);
	const resolvedPortalContainer = portalContainer ?? defaultPortalContainer ?? void 0;
	const handleRef = import_react.useCallback((node) => {
	...
	import_react.useEffect(() => {
		...
		const keepPortalContainerInteractive = () => {
			if (portalElement.style.pointerEvents !== "auto") portalElement.style.setProperty("pointer-events", "auto", "important");
		};
		...
		pointerEventsObserver.observe(portalElement, {
			attributes: true,
			attributeFilter: ["style"]
		});
		const closeForInsidePortalPointerDown = (event) => {
		...
		return () => {
			...
			if (portalElement.style.pointerEvents === "auto") portalElement.style.removeProperty("pointer-events");
			if (previousPointerEvents && previousPointerEvents !== "none") portalElement.style.setProperty("pointer-events", previousPointerEvents, previousPointerEventsPriority);
		};
...
function SelectLabel({ className, ...props }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectLabel$1, {
		...
		...mergeUiProps(props, "part:select-label")
	});
}
function SelectItem({ className, children, ...props }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SelectItem$1, {
		...
		className: cn("focus:bg-accent focus:text-accent-foreground data-[state=checked]:bg-primary/10 data-[state=checked]:text-primary [&_svg:not([class*='text-'])]:text-muted-foreground relative flex w-full cursor-default items-center gap-2 rounded-sm py-1.5 pr-8 pl-2 text-sm outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2", className),
		...mergeUiProps(props, "part:select-item"),
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			className: "absolute right-2 flex size-3.5 items-center justify-center",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItemIndicator, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, { className: "size-4 text-primary" }) })
...
function SelectSeparator({ className, ...props }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectSeparator$1, {
		...
		...mergeUiProps(props, "part:select-separator")
	});
}
function SelectScrollUpButton({ className, ...props }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectScrollUpButton$1, {
		...
		...mergeUiProps(props, "part:select-scroll-up-button"),
...
function SelectScrollDownButton({ className, ...props }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectScrollDownButton$1, {
		"data-ui": "part:select-scroll-down-button",
		"data-slot": "select-scroll-down-button",
		className: cn("flex cursor-default items-center justify-center py-1", className),
		...mergeUiProps(props, "part:select-scroll-down-button"),
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDown, { className: "size-4" })
	});
}
export { SelectLabel as a, SelectValue as c, SelectItem as i, ChevronUp as l, SelectContent as n, SelectSeparator as o, SelectGroup as r, SelectTrigger as s, Select as t };
