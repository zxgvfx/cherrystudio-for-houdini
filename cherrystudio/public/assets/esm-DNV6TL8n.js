...
import { t as _extends } from "./extends-CWTzyNP3.js";
...
var defaultSettingsAbyss = {
	background: config$12.background,
	foreground: config$12.foreground,
	caret: config$12.cursor,
	selection: config$12.selection,
	selectionMatch: config$12.selectionMatch,
	gutterBackground: config$12.background,
	gutterForeground: config$12.foreground,
	lineHighlight: config$12.activeLine
};
var abyssDarkStyle = [
	{
		tag: tags.keyword,
		color: config$12.keyword
	},
	{
		tag: [
			tags.name,
		...
		color: config$12.variable
	},
	{
		tag: [tags.propertyName],
		color: config$12.function
	},
	{
		tag: [
	...
	},
	{
		...
		color: config$12.number
	},
	{
		tag: [tags.typeName],
		color: config$12.type,
		fontStyle: config$12.type
	},
	{
	...
	},
	{
		...
		color: config$12.regexp
	},
	{
		tag: [tags.meta, tags.comment],
		color: config$12.comment
	},
	{
		tag: tags.tagName,
		color: config$12.tag
...
var defaultSettingsAndromeda = {
	background: config$11.background,
	foreground: config$11.foreground,
	caret: config$11.cursor,
	selection: config$11.selection,
	selectionMatch: config$11.selectionMatch,
	gutterBackground: config$11.background,
	gutterForeground: config$11.foreground,
	lineHighlight: config$11.activeLine
};
var andromedaDarkStyle = [
	{
		tag: tags.keyword,
		color: config$11.keyword
	},
	{
		tag: [
			tags.name,
		...
		color: config$11.variable
	},
	{
		tag: [tags.propertyName],
		color: config$11.function
	},
	{
		tag: [
			tags.processingInstruction,
	...
	},
	{
		...
		color: config$11.number
	},
	{
		tag: [tags.typeName],
		color: config$11.type,
		fontStyle: config$11.type
	},
	{
		tag: [tags.operator],
		color: config$11.keyword
	},
	{
		...
		color: config$11.regexp
	},
	{
		tag: [tags.meta, tags.comment],
		color: config$11.comment
	},
	{
		tag: tags.tagName,
		color: config$11.tag
...
var defaultSettingsCopilot = {
	background: config$10.background,
	foreground: config$10.foreground,
	caret: config$10.cursor,
	selection: config$10.selection,
	selectionMatch: config$10.selectionMatch,
	gutterBackground: config$10.background,
	gutterForeground: config$10.foreground,
	lineHighlight: config$10.activeLine
};
var copilotDarkStyle = [
	{
		tag: tags.keyword,
		color: config$10.keyword
	},
	{
		tag: [
			tags.name,
		...
		color: config$10.variable
	},
	{
		tag: [tags.propertyName],
		color: config$10.function
	},
	{
		tag: [
			tags.processingInstruction,
	...
	},
	{
		...
		color: config$10.number
	},
	{
		tag: [tags.typeName],
		color: config$10.type,
		fontStyle: config$10.type
	},
	{
		tag: [tags.operator],
		color: config$10.keyword
	},
	{
		...
		color: config$10.regexp
	},
	{
		tag: [tags.meta, tags.comment],
		color: config$10.comment
	},
	{
		tag: tags.tagName,
		color: config$10.tag
...
var defaultSettingsKimbie = {
	...
	selectionMatch: config$9.selection,
...
var defaultSettingsMonokaiDimmed = {
	...
	selectionMatch: config$7.selection,
...
var defaultSettingsQuietlight = {
	...
	selectionMatch: config$6.selection,
...
var defaultSettingsSolarizedLight = {
	...
	selectionMatch: config$3.selectionMatch,
...
export { abcdef, abcdefDarkStyle, abcdefInit, abyss, abyssDarkStyle, abyssInit, androidstudio, androidstudioDarkStyle, androidstudioInit, andromeda, andromedaDarkStyle, andromedaInit, atomone, atomoneDarkStyle, atomoneInit, aura, auraDarkStyle, auraInit, basicDark, basicDarkInit, basicDarkStyle, basicLight, basicLightInit, basicLightStyle, bbedit, bbeditInit, bbeditLightStyle, bespin, bespinDarkStyle, bespinInit, consoleDark, consoleDarkInit, consoleLight, consoleLightInit, copilot, copilotDarkStyle, copilotInit, darcula, darculaDarkStyle, darculaInit, defaultSettingsAbcdef, defaultSettingsAbyss, defaultSettingsAndroidstudio, defaultSettingsAndromeda, defaultSettingsAtomone, defaultSettingsAura, defaultSettingsBasicDark, defaultSettingsBasicLight, defaultSettingsBbedit, defaultSettingsBespin, defaultSettingsConsoleDark, defaultSettingsConsoleLight, defaultSettingsCopilot, defaultSettingsDarcula, defaultSettingsDracula, defaultSettingsDuotoneDark, defaultSettingsDuotoneLight, defaultSettingsEclipse, defaultSettingsGithubDark, defaultSettingsGithubLight, defaultSettingsGruvboxDark, defaultSettingsGruvboxLight, defaultSettingsKimbie, defaultSettingsMaterial, defaultSettingsMaterialDark, defaultSettingsMaterialLight, defaultSettingsMonokai, defaultSettingsMonokaiDimmed, defaultSettingsNoctisLilac, defaultSettingsNord, defaultSettingsOkaidia, defaultSettingsQuietlight, defaultSettingsRed, defaultSettingsSolarizedDark, defaultSettingsSolarizedLight, defaultSettingsSublime, defaultSettingsTokyoNight, defaultSettingsTokyoNightDay, defaultSettingsTokyoNightStorm, defaultSettingsTomorrowNightBlue, defaultSettingsVscodeDark, defaultSettingsVscodeLight, defaultSettingsWhiteDark, defaultSettingsWhiteLight, defaultSettingsXcodeDark, defaultSettingsXcodeLight, douToneLightStyle, dracula, draculaDarkStyle, draculaInit, duotoneDark, duotoneDarkInit, duotoneDarkStyle, duotoneLight, duotoneLightInit, eclipse, eclipseInit, eclipseLightStyle, githubDark, githubDarkInit, githubDarkStyle, githubLight, githubLightInit, githubLightStyle, gruvboxDark, gruvboxDarkInit, gruvboxDarkStyle, gruvboxLight, gruvboxLightInit, kimbie, kimbieDarkStyle, kimbieInit, material, materialDark, materialDarkInit, materialDarkStyle, materialInit, materialLight, materialLightInit, materialLightStyle, monokai, monokaiDarkStyle, monokaiDimmed, monokaiDimmedDarkStyle, monokaiDimmedInit, monokaiInit, noctisLilac, noctisLilacInit, noctisLilacLightStyle, nord, nordDarkStyle, nordInit, okaidia, okaidiaDarkStyle, okaidiaInit, quietlight, quietlightInit, quietlightStyle, red, redDarkStyle, redInit, solarizedDark, solarizedDarkInit, solarizedDarkStyle, solarizedLight, solarizedLightInit, solarizedLightStyle, sublime, sublimeDarkStyle, sublimeInit, tokyoNight, tokyoNightDay, tokyoNightDayInit, tokyoNightDayStyle, tokyoNightInit, tokyoNightStorm, tokyoNightStormInit, tokyoNightStormStyle, tokyoNightStyle, tomorrowNightBlue, tomorrowNightBlueInit, tomorrowNightBlueStyle, vscodeDark, vscodeDarkInit, vscodeDarkStyle, vscodeLight, vscodeLightInit, vscodeLightStyle, whiteDark, whiteDarkInit, whiteDarkStyle, whiteLight, whiteLightInit, whiteLightStyle, xcodeDark, xcodeDarkInit, xcodeDarkStyle, xcodeLight, xcodeLightInit, xcodeLightStyle };
