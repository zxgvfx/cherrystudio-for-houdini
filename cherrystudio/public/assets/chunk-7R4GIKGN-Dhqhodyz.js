...
import { i as setLogLevel, n as __name, r as log, t as __export } from "./src-BxTmfvcS.js";
...
var renderKatexUnsanitized = /* @__PURE__ */ __name(async (text, config2) => {
	...
	if (!(isMathMLSupported() || config2.legacyMathML || config2.forceLegacyMathML)) return text.replace(katexRegex, "MathML is unsupported in this environment.");
	{
		const { default: katex } = await __vitePreload(async () => {
			const { default: katex$1 } = await import("./katex-BBSUApw8.js");
...
export { adjust_channel_default as $, lineBreakRegex as A, setAccDescription as B, getDiagramTitle as C, getUrl as D, getThemeVariables3 as E, reset as F, setSiteConfig as G, setConfig as H, sanitizeDirective as I, styles_default as J, setupGraphViewbox as K, sanitizeText as L, registerDiagram as M, registerLazyLoadedDiagrams as N, getUserDefinedConfig as O, renderKatexSanitized as P, lighten_default as Q, sanitizeText3 as R, getDiagramLoader as S, getSiteConfig as T, setConfig2 as U, setAccTitle as V, setDiagramTitle as W, updateSiteConfig as X, themes_default as Y, darken_default as Z, getAccDescription as _, clear as a, getConfig2 as b, configureSvgSize as c, defaultConfig_default as d, is_dark_default as et, detectType as f, frontMatterRegex as g, evaluate as h, calculateMathMLDimensions as i, parseGenericTypes as j, hasKatex as k, defaultConfig as l, directiveRegex as m, addDirective as n, color_default as nt, commonDb_exports as o, detectors as p, setupGraphViewbox2 as q, assignWithDepth_default as r, utils_default as rt, common_default as s, UnknownDiagramError as t, rgba_default as tt, defaultConfig2 as u, getAccTitle as v, getEffectiveHtmlLabels as w, getDiagram as x, getConfig as y, saveConfigFromInitialize as z };
