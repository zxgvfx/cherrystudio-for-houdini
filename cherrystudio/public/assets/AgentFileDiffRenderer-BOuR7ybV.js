...
import { c as createHighlighter, d as createOnigurumaEngine, h as bundledLanguages, p as bundledThemes, t as createJavaScriptRegexEngine } from "./dist-D8jgvmz-.js";
...
async function getSharedHighlighter({ themes, langs, preferredHighlighter = "shiki-js" }) {
	highlighter ??= createHighlighter({
		themes: [],
		langs: ["text"],
		engine: preferredHighlighter === "shiki-wasm" ? createOnigurumaEngine(__vitePreload(() => import("./wasm-ntXv2ALE.js"), [], import.meta.url)) : createJavaScriptRegexEngine()
	});
...
registerCustomTheme("pierre-dark", async () => {
	const m = await __vitePreload(() => import("./pierre-dark-DvuTnxUp.js"), [], import.meta.url);
	return {
		...m.default ?? m,
		name: "pierre-dark"
	};
...
registerCustomTheme("pierre-light", async () => {
	const m = await __vitePreload(() => import("./pierre-light-CyM3W-Ss.js"), [], import.meta.url);
	return {
		...m.default ?? m,
		name: "pierre-light"
	};
