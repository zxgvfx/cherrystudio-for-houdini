...
import { r as initReactI18next, t as useTranslation } from "./useTranslation-DnuRkr5k.js";
...
import { i as success, n as error } from "./toast-DfLEw4mF.js";
...
import { a as DialogFooter, c as DialogTrigger, i as DialogDescription, n as DialogClose, o as DialogHeader, r as DialogContent, s as DialogTitle, t as Dialog } from "./dialog-9s9VTSCz.js";
...
import { t as Shield } from "./shield-CSiVMfZ6.js";
...
import { t as clampSurrogateBoundary } from "./text-C_TJ7HOJ.js";
...
var import_dexie_min = /* @__PURE__ */ __toESM((/* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(e, t) {
		...
		function H(t$1, n$1) {
			return null == t$1 || t$1 === X$1 ? n$1 : function(e$1) {
				return n$1(t$1(e$1));
			};
		}
		function J(e$1, t$1) {
		...
		function an(n$1, r$1, i$1, e$1) {
			...
			Ne(function() {
				return me.trans = a$1, me.transless = s$1, 0 !== r$1 ? (tn(n$1, i$1), t$1 = r$1, ((e$2 = a$1).storeNames.includes("$meta") ? e$2.table("$meta").get("version").then(function(e$3) {
					...
					return c$1 = e$3, l$1 = a$1, f$1 = i$1, t$2 = [], e$3 = (s$2 = n$1)._versions, h$1 = s$2._dbSchema = hn(0, s$2.idbdb, f$1), 0 !== (e$3 = e$3.filter(function(e$4) {
						...
						t$2.push(function() {
							...
							n$2.add.forEach(function(e$5) {
								cn$1(f$1, e$5[0], e$5[1].primKey, e$5[1].indexes);
					...
					cn$1(i$1, e$3, o$1[e$3].primKey, o$1[e$3].indexes);
		...
		function ln(t$1, n$1) {
			O(t$1).forEach(function(e$1) {
				n$1.db.objectStoreNames.contains(e$1) || (ie && console.debug("Dexie: Creating missing table", e$1), cn$1(n$1, e$1, t$1[e$1].primKey, t$1[e$1].indexes));
			});
		}
		function fn(e$1, t$1) {
...
var DexieExporter = class {
	...
	async writeExportText(tableName, jsonText, writeMode) {
		let offset = 0;
		let nextWriteMode = writeMode;
		while (offset < jsonText.length) {
			const end = clampSurrogateBoundary(jsonText, Math.min(offset + DEXIE_EXPORT_CHUNK_CHAR_LIMIT, jsonText.length));
			await window.electron.ipcRenderer.invoke(MigrationIpcChannels.WriteExportFile, this.exportPath, tableName, jsonText.slice(offset, end), nextWriteMode);
			offset = end;
	...
	async exportTable(db, tableName) {
		...
		while (true) {
			...
			for (let index = 0; index < primaryKeys.length; index++) {
				...
				if (serializedRecord === void 0) throw this.createRecordExportError(tableName, primaryKey, /* @__PURE__ */ new Error("Record is not JSON serializable"));
				...
				if (entry.length > DEXIE_EXPORT_CHUNK_CHAR_LIMIT) await this.writeExportText(tableName, entry, "append");
				else pendingChunk += entry;
				hasRecords = true;
			}
			lastPrimaryKey = primaryKeys[primaryKeys.length - 1];
		}
		if (pendingChunk) await this.writeExportText(tableName, pendingChunk, "append");
...
var LocalStorageExporter = class {
	...
	async export() {
		...
		await window.electron.ipcRenderer.invoke("migration:write-export-file", this.exportPath, "localStorage", JSON.stringify(records));
...
var ReduxExporter = class {
	export() {
		...
		try {
			...
			throw new Error(`Failed to parse Redux Persist root data: ${error$1}`);
		}
		const result = {};
		const slicesFound = [];
		const slicesMissing = [];
		...
		if (persistedState._persist) try {
...
var MigrationApp = () => {
	...
	const runMigration = async () => {
		...
		try {
			...
			const reduxResult = new ReduxExporter().export();
			logger.info("Redux data exported", {
				slicesFound: reduxResult.slicesFound,
				slicesMissing: reduxResult.slicesMissing
			});
			const exportBasePath = `${await window.electron.ipcRenderer.invoke(MigrationIpcChannels.GetUserDataPath)}/migration_temp`;
			const dexieExportPath = `${exportBasePath}/dexie_export`;
			await new DexieExporter(dexieExportPath).exportAll((p) => {
				logger.info("Dexie export progress", p);
			});
			logger.info("Dexie data exported", { exportPath: dexieExportPath });
			const localStorageExporter = new LocalStorageExporter(`${exportBasePath}/localstorage_export`);
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TopContent, { children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								...
								children: t("migration.completed.description")
							})
						] }),
						...
						warnings.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Dialog, {
