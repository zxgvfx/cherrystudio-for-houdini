...
import { n as PopoverAnchor, r as PopoverContent, t as Popover } from "./popover-Cli1Z35D.js";
import { C as pointer_default, S as nopropagation, T as dispatch_default, _ as nodrag_default, b as nonpassive, i as zoom_default$1, n as identity$1, r as transform, t as zoom_default, v as yesdrag, w as select_default, x as nonpassivecapture, y as noevent_default } from "./src-BkCZtMji.js";
import { t as value_default } from "./value-BVeQD9vL.js";
...
import { s as toMessageListItem } from "./messageListItem-DqE378fB.js";
...
import { n as sharedMessageToUIMessage, r as uiMessagesToPartsMap } from "./messageProjection-BWf8l1I6.js";
import { i as EmptyState, r as LoadingState } from "./topicMessageFlowLiveTree-JsskjjfN.js";
...
function formatNodeTime(createdAt) {
	const value = (0, import_dayjs_min.default)(createdAt);
...
function useStatusLabel(status, isAwaitingInput) {
	const { t } = useTranslation();
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Popover, {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PopoverAnchor, {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(UiDataSlot, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: cn("group/topic-message-flow-node relative w-55 rounded-md border bg-card px-3 py-2 shadow-xs transition-[border-color,box-shadow,opacity]", roleClassNames[data.role], data.isContextBoundary && "border-border bg-muted/45", data.isAwaitingInput && "border-warning-border bg-warning-subtle", data.isActive && (data.isAwaitingInput ? "shadow-sm ring-2 ring-warning/25" : "border-primary shadow-sm ring-2 ring-primary/20"), selected$1 && !data.isActive && (data.isAwaitingInput ? "ring-2 ring-warning/25" : "ring-2 ring-primary/25"), data.isInactiveBranch && "opacity-55"),
				"data-active": data.isActive ? "true" : "false",
				"data-message-id": data.messageId,
				"data-on-active-path": data.isOnActivePath ? "true" : "false",
				onMouseEnter: previewEnabled ? scheduleOpen : void 0,
				onMouseLeave: previewEnabled ? scheduleClose : void 0,
				onMouseMove: previewEnabled ? scheduleOpen : void 0,
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							className: "flex min-w-0 items-center gap-1.5",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: cn("size-1.5 shrink-0 rounded-full", data.isAwaitingInput ? "bg-warning" : statusDotClassNames[data.status]) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "truncate",
			...
			side: "right",
			sideOffset: 10,
			children: open && !data.isAwaitingInput && !data.isContextBoundary ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TopicMessageFlowNodePreviewCard, {
...
function toNodeData(node, activeNodeId, activePath, hasActivePath) {
	const data = {
		messageId: node.id,
		role: node.role,
...
export { z as a, BaseEdge as c, MiniMap as d, index as f, getBezierPath as g, SelectionMode as h, he as i, EdgeLabelRenderer as l, Position as m, TopicMessageFlowCanvas_default as n, Background as o, MarkerType as p, layoutTopicMessageFlowGraph as r, BackgroundVariant as s, buildTopicMessageFlowGraph as t, Handle as u };
