...
import { b as LanguageSelect_default } from "./LanguageSelect-Bez7-PAj.js";
import { aH as ArrowLeftOutlined_default, aT as SwapOutlined_default, ag as EnterOutlined_default, b as require_jsx_runtime, ck as LoadingOutlined_default, cu as CloseOutlined_default, d as init_es, eT as defaultLanguage, eu as i18n_default, ew as useTranslation, f0 as loggerService, f1 as IpcChannel } from "./jsx-runtime-DlGOqAJz.js";
import { aN as ModelAvatar_default, ak as fetchChatCompletion, aq as ConversationService, as as replacePromptVariables, b4 as getAssistantMessage, b7 as getUserMessage, c0 as MessageErrorBoundary_default, cB as MessageContent_default, cj as useTranslate, cu as translateText, d as store_default, d$ as useTopicMessages, d0 as useHotkeys, dW as useTimer, dy as useTheme, e1 as Scrollbar_default, e4 as typography_default, e6 as tag_default, eO as select_default, eY as cancelThrottledBlockUpdate, eh as input_default, ep as divider_default, er as col_default$1, f as useAppSelector, f1 as throttledBlockUpdate, fO as useSettings, fV as useAssistant, fY as useDefaultModel, fd as newMessagesActions, fe as selectMessagesForTopic, fv as abortCompletion, gR as getDefaultTopic, ge as isAbortError, gg as ChunkType, gm as getMainTextContent, go as updateOneBlock, gp as upsertManyBlocks, gq as upsertOneBlock, ip as runAsyncFunction, is as classNames, jD as databases_default, jG as createMainTextBlock, jI as createThinkingBlock, jK as require_lodash, jL as AssistantMessageStatus, jM as MessageBlockStatus, jO as ThemeMode, jq as isMac, kh as LanguagesEnum } from "./store-COlONLDu.js";
import { b as require_react } from "./react-4-AZLvKD.js";
import { $ as tooltip_default, H as CopyIcon_default, bz as dt } from "./ImageViewer-DCAHR-Ja.js";
import { b as CircleArrowLeft } from "./circle-arrow-left-CVAnPOEc.js";
import { b as Copy } from "./copy-B9rCRaBN.js";
import { b as FileText } from "./file-text-BQPWuXTn.js";
import { b as Languages } from "./languages--rgPICt4.js";
import { b as Lightbulb } from "./lightbulb-Cfzuoke0.js";
import { b as MessageSquare } from "./message-square-ITIr4uiM.js";
...
function ErrorBoundaryWrapper(props) {
	...
	const fallbackRender = rest.fallbackRender || rest.FallbackComponent || fallbackComponent || (({ error }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		style: { padding: "20px" },
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: "Something went wrong" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("pre", { children: error?.message })]
	}));
...
`;
const MessageContentContainer = dt.div`
  max-width: 100%;
  display: flex;
  flex: 1;
  flex-direction: column;
...
const Container$3 = dt(Scrollbar_default)`
  display: flex;
...
const Main$2 = dt(Scrollbar_default)`
  width: 100%;
  display: flex;
  flex-direction: row;
...
const Main$1 = dt.div`
  ...
  overflow: hidden;
`;
const ResultText = dt.div`
  white-space: pre-wrap;
  word-break: break-word;
  width: 100%;
`;
const LoadingText = dt.div`
...
const MenuContainer = dt.div`
  ...
  gap: 20px;
`;
const OutputContainer = dt(Scrollbar_default)`
  display: flex;
  flex-direction: column;
  flex: 1;
  gap: 10px;
...
const FeatureList = dt(Scrollbar_default)`
  flex-shrink: 0;
  height: auto;
  -webkit-app-region: none;
`;
const FeatureListWrapper = dt.div`
  display: flex;
  flex-direction: column;
  gap: 5px;
  cursor: pointer;
`;
const FeatureItem = dt.div`
  display: flex;
  flex-direction: row;
  cursor: pointer;
...
const FooterText = dt.div`
  ...
  font-size: 12px;
`;
const PinButtonArea = dt.div`
  cursor: pointer;
  display: flex;
  align-items: center;
  margin-right: 5px;
`;
const Tag = dt(tag_default)`
  cursor: pointer;
  display: flex;
  align-items: center;
  gap: 5px;
...
export { HomeWindow_default as b, ErrorBoundaryWrapper as c, col_default as d };
