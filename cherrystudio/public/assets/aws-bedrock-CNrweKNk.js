...
var AwsBedrockLight = (props) => {
	const iconId = (0, import_react.useId)();
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
		"data-ui": "ui.aws-bedrock-light",
		xmlns: "http://www.w3.org/2000/svg",
		width: "1em",
		height: "1em",
		fill: "none",
		viewBox: "0 0 120 120",
		...mergeUiProps(props, "ui.aws-bedrock-light"),
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
				fill: `url(#${iconId}-awsbedrocklight__a)`,
				d: "M0 0H120V120H0z"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
				fill: "#fff",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("defs", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("linearGradient", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("stop", { stopColor: "#055F4E" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("stop", {
					offset: 1,
					stopColor: "#56C0A7"
				})]
			}) })
...
function AwsBedrockAvatar({ size = 32, shape = "circle", className }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Avatar, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AvatarFallback, {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AwsBedrockLight, { style: {
				width: size,
				height: size
			} })
		})
...
var AwsBedrock = ({ variant, className, ...props }) => {
	if (variant === "light") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AwsBedrockLight, {
		...props,
		className
	});
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AwsBedrockLight, {
		...props,
		className
	});
};
const AwsBedrockIcon = /* @__PURE__ */ Object.assign(AwsBedrock, {
	Avatar: AwsBedrockAvatar,
	colorPrimary: "#000000"
});
export { AwsBedrockIcon as t };
