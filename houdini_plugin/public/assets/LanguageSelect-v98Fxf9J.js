...
import { c_ as init_es$2, d3 as generate, d5 as init_es$1, d6 as FastColor, dh as init_es, dk as getComputedToken, dq as createTheme, ei as require_react_dom } from "./es-C7gg5F5w.js";
import { bV as useTranslate, cr as ToastProvider, dg as useTheme, dq as $ea8dcbcb9ea1b556$export$323e4fc2fa4753fb, dx as $18f2051aff69b9bf$export$a54013f0d02a8f82, dy as ProviderContext, f9 as select_default, fS as useSettings, kH as UNKNOWN } from "./store-Cu6DN42A.js";
import { b as require_react } from "./react-Cs7_W7Sm.js";
import { b as require_jsx_runtime } from "./jsx-runtime-VX_aOJrC.js";
import { S as space_default, aR as config_provider_default, b1 as useToken, b2 as formatToken, ba as DesignTokenContext, bb as defaultConfig, bc as theme_default$1, bd as derivative, be as genFontMapToken_default, bf as genControlHeight_default, bg as genColorMapToken, bh as defaultPresetColors, bi as seed_default } from "./ImageViewer-C62pMHpu.js";
import { ah as MotionConfig, d7 as MotionGlobalConfig } from "./es-BokE909h.js";
import { b as require_en_US$1, f as require_common, g as require_objectSpread2, k as require_interopRequireDefault } from "./en_US-BG3puM0i.js";
...
require_react_dom();
const $f57aed4a881a3485$var$Context = /* @__PURE__ */ import_react.createContext(null);
function $f57aed4a881a3485$export$178405afcd8c5eb(props) {
	...
	return /* @__PURE__ */ import_react.createElement($f57aed4a881a3485$var$Context.Provider, { value: context }, children);
}
function $f57aed4a881a3485$export$d9aaed4c3ece1bc0() {
	let context = (0, import_react.useContext)($f57aed4a881a3485$var$Context);
	return { modalProviderProps: { "aria-hidden": context && context.modalCount > 0 ? true : void 0 } };
}
...
function $f57aed4a881a3485$export$bf688221f59024e5(props) {
	return /* @__PURE__ */ import_react.createElement($f57aed4a881a3485$export$178405afcd8c5eb, null, /* @__PURE__ */ import_react.createElement($f57aed4a881a3485$var$OverlayContainerDOM, props));
}
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime(), 1);
var HeroUIProvider = ({ children, navigate, disableAnimation, useHref, disableRipple = false, skipFramerMotionAnimations = disableAnimation, reducedMotion = "never", validationBehavior, locale: locale$32 = "en-US", labelPlacement, defaultDates, createCalendar, spinnerVariant,...otherProps }) => {
	let contents = children;
	if (navigate) contents = /* @__PURE__ */ (0, import_jsx_runtime.jsx)($ea8dcbcb9ea1b556$export$323e4fc2fa4753fb, {
		navigate,
		useHref,
		children: contents
	});
	const context = (0, import_react.useMemo)(() => {
		if (disableAnimation && skipFramerMotionAnimations) MotionGlobalConfig.skipAnimations = true;
		return {
			createCalendar,
			defaultDates,
			disableAnimation,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ProviderContext, {
		value: context,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)($18f2051aff69b9bf$export$a54013f0d02a8f82, {
			locale: locale$32,
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MotionConfig, {
				reducedMotion,
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)($f57aed4a881a3485$export$bf688221f59024e5, {
					...otherProps,
					children: contents
				})
			})
...
const ToastPortal = () => {
	...
	return /* @__PURE__ */ (0, import_react_dom.createPortal)(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ToastProvider, {
		placement: "top-center",
		regionProps: { className: "z-[1001]" },
		toastOffset: 20,
		toastProps: {
			timeout: 3e3,
			classNames: { base: "hero-toast" }
		}
	}), document.body);
};
...
const AppHeroUIProvider = ({ children }) => {
	const { language } = useSettings();
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeroUIProvider, {
...
export { LanguageSelect_default as b, AppHeroUIProvider as c, AntdProvider_default as d, ToastPortal as e, require_lib as f };
