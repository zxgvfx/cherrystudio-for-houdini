import { A as string, B as tuple, C as union, D as unknown, f as _enum, k as array, l as boolean, n as discriminatedUnion, r as literal, s as looseObject, u as number, v as object, y as record } from "./schemas-DwHFUYcd.js";
import { e as APICallError, m as NoSuchModelError, p as UnsupportedFunctionalityError } from "./types-1baJBz3q.js";
import { b as combineHeaders, c as convertToBase64, d as createEventSourceResponseHandler, e as createJsonErrorResponseHandler, f as createJsonResponseHandler, g as createProviderDefinedToolFactory, h as createProviderDefinedToolFactoryWithOutputSchema, i as generateId, j as getRuntimeEnvironmentUserAgent, k as lazySchema, l as loadOptionalSetting, m as loadSetting, n as parseProviderOptions, o as postJsonToApi, p as resolve, q as validateTypes, r as withUserAgentSuffix, s as withoutTrailingSlash, t as zodSchema } from "./dist-BJcRJPGu.js";
							...
							case "web_search_tool_result": {
								...
								if (Array.isArray(part.content)) {
									...
									for (const result of part.content) controller.enqueue({
										...
										url: result.url,
										title: result.title,
										providerMetadata: { anthropic: { pageAge: (_a2 = result.page_age) != null ? _a2 : null } }
									});
