...
import { n as AntdProvider_default, r as require_lib, t as LanguageSelect_default } from "./LanguageSelect-CZ6Tj4PS.js";
import { Gr as LoadingOutlined_default, Ho as defaultLanguage, Xo as loggerService, Zo as IpcChannel, go as i18n_default, n as init_es, vo as useTranslation } from "./es-CRkf9ice.js";
import { Bs as formatErrorMessage, Dr as detectLanguage, Ei as useHotkeys, Gs as isAbortError, Ha as useTimer, Hf as isWin, Hp as LanguagesEnum, Jc as getDefaultAssistant, Js as ERROR_I18N_KEY_REQUEST_TIMEOUT, Ks as isTimeoutError, Si as getToastUtilities, Uf as StoreSyncService_default, Uo as abortCompletion, Up as UNKNOWN, Vf as isMac, Vr as MessageContent_default, Wf as Provider_default, Xc as getDefaultTopic, Xs as ChunkType, Yc as getDefaultModel, Ys as ERROR_I18N_KEY_STREAM_PAUSED, Za as cancelThrottledBlockUpdate, Zc as getDefaultTranslateAssistant, ac as updateOneBlock, ap as createThinkingBlock, cp as AssistantMessageStatus, ds as pauseTrace, ep as databases_default, fa as CodeStyleProvider, fc as useSettings, in as getUserMessage, lp as MessageBlockStatus, n as store_default, np as createErrorBlock, oc as upsertManyBlocks, pt as ConversationService, qa as useTopicMessages, qc as getAssistantById, ro as throttledBlockUpdate, rp as createMainTextBlock, sc as upsertOneBlock, sp as require_lodash, st as fetchChatCompletion, t as persistor, tn as getAssistantMessage, wo as newMessagesActions, wr as useTranslate, ya as ThemeProvider } from "./store-DxDhJR5y.js";
import "./dayjs.min-A7WN91xd.js";
import { t as require_react } from "./react-1FqkuScD.js";
import "./stylis-BaN_JEhW.js";
import { Ut as button_default, bt as tooltip_default, k as RefreshIcon_default, mt as dropdown_default } from "./ImageViewer-CM8D5DNp.js";
...
import { t as Minus } from "./minus-DUI7oRxk.js";
import { t as Pause } from "./pause-CIkoAZT6.js";
import { t as Pin } from "./pin-Bye6ICwE.js";
import { t as Settings2 } from "./settings-2-BM_t6zyl.js";
import { t as X } from "./x-Df-WjPD4.js";
import "./es-BG8KyI9M.js";
import { n as slider_default, t as CopyButton_default } from "./CopyButton-BEV4cQfK.js";
import { n as dt, r as ft } from "./styled-components.browser.esm-BcmQ0ilM.js";
...
import { r as useSelectionAssistant, t as DynamicIcon } from "./DynamicIcon-2qwl9MEU.js";
