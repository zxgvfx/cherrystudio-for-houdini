...
var OpenclawLight = (props) => {
	const iconId = (0, import_react.useId)();
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
		"data-ui": "ui.openclaw-light",
		xmlns: "http://www.w3.org/2000/svg",
		width: "1em",
		height: "1em",
		fill: "none",
		viewBox: "0 0 120 120",
		...mergeUiProps(props, "ui.openclaw-light"),
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("defs", { children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("linearGradient", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("stop", { stopColor: "#FF4D4D" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("stop", {
						offset: 1,
						stopColor: "#991B1B"
					})]
				}),
...
function OpenclawAvatar({ size = 32, shape = "circle", className }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Avatar, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AvatarFallback, {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(OpenclawLight, { style: {
				width: size,
				height: size
			} })
		})
...
var Openclaw = ({ variant, className, ...props }) => {
	if (variant === "light") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(OpenclawLight, {
		...props,
		className
	});
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(OpenclawLight, {
		...props,
		className
	});
};
const OpenclawIcon = /* @__PURE__ */ Object.assign(Openclaw, {
	Avatar: OpenclawAvatar,
	colorPrimary: "#FF4D4D"
});
export { OpenCode as n, OpenclawIcon as t };
