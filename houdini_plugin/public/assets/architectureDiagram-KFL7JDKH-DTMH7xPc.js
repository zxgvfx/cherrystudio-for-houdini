...
import { e as cleanAndMerge } from "./chunk-U37J5Y7L-UQ_9cfTv.js";
...
import { F as log, M as sanitizeText, P as setAccDescription, Q as setAccTitle, T as setDiagramTitle, W as setupGraphViewbox, d as __name, h as clear, n as defaultConfig_default, t as getAccDescription, u as getAccTitle, v as getConfig, w as getConfig2, z as getDiagramTitle } from "./src-XfX5FL_o.js";
import "./dist-B4A8UMUm.js";
import "./math-Cgxj31JI.js";
import { c as createText, d as getIconSVG, e as registerIconPacks, g as unknownIcon } from "./chunk-62K37W7T-Cdcrszm7.js";
import { b as populateCommonDb } from "./chunk-ANTBXLJU-Ccro7VNp.js";
import { b as selectSvgElement } from "./chunk-T57MJCP2-9fLskutD.js";
import { b as parse } from "./mermaid-parser.core-DqG-sqpm.js";
import { b as cytoscape$1 } from "./cytoscape.esm-3Dk1YEXv.js";
		...
		return (function(modules) {
			...
			(function(module$1, exports$1, __webpack_require__) {
				...
				var Quicksort = function() {
					function Quicksort$1(A, compareFunction) {
						_classCallCheck(this, Quicksort$1);
			...
			(function(module$1, exports$1, __webpack_require__) {
				...
				SVD.svd = function(A) {
					...
					this.U = function(dims) {
						var allocate = function allocate$1(dims$1) {
							if (dims$1.length == 0) return 0;
							else {
								var array = [];
								for (var i$1 = 0; i$1 < dims$1[0]; i$1++) array.push(allocate$1(dims$1.slice(1)));
								return array;
							}
						};
			...
			(function(module$1, exports$1, __webpack_require__) {
				...
				var NeedlemanWunsch = function() {
					function NeedlemanWunsch$1(sequence1, sequence2) {
						...
						_classCallCheck(this, NeedlemanWunsch$1);
					...
					_createClass(NeedlemanWunsch$1, [
						{
							key: "getScore",
					...
					return NeedlemanWunsch$1;
				}();
				module$1.exports = NeedlemanWunsch;
			}),
			(function(module$1, exports$1, __webpack_require__) {
			...
			var __webpack_modules__ = {
				...
				548: ((module$1, __unused_webpack_exports, __webpack_require__$1) => {
					...
					auxiliary.getTopMostNodes = function(nodes) {
						...
						var roots = nodes.filter(function(ele, i$1) {
				...
				816: ((module$1, __unused_webpack_exports, __webpack_require__$1) => {
					...
					var coseLayout = function coseLayout$1(options, spectralResult) {
						var cy = options.cy;
						...
						var coseLayout$2 = new CoSELayout();
						var gm = coseLayout$2.newGraphManager();
						processChildrenList(gm.addRoot(), aux.getTopMostNodes(nodes), coseLayout$2, options);
						processEdges(coseLayout$2, gm, edges);
						processConstraints(coseLayout$2, options);
						coseLayout$2.runLayout();
						return idToLNode;
					};
					module$1.exports = { coseLayout };
				}),
				212: ((module$1, __unused_webpack_exports, __webpack_require__$1) => {
					...
					var aux = __webpack_require__$1(548);
					var _require = __webpack_require__$1(657), spectralLayout = _require.spectralLayout;
					var _require2 = __webpack_require__$1(816), coseLayout = _require2.coseLayout;
					...
					var Layout$1 = function() {
						function Layout$2(options) {
							_classCallCheck(this, Layout$2);
							this.options = assign({}, defaults, options);
						}
						_createClass(Layout$2, [{
							key: "run",
							value: function run() {
								var layout = this;
				...
				657: ((module$1, __unused_webpack_exports, __webpack_require__$1) => {
					...
					var spectralLayout = function spectralLayout$1(options) {
						var cy = options.cy;
						var eles = options.eles;
						var nodes = eles.nodes();
					...
					module$1.exports = { spectralLayout };
				}),
...
var drawGroups = /* @__PURE__ */ __name(async function(groupsEl, cy, db) {
	const padding = db.getConfigField("padding");
	const groupIconSize = padding * .75;
	...
	return new Promise((resolve) => {
		...
		const layout = cy.layout({
			...
			idealEdgeLength(edge) {
				...
				const elasticity = parentA === parentB ? 1.5 * db.getConfigField("iconSize") : .5 * db.getConfigField("iconSize");
				return elasticity;
			},
			edgeElasticity(edge) {
				const [nodeA, nodeB] = edge.connectedNodes();
				const { parent: parentA } = nodeData(nodeA);
				const { parent: parentB } = nodeData(nodeB);
				const elasticity = parentA === parentB ? .45 : .001;
				return elasticity;
			},
			alignmentConstraint,
