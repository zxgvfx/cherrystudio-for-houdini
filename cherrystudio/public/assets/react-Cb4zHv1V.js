...
import { n as CustomVideoElement, t as MediaTracksMixin } from "./dist-BeZH5-Tg.js";
...
var DashVideoElement = class extends MediaTracksMixin(CustomVideoElement) {
	...
	async load() {
		...
		this.#apiInit = true;
		const Dash = await __vitePreload(() => import("./dash.all.min-BJSONIkE.js"), [], import.meta.url);
