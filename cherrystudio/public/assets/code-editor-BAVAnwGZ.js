const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./dist-BNRh_Col.js","./dist-BrOmixoC.js","./dist-CoUlMpOM.js","./dist-BfDuE-iA.js","./dist-CImN5vEq.js","./dist-Ca8pV2Fc.js","./dist-Cgr45N1G.js","./esm-Df0gSTcp.js","./dist-CjXsAxTw.js"])))=>i.map(i=>d[i]);
...
import { i as prepareCodeChanges, r as getNormalizedExtension } from "./utils-Bvfn4Suj.js";
var import_react = /* @__PURE__ */ __toESM(require_react());
var linterLoaders = { json: async () => {
	return linter((await __vitePreload(() => import("./dist-BNRh_Col.js"), __vite__mapDeps([0,1,2]), import.meta.url).then((mod) => mod.jsonParseLinter))());
} };
var specialLanguageLoaders = {
	dot: async () => {
		return (await __vitePreload(() => import("./dist-BfDuE-iA.js"), __vite__mapDeps([3,2,4,5]), import.meta.url)).dot();
	},
	mmd: async () => {
		return (await __vitePreload(() => import("./dist-Cgr45N1G.js"), __vite__mapDeps([6,2,4]), import.meta.url)).mermaid();
	}
};
async function loadLanguageExtension(language, languageConfig) {
	...
	try {
		const { loadLanguage } = await __vitePreload(async () => {
			const { loadLanguage: loadLanguage$1 } = await import("./esm-Df0gSTcp.js");
