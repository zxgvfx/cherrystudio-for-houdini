const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./dist-Bm7hkjM1.js","./dist-Cu7DuZHc.js","./lib-6TKYmTQn.js","./chunk-DiqNceaa.js","./zwitch-B7UdpQMH.js","./dist-D8jgvmz-.js","./preload-helper-BAxOQgJR.js","./markdown-it-DdkQP2_D.js","./markdown-it-zV3ZRsvC.js"])))=>i.map(i=>d[i]);
import { t as loggerService } from "./LoggerService-oVV4iwe6.js";
import { t as __vitePreload } from "./preload-helper-BAxOQgJR.js";
import { h as getTokenStyleObject } from "./dist-Cu7DuZHc.js";
...
var shikiInitializer = new AsyncInitializer(async () => {
	return await __vitePreload(() => import("./dist-Bm7hkjM1.js"), __vite__mapDeps([0,1,2,3,4,5,6]), import.meta.url);
});
...
var mdInitializer = new AsyncInitializer(async () => {
	return (await __vitePreload(() => import("./markdown-it-DdkQP2_D.js"), __vite__mapDeps([7,8,3]), import.meta.url)).default;
});
async function getMarkdownIt(theme, markdown) {
	...
	const { fromHighlighter } = await __vitePreload(async () => {
		const { fromHighlighter: fromHighlighter$1 } = await import("./core-B_9XaqQF.js");
