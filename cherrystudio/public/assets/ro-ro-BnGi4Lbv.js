...
const assistants = {
	...
	"clear": {
		...
		"menu_title": "Șterge toate conversațiile cu asistentul",
	...
	"presets": {
		...
		"manage": {
			"batch_delete": {
				"button": "Șterge",
				"confirm": "Ești sigur că vrei să ștergi cei {{count}} asistenți selectați?"
			},
	...
	"settings": {
		...
		"regular_phrases": {
			...
			"contentPlaceholder": "Te rugăm să introduci conținutul expresiei, suportă folosirea variabilelor și apasă Tab pentru a localiza rapid variabila de modificat. De exemplu:\nAjută-mă să planific un traseu de la ${from} la ${to} și trimite-l la ${email}.",
...
const backup = {
	...
	"error": { "active_data_writers": "O conversație sau un agent este încă în execuție. Așteptați să se termine, apoi încercați din nou." },
	"progress": {
...
const code = {
	...
	"adv": {
		"claude": {
			...
			"disable_terminal_title": "Dezactivați Titlul Terminalului",
			"effort_level_hint": "Nivel de efort",
			"enable_teammates": "Activați Colegii de Echipă",
			...
			"model_roles_hint": "Suprascrie modelele utilizate pentru sarcinile secundare de fundal (de ex. compactare, titluri). Lăsați gol pentru a urma modelul principal.",
			"options": "Opțiuni rapide",
			"opus_model": "Opus",
			"permissions_allow": "Permiteți (separate prin virgulă)",
		...
		"codex": {
			...
			"remote_compaction": "Activați compactarea la distanță"
		},
		"gemini": {
			"checkpointing": "Activarea punctelor de control",
			"disable_usage_stats": "Dezactivați statisticile de utilizare",
	...
	"cli_config": {
		"format_failed": "Formatarea a eșuat. Verificați sintaxa fișierului.",
	...
	"collapse": "Prăbușire",
	"config_json_hint": "Lipiți sau editați JSON brut; rămâne sincronizat cu câmpurile de mai sus",
	"configure": "Configurare",
	"configuring_provider": "Configurați {{provider}}",
	"count_one": "{{count}} element",
	"count_other": "{{count}} articole",
	...
	"format_json": "Format",
	"hero_tagline": "Alegeți un instrument CLI pentru configurare",
	"install": "Instalează",
	...
	"model": "Model",
	"model_hint": "Alegeți ce model AI să folosească instrumentul CLI",
	"model_hint_config": "Selectați modelul de utilizat",
	"model_mode": {
		"common": "General",
		"detailed": "Detaliat"
	},
	...
	"no_providers_description": "Activați un furnizor acceptat în Setări → Serviciu Model",
	...
	"providerless_hint": "Acest instrument se autentifică prin propriul flux de conectare — alegeți pur și simplu un director de lucru și lansați-l. Rulați instrumentul o dată pentru a vă conecta.",
	"providers": "Furnizori",
	"raw_config": "Config brut (JSON)",
	"search_provider_placeholder": "Furnizori de căutare…",
	"select_folder": "Selectează dosarul",
	"select_provider_before_launch": "Selectați un furnizor înainte de a lansa {{toolName}}",
	"select_tool_to_start": "Selectați un instrument CLI din stânga pentru a începe configurarea",
...
const common = {
	...
	"group": {
		...
		"name_placeholder": "Introduceți numele grupului...",
...
const error = {
	...
	"diagnosis": {
		...
		"auth": "Cheie API invalidă, verificați și reconfigurați",
		"content": "Conținut blocat de sistemul de securitate, modificați și reîncercați",
		...
		"mcp": "Conexiunea la serverul MCP a eșuat, verificați dacă serviciul rulează",
		"model": "Model negăsit sau fără acces",
		"model_conflict": "Modelul de diagnostic este identic cu modelul cu eroare",
		"network": "Nu se poate conecta la server, verificați setările de rețea sau proxy",
		"ocr": "Motorul OCR nu este inițializat, verificați setările OCR",
		"parse": "IA a returnat un răspuns invalid, vă rugăm să reîncercați sau să schimbați modelul",
		"payload": "Conținutul cererii este prea mare, reduceți dimensiunea fișierului sau a textului.",
		"proxy": "Eroare de proxy sau certificat SSL, verificați setările de proxy și de rețea",
		"quota": "Cota contului epuizată, reîncărcați sau schimbați furnizorul",
		"rate_limit": "Prea multe cereri într-un timp scurt. Așteptați un moment și încercați din nou, sau treceți la un model cu o limită de rată mai mare",
		"region": "Serviciu indisponibil în regiunea ta. Configurează un proxy sau treci la un furnizor disponibil în zona ta",
		"server": "Eroare de server, reîncercați mai târziu",
		"stream": "Răspuns întrerupt, verificați stabilitatea rețelei sau reîncercați",
	...
	"tool_call_limit_reached": "Asistentul a atins limita de apeluri la instrumente înainte de a produce un răspuns final. Încercați din nou sau reduceți domeniul sarcinii.",
	...
	"value": "Valoare",
	"values": "Valori",
	"web_lookup_network_error": "Accesul la web a eșuat. Verificați conexiunea la rețea și încercați din nou.",
	"web_search_api_host_invalid": "Căutarea web nu este disponibilă deoarece gazda API a furnizorului configurat este invalidă. Introduceți o adresă URL HTTP(S) validă în Setări → Căutare web, apoi încercați din nou.",
	"web_search_api_host_missing": "Căutarea pe web nu este disponibilă deoarece furnizorul configurat nu are un gazdă API. Adăugați unul în Setări → Căutare web, apoi încercați din nou.",
	"web_search_api_key_missing": "Căutarea web nu este disponibilă deoarece furnizorul configurat nu are o cheie API. Adăugați una în Setări → Căutare web, apoi încercați din nou.",
	"web_search_provider_unavailable": "Căutarea web nu este disponibilă deoarece nu este configurat niciun furnizor compatibil. Configurați unul în Setări → Căutare web, apoi încercați din nou."
};
const file_preview = {
	"directory": {
		"description": "Selectați un fișier din acest folder pentru a-l previzualiza.",
		"title": "Acesta este un dosar"
	},
	"html": {
		"empty": {
	...
	"pdf": { "too_large": {
		...
		"description": "Fișierele PDF mai mari de {{limit}} MiB nu pot fi previzualizate.",
...
const files = {
	...
	"document": "Document",
	"drag_upload": "Trageți fișierele aici pentru încărcare",
	"edit": "Editează",
	"empty": {
	...
	"rename": "Redenumește",
	"restore": "Restaurează",
	"select_all": "Selectați fișierele vizibile",
	...
	"show_in_folder": "Afișează în folder",
	"size": "Dimensiune",
	"text": "Text",
	"title": "Fișiere",
	"trash": "Gunoi",
...
const globalSearch = {
	...
	"quickApps": {
		...
		"manager_title": "Gestionați aplicațiile rapide",
		"reset": "Resetare",
		"save_failed": "Nu s-au putut salva aplicațiile rapide",
		"show": "Arată {{name}}",
		"title": "Aplicații rapide"
	},
	"recent_hint": "Tastați pentru a căuta conversații, sarcini, asistenți, agenți și cunoștințe",
	"resultTypes": {
		"agent": "Agent",
		"assistant": "Asistent",
		"knowledge-base": "Cunoștință",
...
const history = {
	...
	"records": {
		...
		"bulkDeleteSessions": {
			"description": "Ștergeți {{count}} sarcină(e) selectată(e)?",
			"title": "Șterge sarcinile selectate"
		},
		"bulkDeleteTopics": {
			"description": "Ștergeți {{count}} conversație(i) selectată(e)?",
...
const knowledge = /* @__PURE__ */ JSON.parse("{\"add\":{\"group\":\"Grup\",\"submit\":\"Creează\",\"title\":\"Bază de cunoștințe nouă\"},\"context\":{\"delete\":\"Șterge baza de cunoștințe\",\"delete_confirm_description\":\"Această bază de cunoștințe nu poate fi recuperată după ștergere.\",\"delete_confirm_title\":\"Ștergeți baza de cunoștințe?\",\"move_to\":\"Mută la\",\"rename\":\"Redenumește\"},\"data_source\":{\"actions\":{\"delete\":\"Șterge\",\"preview_source\":\"Previzualizare Sursă\",\"reindex\":\"Reindexare\",\"view_chunks\":\"Vezi Fragmente\"},\"add_dialog\":{\"conflict_dialog\":{\"description\":\"{{count}} dintre sursele pe care le adaugi au același nume ca elementele existente. Alege cum să le gestionezi.\",\"keep_all\":\"Păstrează tot\",\"replace\":\"Înlocuiește\",\"title\":\"Sursele există deja\"},\"footer\":{\"selected_notes\":\"{{count}} notițe selectate\"},\"note\":{\"description\":\"Selectează notițele existente ca surse pentru baza de cunoștințe\",\"empty_description\":\"Notele selectabile vor apărea aici după ce lista reală de note va fi conectată. Deocamdată, folosiți fișiere, foldere, URL-uri sau hărți de site.\",\"empty_title\":\"Notele nu sunt încă conectate\",\"loading\":\"Se încarcă notițele…\"},\"placeholder\":{\"supported_formats\":\"Acceptă PDF, DOCX, MD, XLSX, TXT, CSV\",\"title\":\"Click pentru a selecta fișierele sau trageți-le aici\"},\"sources\":{\"directory\":\"Folder\",\"file\":\"Fișier\",\"note\":\"Notă\",\"url\":\"URL\"},\"submit\":{\"error\":\"Nu s-a reușit adăugarea sursei de date\",\"success\":\"Sursa de date adăugată la baza de cunoștințe\"},\"title\":\"Adăugare sursă de date\",\"too_many_sources\":\"Poți adăuga cel mult {{count}} surse deodată. Reduce selecția și încearcă din nou.\",\"unsupported_files_skipped\":\"S-au omis {{count}} fișier(e) neacceptate\",\"url\":{\"description\":\"Introduceți un URL de pagină web:\",\"help\":\"Textul paginii va fi preluat, împărțit în fragmente și indexat automat\",\"input_label\":\"URL pagină web\",\"placeholder\":\"https://docs.cherry-ai.com/\",\"title\":\"Importă o singură pagină web\"}},\"back_to_parent\":\"Înapoi\",\"bulk\":{\"delete\":\"Șterge\",\"delete_confirm_description\":\"Ștergeți cele {{count}} surse de date selectate? Această acțiune nu poate fi anulată.\",\"delete_confirm_title\":\"Șterge sursele de date selectate?\",\"loaded_only_hint\":\"Se aplică doar elementelor încărcate ({{total}} în total)\",\"reindex\":\"Reindexare\",\"selected_count\":\"{{count}} selectate\"},\"chunks_count\":\"{{count}} fragmente\",\"delete_confirm_description\":\"Această sursă de date și datele sale index nu pot fi recuperate după ștergere.\",\"delete_confirm_title\":\"Șterge sursa de date?\",\"delete_failed\":\"Nu s-a reușit ștergerea sursei de date\",\"empty\":{\"shortcuts\":{\"directory\":{\"title\":\"Import dosar\"},\"file\":{\"title\":\"Fișier\"},\"url\":{\"title\":\"URL\"}},\"title\":\"Încarcă Prima Ta Sursă de Date\"},\"empty_description\":\"Nici o sursă de date încă\",\"empty_folder\":\"Acest folder este gol\",\"filters\":{\"all\":\"Toate\",\"directory\":\"Foldere\",\"file\":\"Fișiere\",\"note\":\"Note\",\"url\":\"URL-uri\"},\"list\":{\"end_reached\":\"Nu mai sunt articole\",\"loading_more\":\"Se încarcă mai multe…\"},\"preview\":{\"failed\":\"Nu s-a reușit previzualizarea sursei\",\"unavailable\":\"Această sursă de date nu are nicio sursă pentru previzualizare.\"},\"reindex_failed\":\"Nu s-a putut reindexa sursa de date\",\"status\":{\"chunking\":\"Segmentare\",\"copying\":\"Copiere {{percent}}%\",\"embedding\":\"Încorporare\",\"error\":\"Eroare\",\"pending\":\"Așteptare\",\"ready\":\"Gata\"},\"table\":{\"aria_label\":\"Surse de date\",\"columns\":{\"actions\":\"Acțiuni\",\"name\":\"Nume\",\"status\":\"Stare\",\"type\":\"Tip\",\"updated_at\":\"Actualizat\"},\"open_row\":\"Deschide {{title}}\",\"select_all\":\"Selectează tot\",\"select_row\":\"Selectați rândul\"},\"toolbar\":{\"add\":\"Adaugă sursă de date\"}},\"dimensions_auto_set\":\"Setează automat dimensiunile embedding\",\"dimensions_size_placeholder\":\"Lasă gol pentru a nu transmite dimensiuni\",\"embedding_model\":\"Model de încorporare\",\"embedding_model_required\":\"Este necesar un model de încorporare a bazei de cunoștințe\",\"empty\":\"Nicio bază de cunoștințe\",\"empty_action\":\"Creați Bază de Cunoștințe\",\"empty_description\":\"Nu aveți încă nicio bază de cunoștințe. Creați una pentru a începe să vă organizați și să căutați documentele.\",\"error\":{\"directory_not_migrated\":\"Migrarea folderului a eșuat. Te rugăm să-l ștergi și să-l reîncarci.\",\"failed_base_unknown\":\"Această bază de cunoștințe a eșuat în timpul migrării. Reconstruiește-o și alege un nou model de încorporare.\",\"failed_to_create\":\"Nu s-a reușit crearea bazei de cunoștințe\",\"failed_to_delete\":\"Nu s-a reușit ștergerea bazei de cunoștințe\",\"failed_to_edit\":\"Nu s-a reușit editarea bazei de cunoștințe\",\"failed_to_move\":\"Nu s-a reușit mutarea bazei de cunoștințe\",\"indexing_interrupted\":\"Indexarea a fost întreruptă deoarece aplicația s-a închis. Reindexați acest element pentru a finaliza.\",\"missing_embedding_model\":\"Modelul de încorporare utilizat de această bază de cunoștințe nu a fost găsit în timpul migrării. Reconstruiți baza de cunoștințe și alegeți un nou model de încorporare.\",\"missing_vector_store\":\"Magazinul vectorial al acestei baze de cunoștințe nu a putut fi citit în timpul migrării (lipsește, este gol sau blocat). Baza de cunoștințe a fost păstrată; reindexați-o pentru recuperare.\",\"model_invalid\":\"Niciun model selectat\"},\"groups\":{\"add\":\"Grup nou\",\"create_base_here\":\"Creează aici\",\"default\":\"Implicit\",\"delete\":\"Șterge Grup\",\"delete_confirm_description\":\"Bazele de cunoștințe din acest grup vor fi mutate la Negrupate după ștergere.\",\"delete_confirm_title\":\"Ștergeți grupul?\",\"error\":{\"failed_to_create\":\"Nu s-a reușit crearea grupului\",\"failed_to_delete\":\"Nu s-a reușit ștergerea grupului\",\"failed_to_update\":\"Nu s-a reușit redenumirea grupului\"},\"name_placeholder\":\"Introduceți numele grupului...\",\"name_required\":\"Numele grupului este obligatoriu\",\"rename\":\"Redenumește\",\"rename_title\":\"Redenumește grupul\",\"ungrouped\":\"Neagrupat\"},\"meta\":{\"data_sources_count\":\"{{count}} surse\",\"updated_at\":\"Actualizat {{time}}\"},\"name_required\":\"Numele bazei de cunoștințe este obligatoriu\",\"not_set\":\"Nu este setat\",\"provider_not_found\":\"Furnizorul nu a fost găsit\",\"rag\":{\"chunk_overlap\":\"Dimensiune Suprapunere\",\"chunk_overlap_invalid\":\"Suprapunerea fragmentelor trebuie să fie mai mare sau egală cu 0\",\"chunk_overlap_must_be_smaller\":\"Suprapunerea fragmentelor trebuie să fie mai mică decât dimensiunea fragmentului\",\"chunk_overlap_requires_chunk_size\":\"Dimensiunea chunk-ului este obligatorie când suprapunerea chunk-ului este setată\",\"chunk_separator\":\"Separator\",\"chunk_separator_required\":\"Separatorul este necesar când fragmentarea inteligentă este dezactivată\",\"chunk_size\":\"Dimensiunea blocului\",\"chunk_size_change_warning\":\"Modificările dimensiunii și suprapunerii blocurilor se aplică doar conținutului nou adăugat\",\"chunk_size_invalid\":\"Dimensiunea fragmentului trebuie să fie mai mare decât 0\",\"chunking\":\"Segmentare\",\"default_separator\":\"Auto (recomandat)\",\"document_count\":\"Număr de documente\",\"download_local_embedding\":\"Descarcă Model Local\",\"download_local_embedding_failed\":\"Nu s-a reușit descărcarea modelului local de încorporare (embedding)\",\"embedding_model\":\"Model de încorporare\",\"embedding_model_select\":\"Selecția Modelului\",\"file_processing\":\"Procesare fișiere\",\"file_processing_hint\":\"Procesarea fișierelor se execută automat în timpul importului documentului. Alegerea furnizorului potrivit poate îmbunătăți calitatea analizei documentelor.\",\"hints\":{\"chunk_overlap\":\"Numărul de token-uri suprapuse păstrate între fragmentele adiacente pentru a reduce rupturile semantice.\",\"chunk_separator\":\"Delimitatorul pe care este împărțit textul, în formă evadată. Cu fragmentarea inteligentă activată, adaugă un punct de întrerupere; cu ea dezactivată, textul este împărțit doar de acest delimitator.\",\"chunk_size\":\"Numărul țintă de tokeni pentru fiecare fragment de document. Acest lucru afectează granularitatea recuperării și lungimea contextului.\",\"document_count\":\"Numărul maxim de fragmente de document returnate pentru fiecare recuperare. Valori mai mari acoperă mai mult conținut, dar folosesc mai mult context.\",\"embedding_model\":\"Folosit pentru a converti conținutul bazei de cunoștințe în vectori. Schimbarea modelului necesită de obicei reindexarea conținutului existent.\",\"processor\":\"Parser utilizat la importul fișierelor pentru extragerea textului principal, tabelelor și conținutului aferent.\",\"rerank_model\":\"Model folosit pentru reordonarea rezultatelor inițiale de recuperare și îmbunătățirea relevanței fragmentelor finale.\",\"smart_chunking\":\"Împarte automat în funcție de structura Markdown (titluri, blocuri de cod, paragrafe) și nu împărți niciodată în interiorul unui bloc de cod. Dezactivează pentru a împărți pur și simplu după separator.\",\"threshold\":\"Prag de similaritate pentru filtrarea fragmentelor cu relevanță scăzută. Valori mai mari fac recuperarea mai strictă.\"},\"processor\":\"Furnizor de procesare\",\"rerank_disabled\":\"Dezactivat\",\"rerank_model\":\"Model de Reordonare\",\"reset_action\":\"Restabilește valorile implicite\",\"reset_defaults\":\"Resetare la valorile implicite\",\"retrieval\":\"Setări de recuperare\",\"save_action\":\"Salvează\",\"saved\":\"Salvat\",\"separator_rule\":\"Regula Separator\",\"smart_chunking\":\"Fragmentare inteligentă\",\"threshold\":\"Prag de similaritate\",\"tokens_unit\":\"tokeni\",\"use_local_embedding\":\"Folosește Model Local\"},\"recall\":{\"collapse\":\"Restrânge fragmentul\",\"copy\":\"Copiază Fragment\",\"duration\":\"{{duration}}ms\",\"empty_description\":\"Fragmentele de document potrivite și scorurile vor apărea aici\",\"empty_title\":\"Introduceți o interogare pentru a testa recuperarea\",\"expand\":\"Extinde Fragment\",\"history_clear\":\"Clar\",\"history_remove\":\"Șterge istoricul\",\"history_title\":\"Istoric căutări\",\"placeholder\":\"Introduceți interogarea de testare...\",\"ranking_only\":\"Rezultate ordonate\",\"result_count\":\"{{count}} rezultate\",\"result_rank\":\"Rang #{{rank}}\",\"result_relevance\":\"Relevanță {{score}}\",\"search_failed\":\"Nu s-a reușit rularea testului de rechemare\",\"searching\":\"Căutare...\",\"submit\":\"Căutare\",\"top_score\":\"Top: {{score}}\"},\"rename_title\":\"Redenumește Baza de Cunoștințe\",\"restore\":{\"action\":\"Reconstruiește baza de cunoștințe\",\"default_name\":\"{{name}}_bak\",\"failed_to_restore\":\"Nu s-a reușit reconstruirea bazei de cunoștințe\",\"skipped_missing_sources_one\":\"S-a sărit {{count}} element al cărui sursă nu mai există\",\"skipped_missing_sources_other\":\"Au fost sărite {{count}} elemente ale căror sursă nu mai există\",\"submit\":\"Reconstrui\",\"title\":\"Reconstruiește baza de cunoștințe\"},\"search\":\"Caută în baza de cunoștințe\",\"search_placeholder\":\"Introdu text pentru căutare\",\"status\":{\"completed\":\"Gata\",\"failed\":\"Eșuat\",\"processing\":\"Procesare\"},\"status_embedding_failed\":\"Embedding eșuat\",\"status_preprocess_failed\":\"Preprocesare eșuată\",\"subtitle_file\":\"fișier subtitrare\",\"tabs\":{\"data_source\":\"Surse de date\",\"rag_config\":\"Configurare RAG\",\"recall_test\":\"Test de Rechemare\"},\"title\":\"Bază de cunoștințe\",\"videos_file\":\"fișier video\"}");
const languages = {
	"arabic": "Arabă",
	"chinese": "Chineză",
...
const miniApps = {
	...
	"ima": "acum",
	"metaso": "Metaso",
	"minimax-agent": "Agent Minimax CN",
	"minimax-global": "Agent Minimax",
	"nami-ai": "Nami AI",
	"qwen": "Qwen",
	"sensechat": "SenseChat",
	"stepfun": "Stepfun",
...
const models = {
	"action": {
		"configure_custom": "Configurați modele personalizate",
	...
	"embedding": "Embedding",
	"embedding_dimensions": "Dimensiuni embedding",
	"embedding_model": "Model embedding",
	"embedding_model_tooltip": "Adaugă în Setări->Furnizor Model->Gestionează",
	...
	"multi_select": { "label": "Multi-model paralel (mutu exclusiv cu multi-asistent)" },
	...
	"rerank_model_not_support_provider": "Momentan, modelul reranker nu acceptă acest furnizor ({{provider}})",
	"rerank_model_support_provider": "Momentan, modelul reranker acceptă doar anumiți furnizori ({{provider}})",
	"rerank_model_tooltip": "Fă clic pe butonul Gestionează din Setări -> Servicii Model pentru a adăuga.",
	"search": {
...
const notes = {
	...
	"create_folder_failed": "Nu s-a reușit crearea folderului",
	...
	"folder": "Dosar",
	"leave": {
		"description": "Părăsirea acestei note va elimina modificările nesalvate. Doriți să continuați?",
	...
	"metadata_sync_failed": "Fișier actualizat, dar rețineți că sincronizarea stării a eșuat. Vă rugăm să reîncercați operațiunea.",
	...
	"save_failure": {
		...
		"metadata_pending": "Nota a fost salvată, dar metadatele fișierului sale sunt încă în curs de recuperare. Nu reîncercați această salvare."
	},
	"search": {
		"both": "Nume+Conținut",
		"content": "Conținut",
	...
	"target_name_exists": "O notă sau un dosar cu acest nume există deja",
	"title": "Notițe",
...
const onboarding = {
	"privacy": {
		...
		"update_failed": "Nu am putut salva acceptarea politicii de confidențialitate. Încercați din nou."
	},
	"provider_setup": {
		"missing_model": "Activați cel puțin un model de la furnizorul activat",
		"missing_provider": "Activați un furnizor pentru a continua",
		"next": "Următorul",
		"subtitle": "Adaugă o cheie API sau conectează-te cu CherryIN, apoi activează un furnizor.",
		"title": "Alegeți un furnizor"
	},
	"select_model": {
		"change_later": "Poți schimba oricând asta din setări.",
		"start": "Începe",
		"subtitle": "Selectați modelul implicit pentru fiecare scenariu",
		"title": "Alegeți Modelele Dvs. Implicite"
	},
	"skip": "Sariți",
	"toast": {
		"complete_failed": "Nu s-a putut finaliza configurarea. Vă rugăm să încercați din nou.",
		"connected": "Conectat cu succes la CherryIN"
	},
	"welcome": {
		"login_cherryin": "Conectare cu CherryIN",
		"or_continue_with": "SAU CONTINUAȚI CU",
		"other_provider": "Alegeți alți furnizori",
		"select_other_provider": "Selectați alt furnizor",
		"setup_hint": "Vă rugăm să configurați cel puțin un furnizor pentru cea mai bună experiență",
		"subtitle": "Conectați un furnizor pentru a vă activa stația de lucru AI all-in-one",
...
const openclaw = {
	...
	"error": { "select_provider_model": "Vă rugăm să selectați mai întâi un furnizor și un model" },
	"gateway": {
	...
	"migration": {
		"description": "A fost detectată o versiune învechită a OpenClaw instalată prin npm. Reinstalați pentru a obține cea mai recentă versiune oficială.",
	...
	"model_config": {
		...
		"auth_token_placeholder": "Introduceți sau generați un token",
		"generate_token": "Generează",
		"model": "Model",
		"provider": "Furnizor",
		"select_model": "Selectați un model",
		"select_provider": "Selectați un furnizor",
	...
	"not_installed": {
		"description": "OpenClaw nu este instalat pe sistemul dvs. Vă rugăm să-l instalați mai întâi pentru a utiliza această funcție.",
		"install_button": "Instalează OpenClaw",
		"install_guide_title": "Ghid de instalare",
		"macos_linux_title": "macOS / Linux",
		"refresh": "Reîmprospătare",
		"step2_hint": "După instalare, faceți clic pe butonul „Reîmprospătare” de mai sus pentru a detecta OpenClaw",
	...
	"tips": {
		"permissions": "OpenClaw are permisiuni de sistem ridicate. Utilizați doar în medii de încredere",
		"title": "Sfaturi",
		"token_usage": "Modul agent AI poate consuma mai multe tokenuri. Vă rugăm să monitorizați utilizarea"
	},
	"title": "OpenClaw",
	"uninstall_confirm": "Sigur doriți să dezinstalați OpenClaw? Apăsați OK pentru a confirma.",
	"uninstalled": {
...
const ovms = {
	...
	"description": "<div><p>1. Descarcă modele OV.</p><p>2. Adaugă modele în 'Manager'.</p><p>Suportă doar Windows!</p><p>Cale instalare OVMS: '%USERPROFILE%\\.cherrystudio\\ovms' .</p><p>Te rugăm să consulți <a href=https://github.com/openvinotoolkit/model_server/blob/c55551763d02825829337b62c2dcef9339706f79/docs/deploying_server_baremetal.md>Ghidul Intel OVMS</a></p></dev>",
	"download": {
		"button": "Descarcă",
...
const paintings = {
	...
	"dashscope": {
		...
		"enable_interleave_tip": "Când este activată, generează un rezultat mixt de text și imagine fără a necesita o imagine de intrare. Dezactivați pentru a folosi modul de editare (necesită 1–4 imagini de intrare).",
	...
	"edit": {
		...
		"image_required": "Vă rugăm să încărcați mai întâi o imagine pentru editare"
	},
	"generate": {
		"height": "Înălțime",
		"width": "Lățime"
	...
	"guidance_scale_tip": "Classifier Free Guidance. Cât de fidel vrei să respecte modelul promptul tău când caută o imagine similară să-ți arate",
	...
	"person_generation_tip": "Permiteți modelului să genereze imagini cu persoane",
	"ppio": {
		...
		"use_pre_llm_tip": "Activează expansiunea textului pentru optimizarea promptului. Recomandat pentru prompturi scurte, dezactivați pentru cele lungi",
	...
	"prompt_required": "Vă rugăm să introduceți o solicitare",
	...
	"required_field": "Câmp obligatoriu",
	"revealing": "Dezvăluirea imaginii generate",
...
const plugins = {
	...
	"confirm_uninstall_package": "Sigur doriți să dezinstalați pachetul {{name}} și toate componentele sale?",
	...
	"showing_results_skills_one": "Afișare {{count}} abilitate",
	"showing_results_skills_other": "Afișare {{count}} competențe",
	"showing_results_skills_plural": "Afișare {{count}} competențe",
	"skills": "Abilități",
	"sort": {
...
const privacy_policy_update = {
	"acknowledge_failed": "Nu s-a putut salva confirmarea. Vă rugăm să încercați din nou.",
	"description_before_link": "Am actualizat politica de confidențialitate. Vă rugăm să consultați cea mai recentă versiune.",
	"policy": "Politica de confidențialitate",
...
const selection = {
	...
	"settings": {
		...
		"linux": {
			"compositor_incompatible": "Mediul dvs. desktop nu acceptă funcția de selecție. Vă rugăm să treceți la o sesiune X11 pentru o experiență completă.",
			...
			"wayland_checklist_subtitle": "Asigurați-vă că sunt îndeplinite următoarele condiții pentru a optimiza experiența Wayland:",
			"wayland_description": "Vă aflați într-o sesiune Wayland. Din cauza limitărilor sistemului, bara de instrumente poate apărea doar în centrul ecranului în loc să urmărească textul selectat pe unele medii desktop. Se recomandă să treceți la o sesiune X11 pentru o experiență completă.",
			"wayland_title": "Notificare sesiune Wayland",
			"xwayland_fail": "Nu este activat, vă rugăm să lansați Cherry Studio cu steagul `--ozone-platform=x11`",
...
const translate = {
	...
	"files": {
		...
		"upload": "Trageți sau faceți clic pentru a încărca imaginea/documentul"
	},
	"history": {
		...
		"delete_description": "Ștergeți această înregistrare din istoricul traducerilor? Această acțiune nu poate fi anulată.",
	...
	"input": { "placeholder": "Textul, fișierele text sau imaginile (cu suport OCR) pot fi lipite sau trase aici" },
	"language": {
