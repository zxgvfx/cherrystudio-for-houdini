import { C as indentNodeProp, Dt as tags, Et as styleTags, It as parseMixed, _ as foldInside, m as delimitedIndent, o as LanguageSupport, r as LRLanguage, y as foldNodeProp } from "./dist-BRteDD4O.js";
import { i as LocalTokenGroup, r as LRParser } from "./dist-By1sRK-o.js";
import { t as parser } from "./dist-EuhmJNRK.js";
var keywordMap = {
	strict: 1,
	graph: 2,
	digraph: 3,
...
var language = LRLanguage.define({
	parser: parser$1.configure({
		...
		wrap: parseMixed((node) => {
			return node.name == "HTMLStringContent" ? { parser } : null;
		})
	}),
	languageData: {
