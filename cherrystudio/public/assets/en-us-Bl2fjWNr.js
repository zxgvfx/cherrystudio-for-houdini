...
const error = {
	...
	"toolName": "Tool Name",
	"tool_call_limit_reached": "The assistant reached the tool-call limit before producing a final answer. Try again or reduce the task scope.",
...
const knowledge = {
	...
	"rag": {
		...
		"download_local_embedding": "Download Local Model",
...
const models = {
	...
	"multi_select": { "label": "Multi-model simultaneous responses" },
...
const warning = { "missing_provider": "The supplier does not exist; reverted to the default supplier {{provider}}. This may cause issues." };
const words = {
