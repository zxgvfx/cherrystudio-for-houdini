...
import { t as LanguageSelect_default } from "./LanguageSelect-BjEvo9EV.js";
import { Kr as LoadingOutlined_default, Qo as IpcChannel, Uo as defaultLanguage, Yt as ArrowLeftOutlined_default, Zo as loggerService, _o as i18n_default, n as init_es, ni as CloseOutlined_default, sn as SwapOutlined_default, xt as EnterOutlined_default, yo as useTranslation } from "./es-DkAVbmke.js";
import { Di as useHotkeys, Eo as selectMessagesForTopic, Fr as translateText, Hr as MessageContent_default, Ja as useTopicMessages, Jp as LanguagesEnum, Ju as runAsyncFunction, Ks as isAbortError, Ld as typography_default, Os as useDefaultModel, Qa as cancelThrottledBlockUpdate, To as newMessagesActions, Ts as useAssistant, Ua as useTimer, Wo as abortCompletion, Xa as Scrollbar_default, Zd as input_default, Zs as ChunkType, Zu as classNames, _f as select_default, _p as ThemeMode, an as getUserMessage, cc as upsertOneBlock, cf as col_default$1, dp as createThinkingBlock, hp as MessageBlockStatus, ht as replacePromptVariables, i as useAppSelector, io as throttledBlockUpdate, lp as createMainTextBlock, mp as AssistantMessageStatus, n as store_default, nl as getDefaultTopic, nn as getAssistantMessage, oc as updateOneBlock, of as divider_default, op as databases_default, or as MessageErrorBoundary_default, pc as useSettings, pp as require_lodash, pt as ConversationService, qf as isMac, rc as getMainTextContent, sc as upsertManyBlocks, st as fetchChatCompletion, wr as useTranslate, xa as useTheme, zd as tag_default, zt as ModelAvatar_default } from "./store-BGJt4Ep3.js";
import { t as require_react } from "./react-1FqkuScD.js";
import { xt as tooltip_default, z as CopyIcon_default } from "./ImageViewer-DYgRjhpa.js";
import { t as CircleArrowLeft } from "./circle-arrow-left-4U9oLhgt.js";
import { t as Copy } from "./copy-BfOh9mRD.js";
import { t as FileText } from "./file-text-CXkFMEB-.js";
import { t as Languages } from "./languages-BVQTLM6X.js";
import { t as Lightbulb } from "./lightbulb-CBQ4VEUS.js";
import { t as MessageSquare } from "./message-square-_4IpnlmY.js";
