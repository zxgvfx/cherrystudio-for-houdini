						...
						switch (part.type) {
							...
							case "file":
								...
								if (part.mediaType.startsWith("video/")) {
									if (part.data instanceof URL) throw new UnsupportedFunctionalityError({ functionality: "video file parts with URLs" });
									return {
										type: "file",
										file: {
											filename: part.filename != null ? part.filename : "video",
