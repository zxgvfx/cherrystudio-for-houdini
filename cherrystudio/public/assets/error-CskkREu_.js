import { r as __export } from "./rolldown-runtime-D8OvLAZx.js";
import { C as string, P as _coercedNumber, R as NEVER, S as strictObject, T as unknown, _ as object, a as array, c as discriminatedUnion, g as number$1, j as ZodError, n as _enum, o as boolean, p as literal, s as custom, t as ZodNumber, u as int, x as record } from "./schemas-1oAyIgyK.js";
...
import { c as AISDKError, n as InvalidToolInputError } from "./dist-CK6lZPpu.js";
function number(params) {
	return _coercedNumber(ZodNumber, params);
}
const BUILTIN_AGENT_ROLE = {
	ASSISTANT: "assistant",
	SUPPORT: "support"
};
function isProtectedBuiltinAgentRole(role) {
...
const AgentConfigurationSchema = object({
	...
	builtin_role: _enum([BUILTIN_AGENT_ROLE.ASSISTANT, BUILTIN_AGENT_ROLE.SUPPORT]).optional()
}).loose();
...
const aiStreamAdmissionReasons = {
...
function isAiStreamAdmissionReason(value) {
...
function aiStreamAdmissionReason(e) {
	if (!(e instanceof IpcError) || e.code !== aiErrorCodes.AI_STREAM_ADMISSION_REJECTED) return void 0;
	if (!e.data || typeof e.data !== "object" || !("reason" in e.data)) return void 0;
	return isAiStreamAdmissionReason(e.data.reason) ? e.data.reason : void 0;
}
...
function getAiStreamAdmissionMessage(error) {
	switch (aiStreamAdmissionReason(error)) {
		case "SINGLE_MODEL_REQUIRED": return t("message.error.stream_admission.single_model_required");
		case "TARGET_NOT_IN_LIVE_GROUP": return t("message.error.stream_admission.target_not_in_live_group");
		case "MODEL_ALREADY_IN_LIVE_GROUP": return t("message.error.stream_admission.model_already_in_live_group");
		case "EXECUTION_NOT_READY": return t("message.error.stream_admission.execution_not_ready");
		case "EXECUTION_CHANGED": return t("message.error.stream_admission.execution_changed");
		case "TOPIC_BUSY": return t("message.error.stream_admission.topic_busy");
		default: return;
	}
}
...
var PROVIDER_ERROR_TEXT_MAX = 500;
...
export { isSerializedAiSdkNoSuchProviderError as A, sanitizeAgentConfiguration as B, isSerializedAiSdkInvalidPromptError as C, isSerializedAiSdkNoObjectGeneratedError as D, isSerializedAiSdkMessageConversionError as E, isSerializedAiSdkTypeValidationError as F, BUILTIN_AGENT_ROLE as H, isSerializedAiSdkUnsupportedFunctionalityError as I, isSerializedError as L, isSerializedAiSdkRetryError as M, isSerializedAiSdkTooManyEmbeddingValuesForCallError as N, isSerializedAiSdkNoSpeechGeneratedError as O, isSerializedAiSdkToolCallRepairError as P, AGENTS_MAX_LIMIT as R, isSerializedAiSdkInvalidMessageRoleError as S, isSerializedAiSdkJSONParseError as T, isProtectedBuiltinAgentRole as U, AGENT_WORKSPACE_TYPE as V, number as W, isSerializedAiSdkDownloadError as _, formatMcpError as a, isSerializedAiSdkInvalidArgumentError as b, isAbortError as c, serializeHealthCheckError as d, parseJSON as f, isSerializedAiSdkApiCallError as g, aiErrorDetail as h, formatErrorMessageWithPrefix as i, isSerializedAiSdkNoSuchToolError as j, isSerializedAiSdkNoSuchModelError as k, providerErrorText as l, aiErrorCodes as m, formatError as n, formatZodError as o, axios_default as p, formatErrorMessage as r, getErrorMessage as s, formatAiSdkError as t, safeToString as u, isSerializedAiSdkError as v, isSerializedAiSdkInvalidToolInputError as w, isSerializedAiSdkInvalidDataContentError as x, isSerializedAiSdkErrorUnion as y, AgentPermissionModeSchema as z };
