import { $ as showTooltip, A as indentUnit, F as syntaxTree, G as Decoration, H as Direction, I as EditorView, J as ViewPlugin, K as WidgetType, P as getTooltip, U as keymap, W as logException, a4 as Annotation, a7 as CharCategory, a8 as EditorSelection, aa as Facet, ab as MapMode, ac as Prec, ad as RangeSet, af as RangeValue, ag as StateEffect, ah as StateField, ai as Text, aj as Transaction, ak as codePointAt, al as codePointSize, am as combineConfig, ap as fromCodePoint } from "./dist-BY7PSxtU.js";
...
var Snippet = class Snippet {
	...
	instantiate(state, pos) {
		...
		let ranges = this.fieldPositions.map((pos$1) => new FieldRange(pos$1.field, lineStart[pos$1.line] + pos$1.from, lineStart[pos$1.line] + pos$1.to));
		return {
			text,
			ranges
		};
	...
	static parse(template) {
		...
		for (let line of template.split(/\r\n?|\n/)) {
			while (m = /[#$]\{(?:(\d+)(?::([^}]*))?|((?:\\[{}]|[^}])*))\}/.exec(line)) {
				...
				let name = rawName.replace(/\\[{}]/g, (m$1) => m$1[1]);
...
const setActive = /* @__PURE__ */ StateEffect.define({ map(value, changes) {
...
const snippetKeymap = /* @__PURE__ */ Facet.define({ combine(maps) {
...
const snippetPointerHandler = /* @__PURE__ */ EditorView.domEventHandlers({ mousedown(event, view) {
...
export { CompletionContext as b, autocompletion as c, closeBrackets as d, closeBracketsKeymap as e, completeFromList as f, completionKeymap as g, ifNotIn as h, snippetCompletion as i };
