...
const assistants = {
	...
	"clear": {
		...
		"menu_title": "Supprimer toutes les conversations avec l'assistant",
		"success_title": "{{count}} sujets effacés",
		"title": "Supprimer les sujets"
	},
	"copy": { "title": "Copier l'Aide" },
	"delete": {
	...
	"settings": {
		...
		"regular_phrases": {
			...
			"contentPlaceholder": "Veuillez saisir le contenu de la phrase, vous pouvez utiliser des variables, et appuyez sur Tab pour localiser rapidement la variable à modifier. Par exemple : \nAidez-moi à planifier un itinéraire de ${from} à ${to}, et envoyez-le à ${email}.",
	...
	"title": "Agent",
	"unpin": { "title": "Détacher l'assistant" }
};
const auth = {
...
const code = {
	...
	"search_provider_placeholder": "Fournisseurs de recherche…",
...
const file_preview = {
	...
	"pdf": { "too_large": {
		...
		"description": "Les fichiers PDF de plus de {{limit}} Mo ne peuvent pas être prévisualisés.",
...
const globalSearch = {
	...
	"open": "Recherche globale ouverte",
...
const models = {
	...
	"multi_select": { "label": "Parallélisme multi-modèle (exclusif mutuel avec assistant multiple)" },
...
const openclaw = {
	...
	"description": "Intégrer les fournisseurs Cherry Studio avec la passerelle OpenClaw pour permettre aux agents de codage IA comme Claude Code, Qwen-Coder, et bien d'autres.",
	...
	"node_missing": {
		"description": "OpenClaw nécessite Node.js/npm. Veuillez d'abord installer Node.js, puis redémarrez Cherry Studio.",
...
const plugins = {
	...
	"showing_results_skills": "Affichage de {{count}} compétence",
	"showing_results_skills_one": "Affichage de {{count}} compétence",
	"showing_results_skills_other": "Affichage de {{count}} compétences",
...
const selection = {
	"action": {
		...
		"prompt": {
			...
			"summary": "Je ne peux pas résumer le contenu, car aucun texte à résumer n’a été fourni après {{language}}."
		},
		"translate": {
...
const translate = {
	...
	"input": { "placeholder": "Peut coller ou glisser du texte, des fichiers texte ou des images (avec prise en charge de l'OCR)" },
	"language": {
