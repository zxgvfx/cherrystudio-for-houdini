...
function BracesVariableIcon({ size = "1em", ...props }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
		"data-ui": "icons.braces-variable-icon",
		...
		"aria-hidden": "true",
		focusable: "false",
		...mergeUiProps(props, "icons.braces-variable-icon"),
...
export { BracesVariableIcon as t };
