import { A as safeParseAsync, C as string, N as toJSONSchema, S as strictObject, T as unknown, _ as object$1, a as array$1, c as discriminatedUnion, f as lazy, g as number, h as never, i as _null, n as _enum, o as boolean, p as literal, r as _instanceof, s as custom, w as union, x as record } from "./schemas-1oAyIgyK.js";
var marker$3 = "vercel.ai.error";
var symbol$3 = Symbol.for(marker$3);
var _a$3, _b$2;
var AISDKError$1 = class _AISDKError extends (_b$2 = Error, _a$3 = symbol$3, _b$2) {
...
var _a4$1, _b4;
var InvalidArgumentError = class extends (_b4 = AISDKError$1, _a4$1 = symbol4$2, _b4) {
...
var _a7$1, _b7;
var JSONParseError$1 = class extends (_b7 = AISDKError$1, _a7$1 = symbol7$2, _b7) {
...
var _a$2, _b$1;
var DownloadError = class extends (_b$1 = AISDKError$1, _a$2 = symbol$2, _b$1) {
...
function parseArrayDef(def, refs) {
	...
	if (((_a2$1 = def.type) == null ? void 0 : _a2$1._def) && ((_c = (_b2 = def.type) == null ? void 0 : _b2._def) == null ? void 0 : _c.typeName) !== ZodFirstPartyTypeKind.ZodAny) res.items = parseDef(def.type._def, {
		...refs,
...
var zod3ToJsonSchema = (schema, options) => {
	...
	let definitions = typeof options === "object" && options.definitions ? Object.entries(options.definitions).reduce((acc, [name3$3, schema2]) => {
		...
		return {
			...acc,
			[name3$3]: (_a3$1 = parseDef(schema2._def, {
				...refs,
				currentPath: [
					...refs.basePath,
					refs.definitionPath,
	...
	const main = (_a2$1 = parseDef(schema._def, name2$3 === void 0 ? refs : {
		...refs,
		currentPath: [
			...refs.basePath,
			refs.definitionPath,
		...
		stream: processUIMessageStream({
			...
			runUpdateMessageJob(job) {
				return job({
					state,
					write: () => {
						controller?.enqueue(cherrySnapshotUIMessage(state.message));
					}
				});
			},
			onError: handleError
...
var HttpChatTransport = class {
	...
	async sendMessages({ abortSignal, ...options }) {
		...
		const api = (_b$3 = preparedRequest == null ? void 0 : preparedRequest.api) != null ? _b$3 : this.api;
	...
	async reconnectToStream(options) {
		...
		const api = (_b$3 = preparedRequest == null ? void 0 : preparedRequest.api) != null ? _b$3 : `${this.api}/${options.chatId}/stream`;
		const headers = (preparedRequest == null ? void 0 : preparedRequest.headers) !== void 0 ? normalizeHeaders(preparedRequest.headers) : baseHeaders;
		const credentials = (_c = preparedRequest == null ? void 0 : preparedRequest.credentials) != null ? _c : resolvedCredentials;
		const response = await ((_d = this.fetch) != null ? _d : globalThis.fetch)(api, {
			method: "GET",
...
var AbstractChat = class {
	constructor({ generateId: generateId2 = generateId, id = generateId2(), transport = new DefaultChatTransport(), messageMetadataSchema, dataPartSchemas, state, onError, onToolCall, onFinish, onData, sendAutomaticallyWhen }) {
		...
		this.sendMessage = async (message, options) => {
			...
			if (message.messageId != null) {
				...
				this.state.replaceMessage(messageIndex, {
					...
					role: (_b$3 = uiMessage.role) != null ? _b$3 : "user",
		...
		this.addToolApprovalResponse = async ({ id: id$1, approved, reason, options }) => this.jobExecutor.run(async () => {
			...
			const updatePart = (part) => isToolUIPart(part) && part.state === "approval-requested" && part.approval.id === id$1 ? {
				...part,
	...
	async makeRequest({ trigger, metadata, headers, body, messageId }) {
		...
		try {
			...
			try {
				(_b$3 = this.onFinish) == null || _b$3.call(this, {
...
export { isFileUIPart as a, AISDKError as c, isDataUIPart as i, InvalidToolInputError as n, isToolUIPart as o, getToolName as r, readUIMessageStream as s, AbstractChat as t };
