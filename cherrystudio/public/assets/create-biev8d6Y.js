...
import { r as DialogContent, s as DialogTitle, t as Dialog } from "./dialog-DwmxJH-S.js";
import { t as scrollbar_default } from "./scrollbar-DXc_RNdR.js";
import { a as FormItem, d as useForm, f as useFormState, i as FormField, n as FormControl, o as FormLabel, p as useWatch, r as FormDescription, s as FormMessage, t as Form } from "./form-D4JKgtXI.js";
import { n as ipcApi } from "./ipc-DpcwPFwy.js";
import { t as getDefaultRouteTitle } from "./routeTitle--4OTq6gp.js";
...
import { D as PromptPolishActions, E as PermissionModeSelect, O as PromptEditorField, _ as CocoSettingsFields, c as PromptVariablesPopover, f as resourceDialogCloseButtonClassName, i as EDIT_DIALOG_PROMPT_MIN_HEIGHT, l as TextInputField, m as resourceDialogTitleClassName, n as CompactModelField, o as FieldLabelWithHelp, p as resourceDialogHeaderClassName, r as EDIT_DIALOG_PROMPT_MAX_HEIGHT, s as KnowledgeBaseField, t as AvatarField, v as usePromptProcessor, y as SkillCatalogPicker } from "./EditDialogShared-jA4mvNoE.js";
import { l as useAgentModelFilter } from "./ModelSelector-DGMGvnR1.js";
import { a as RESOURCE_PROMPT_POLISH_SYSTEM_PROMPT } from "./resourceCatalog-BJgI2SG2.js";
import { i as getPermissionModeCards } from "./agent-IxO6TDCv.js";
...
function AgentRuntimeModelFields({ form, portalContainer, modelLabels, setModelLabels, modelFilter, onSettingsNavigate }) {
	...
	const handleRuntimeChange = (next) => {
		...
		if (next === "coco") {
			...
			form.setValue("cocoPermission", "ask", { shouldDirty: true });
		}
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		agentType === "coco" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CocoSettingsFields, {
			control: form.control,
			mode: form.watch("cocoMode") ?? "agent",
			permission: form.watch("cocoPermission") ?? "ask",
			onModeChange: (value) => form.setValue("cocoMode", value, { shouldDirty: true }),
			onPermissionChange: (value) => form.setValue("cocoPermission", value, { shouldDirty: true }),
			portalContainer
		}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormField, {
			control: form.control,
			name: "permissionMode",
