import { A as unknown, f as _enum, k as array, l as boolean, t as number, u as object, v as record, x as string, z as union } from "./schemas-Bbbixa2f.js";
import { C as loadOptionalSetting, D as loadSetting, G as parseProviderOptions, I as postJsonToApi, J as resolve, O as withUserAgentSuffix, P as withoutTrailingSlash, Q as zodSchema, Y as TooManyEmbeddingValuesForCallError, _ as UnsupportedFunctionalityError, c as combineHeaders, e as convertToBase64, h as createEventSourceResponseHandler, j as createJsonErrorResponseHandler, k as createJsonResponseHandler, l as createProviderDefinedToolFactory, m as createProviderDefinedToolFactoryWithOutputSchema, q as generateId, t as getRuntimeEnvironmentUserAgent, z as lazySchema } from "./dist-mVY8hbYS.js";
...
var GoogleGenerativeAILanguageModel = class {
	...
	async getArgs({ prompt, maxOutputTokens, temperature, topP, topK, frequencyPenalty, presencePenalty, stopSequences, responseFormat, seed, tools, toolChoice, providerOptions }) {
		...
		if ((tools == null ? void 0 : tools.some((tool) => tool.type === "provider-defined" && tool.id === "google.vertex_rag_store")) && !this.config.provider.startsWith("google.vertex.")) warnings.push({
			type: "other",
