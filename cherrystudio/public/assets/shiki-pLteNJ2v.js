const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./dist-CtM_deIR.js","./dist-Cu7DuZHc.js","./lib-6TKYmTQn.js","./chunk-DiqNceaa.js","./zwitch-B7UdpQMH.js","./dist-J1XnJP4k.js","./preload-helper-BAxOQgJR.js","./markdown-it-ti1Jxlo-.js","./markdown-it-CzjPjKWl.js"])))=>i.map(i=>d[i]);
...
var shikiInitializer = new AsyncInitializer(async () => {
	return await __vitePreload(() => import("./dist-CtM_deIR.js"), __vite__mapDeps([0,1,2,3,4,5,6]), import.meta.url);
});
...
var mdInitializer = new AsyncInitializer(async () => {
	return (await __vitePreload(() => import("./markdown-it-ti1Jxlo-.js"), __vite__mapDeps([7,8,3]), import.meta.url)).default;
});
async function getMarkdownIt(theme, markdown) {
	...
	const { fromHighlighter } = await __vitePreload(async () => {
		const { fromHighlighter: fromHighlighter$1 } = await import("./core-pfxn37V5.js");
