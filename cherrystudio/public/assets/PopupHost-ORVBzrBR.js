...
import { n as getCmThemeNames, t as getCmThemeByName } from "./utils-D1QIKxFT.js";
import { t as CodeStyleContext } from "./useCodeStyle-hWHmowmT.js";
import { n as useTheme } from "./useTheme-mM6gKAcD.js";
import { c as loadThemeIfNeeded, i as getMarkdownIt, n as DEFAULT_THEMES, o as getShiki, r as getHighlighter, s as loadLanguageIfNeeded, t as DEFAULT_LANGUAGES } from "./shiki-g8Tr0-KC.js";
...
import { r as popupService } from "./popup-fJcKiA2S.js";
...
var ShikiStreamService = class {
	...
	async initWorker() {
		...
		this.workerInitPromise = (async () => {
			try {
				this.worker = new (await (__vitePreload(() => import("./shikiStream.worker-SgK5e_Zi.js"), [], import.meta.url))).default();
