const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./info-NVLQJR56-BxsvAoPd.js","./chunk-FPAJGGOC-CRgAxkEb.js","./isEmpty-7pwPNs8K.js","./_baseFor-D3YGcNEJ.js","./reduce-fulHaVuN.js","./flatten-917SNdFV.js","./chunk-0ogMdkZ1.js","./chunk-LBM3YZW2-CBGkY6yt.js","./packet-BFZMPI3H-J3ndZzuQ.js","./chunk-76Q3JFCE-Dd_lvfcB.js","./pie-7BOR55EZ-C9SozT8d.js","./chunk-T53DSG4Q-C6BZYGad.js","./architecture-U656AL7Q-C8s-aW0X.js","./chunk-O7ZBX7Z2-DvDg5FhK.js","./gitGraph-F6HP7TQM-B1PkZ6hV.js","./chunk-S6J4BHB3-BcC1URD2.js","./radar-NHE76QYJ-5DP-VOEw.js","./chunk-LHMN2FUI-DKAz_CvS.js","./treemap-KMMF4GRG-Bby-_LiV.js","./chunk-FWNWRKHM-BugacAbj.js"])))=>i.map(i=>d[i]);
import { t as __vitePreload } from "./preload-helper-Ds6i2_-X.js";
import { f as __name } from "./chunk-FPAJGGOC-CRgAxkEb.js";
var parsers = {};
var initializers = {
	info: /* @__PURE__ */ __name(async () => {
		const { createInfoServices: createInfoServices2 } = await __vitePreload(async () => {
			const { createInfoServices: createInfoServices2$1 } = await import("./info-NVLQJR56-BxsvAoPd.js");
	...
	packet: /* @__PURE__ */ __name(async () => {
		const { createPacketServices: createPacketServices2 } = await __vitePreload(async () => {
			const { createPacketServices: createPacketServices2$1 } = await import("./packet-BFZMPI3H-J3ndZzuQ.js");
	...
	pie: /* @__PURE__ */ __name(async () => {
		const { createPieServices: createPieServices2 } = await __vitePreload(async () => {
			const { createPieServices: createPieServices2$1 } = await import("./pie-7BOR55EZ-C9SozT8d.js");
	...
	architecture: /* @__PURE__ */ __name(async () => {
		const { createArchitectureServices: createArchitectureServices2 } = await __vitePreload(async () => {
			const { createArchitectureServices: createArchitectureServices2$1 } = await import("./architecture-U656AL7Q-C8s-aW0X.js");
	...
	gitGraph: /* @__PURE__ */ __name(async () => {
		const { createGitGraphServices: createGitGraphServices2 } = await __vitePreload(async () => {
			const { createGitGraphServices: createGitGraphServices2$1 } = await import("./gitGraph-F6HP7TQM-B1PkZ6hV.js");
	...
	radar: /* @__PURE__ */ __name(async () => {
		const { createRadarServices: createRadarServices2 } = await __vitePreload(async () => {
			const { createRadarServices: createRadarServices2$1 } = await import("./radar-NHE76QYJ-5DP-VOEw.js");
	...
	treemap: /* @__PURE__ */ __name(async () => {
		const { createTreemapServices: createTreemapServices2 } = await __vitePreload(async () => {
			const { createTreemapServices: createTreemapServices2$1 } = await import("./treemap-KMMF4GRG-Bby-_LiV.js");
