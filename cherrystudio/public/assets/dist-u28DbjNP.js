import { $ as getTooltip, At as codePointSize, Dt as Text, E as indentUnit, Et as StateField, G as Direction, J as WidgetType, K as EditorView, Ot as Transaction, Pt as fromCodePoint, St as RangeSet, Tt as StateEffect, W as Decoration, _t as EditorSelection, bt as MapMode, dt as showTooltip, gt as CharCategory, it as keymap, j as syntaxTree, jt as combineConfig, kt as codePointAt, ot as logException, pt as Annotation, q as ViewPlugin, wt as RangeValue, xt as Prec, yt as Facet } from "./dist-DErY0e6o.js";
		...
		if (a.result.filter === false) for (let option of a.result.options) addOption(new Option(option, a.source, getMatch ? getMatch(option) : [], 1e9 - options.length));
			...
			for (let option of a.result.options) if (match = matcher.match(option.label)) {
				...
				if (typeof option.section == "object" && option.section.rank === "dynamic") {
					...
					dynamicSectionScore[name] = Math.max(score$1, dynamicSectionScore[name] || -1e9);
				}
			}
		}
	}
