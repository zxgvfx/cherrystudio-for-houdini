import { A as _baseRest_default, B as _overRest_default, D as _assignValue_default, F as _baseAssignValue_default, H as _setToString_default, I as constant_default, N as identity_default, P as isArray_default, T as _root_default, c as _baseFor_default, n as keysIn_default, s as _baseUnary_default, x as _isIterateeCall_default, y as isArrayLike_default } from "./isArrayLikeObject-C0fnS-tW.js";
import { A as toString_default, G as _arrayMap_default, H as isSymbol_default, c as reduce_default, d as isUndefined_default, e as values_default, f as filter_default, h as forEach_default, i as _castFunction_default, l as _baseForOwn_default, m as _baseIteratee_default, n as _baseProperty_default, o as hasIn_default, t as _baseClone_default, w as _baseFlatten_default, x as _baseGet_default } from "./_baseUniq-DL66X10H.js";
import { b as _basePickBy_default, c as min_default, d as _baseExtremum_default, e as _baseLt_default, f as isString_default, g as has_default, h as map_default, i as _baseMap_default, j as find_default, k as last_default, l as defaults_default, m as flatten_default, o as toFinite_default } from "./_basePickBy-CmFGsbDd.js";
import { c as _getTag_default, e as _baseKeys_default } from "./isEmpty-4inQ9Rdd.js";
import { E as merge_default } from "./chunk-U37J5Y7L-BnFtP-4c.js";
import { b as Graph } from "./graphlib-Ds559TXH.js";
...
function compareMultiple(object, other, orders) {
	...
	while (++index < length) {
		...
		if (result) {
			...
			var order$1 = orders[index];
			return result * (order$1 == "desc" ? -1 : 1);
		}
	}
...
function baseOrderBy(collection, iteratees, orders) {
	...
	var result = _baseMap_default(collection, function(value, key, collection$1) {
...
function normalizeRanks(g) {
	...
	forEach_default(g.nodes(), function(v) {
		var node = g.node(v);
		if (has_default(node, "rank")) node.rank -= min;
	});
}
...
function enterEdge(t, g, edge) {
	...
	var candidates = filter_default(g.edges(), function(edge$1) {
		return flip === isDescendant(t, t.node(edge$1.v), tailLabel) && flip !== isDescendant(t, t.node(edge$1.w), tailLabel);
	});
	return minBy_default(candidates, function(edge$1) {
...
function initOrder(g) {
	...
	var maxRank$1 = max_default(map_default(simpleNodes, function(v) {
		return g.node(v).rank;
	}));
	var layers = map_default(range_default(maxRank$1 + 1), function() {
		return [];
	});
	function dfs$2(v) {
	...
	forEach_default(orderedVs, dfs$2);
	return layers;
}
